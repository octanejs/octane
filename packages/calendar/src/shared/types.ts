...
export type NavigationLabelFunc = ({
	...
	locale,
	view,
}: NavigationLabelArgs) => OctaneNode;
...
export type OnClickFunc = (value: Date, event: MouseEvent) => void;

export type OnClickWeekNumberFunc = (weekNumber: number, date: Date, event: MouseEvent) => void;
...
export type TileContentFunc = (args: TileArgs) => OctaneNode;
