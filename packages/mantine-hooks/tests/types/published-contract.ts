// @parity-case types:mantine-hooks-adapted:public-contract
...
import type * as Native0 from '@octanejs/mantine-hooks';
...
// The authenticated native baseline exposes Octane's optional compiler hook slot.
type Contract16 = Assert<
	Equal<Parameters<typeof Native0.useIsomorphicEffect>['length'], 1 | 2 | 3>
>;
