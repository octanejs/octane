...
children, ...restProps }: HeatmapCircleProps<ColumnDatum, BinDatum> & Omit<Octane.SVGProps<SVGCircleElement>, keyof HeatmapCircleProps<ColumnDatum, BinDatum> | 'r' | 'cx' | 'cy' | 'fill' | 'fillOpacity'>): import("react").JSX.Element;
