...
children, ...restProps }: HeatmapCircleProps<ColumnDatum, BinDatum> & Omit<SVGProps<SVGCircleElement>, keyof HeatmapCircleProps<ColumnDatum, BinDatum> | 'r' | 'cx' | 'cy' | 'fill' | 'fillOpacity'>): import("react").JSX.Element;
