...
import type { AreaProps as AreaOwnProps } from '@octanejs/visx/shape';
type AreaProps<Datum> = AreaOwnProps<Datum> & Omit<Octane.SVGProps<SVGPathElement>, keyof AreaOwnProps<Datum>>;
...
export default function Threshold<Datum>({ className, curve, clipAboveTo, clipBelowTo, data, defined, x, y0, y1, aboveAreaProps, belowAreaProps, id, }: ThresholdProps<Datum>): import("react").JSX.Element;
export {};
