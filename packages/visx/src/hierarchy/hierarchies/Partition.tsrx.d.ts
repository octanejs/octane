...
export default function Partition<Datum>({ top, left, className, root, size, round, padding, children, nodeComponent, }: PartitionProps<Datum>): import("react").JSX.Element;
