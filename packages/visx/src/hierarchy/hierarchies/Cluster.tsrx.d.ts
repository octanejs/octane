...
export type LinkComponentProps<Datum> = {
 ...
 */
    ...
    linkComponent?: FunctionComponent<LinkComponentProps<Datum>> | ComponentClass<LinkComponentProps<Datum>>;
...
export default function Cluster<Datum>({ top, left, className, root, size, nodeSize, separation, children, linkComponent, nodeComponent, }: ClusterProps<Datum>): import("react").JSX.Element;
