...
export default function Polygon({ polygon, className, children, ...restProps }: PolygonProps & Omit<Octane.SVGProps<SVGPathElement>, keyof PolygonProps>): import("react").JSX.Element | null;
