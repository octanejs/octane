...
export default function VoronoiPolygon({ polygon, className, children, ...restProps }: VoronoiPolygonProps & Omit<Octane.SVGProps<SVGPathElement>, keyof VoronoiPolygonProps>): import("react").JSX.Element | null;
