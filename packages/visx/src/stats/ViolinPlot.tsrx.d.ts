...
export default function ViolinPlot<Datum extends object>({ left, top, className, data, width, count, value, valueScale, horizontal, children, ...restProps }: ViolinPlotProps<Datum> & Omit<Octane.SVGProps<SVGPathElement>, keyof ViolinPlotProps<Datum>>): import("react").JSX.Element;
