...
export default function CircleSubject({ className, x: propsX, y: propsY, stroke, radius, ...restProps }: CircleSubjectProps & Omit<Octane.SVGProps<SVGCircleElement>, keyof CircleSubjectProps>): import("react").JSX.Element;
