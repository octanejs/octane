...
export default function CircleSubject({ className, x: propsX, y: propsY, stroke, radius, ...restProps }: CircleSubjectProps & Omit<SVGProps<SVGCircleElement>, keyof CircleSubjectProps>): import("react").JSX.Element;
