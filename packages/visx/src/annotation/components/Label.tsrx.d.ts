...
import type { Options as UseMeasureOptions } from '../../internal/useMeasure.tsrx';
export type LabelProps = {
    ...
    backgroundProps?: Octane.SVGProps<SVGRectElement>;
...
export default function Label({ anchorLineStroke, backgroundFill, backgroundPadding, backgroundProps, className, fontColor, horizontalAnchor: propsHorizontalAnchor, showAnchorLine, showBackground, subtitle, subtitleDy, subtitleFontSize, subtitleFontWeight, subtitleProps, title, titleFontSize, titleFontWeight, titleProps, verticalAnchor: propsVerticalAnchor, width: propWidth, maxWidth, x: propsX, y: propsY, }: LabelProps): import("react").JSX.Element | null;
