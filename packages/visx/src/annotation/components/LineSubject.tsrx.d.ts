...
export default function LineSubject({ className, x: propsX, y: propsY, orientation, min, max, stroke, ...restProps }: LineSubjectProps & Omit<Octane.SVGProps<SVGLineElement>, keyof LineSubjectProps>): import("react").JSX.Element;
