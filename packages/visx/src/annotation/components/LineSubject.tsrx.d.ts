...
export default function LineSubject({ className, x: propsX, y: propsY, orientation, min, max, stroke, ...restProps }: LineSubjectProps & Omit<SVGProps<SVGLineElement>, keyof LineSubjectProps>): import("react").JSX.Element;
