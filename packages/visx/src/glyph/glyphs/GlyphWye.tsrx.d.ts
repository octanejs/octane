...
export default function GlyphWye<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphWyeProps<Datum> & Omit<Octane.SVGProps<SVGPathElement>, keyof GlyphWyeProps<Datum>>): import("react").JSX.Element;
