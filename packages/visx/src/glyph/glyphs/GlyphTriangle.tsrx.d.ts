...
export default function GlyphTriangle<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphTriangleProps<Datum> & Omit<Octane.SVGProps<SVGPathElement>, keyof GlyphTriangleProps<Datum>>): import("react").JSX.Element;
