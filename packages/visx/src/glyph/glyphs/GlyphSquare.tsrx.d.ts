...
export default function GlyphSquare<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphSquareProps<Datum> & Omit<Octane.SVGProps<SVGPathElement>, keyof GlyphSquareProps<Datum>>): import("react").JSX.Element;
