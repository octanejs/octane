...
export default function GlyphDiamond<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphDiamondProps<Datum> & Omit<Octane.SVGProps<SVGPathElement>, keyof GlyphDiamondProps<Datum>>): import("react").JSX.Element;
