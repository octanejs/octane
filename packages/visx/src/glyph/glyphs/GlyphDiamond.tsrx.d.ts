...
export default function GlyphDiamond<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphDiamondProps<Datum> & Omit<SVGProps<SVGPathElement>, keyof GlyphDiamondProps<Datum>>): import("react").JSX.Element;
