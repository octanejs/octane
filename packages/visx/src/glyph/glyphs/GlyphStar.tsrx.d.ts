...
export default function GlyphStar<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphStarProps<Datum> & Omit<Octane.SVGProps<SVGPathElement>, keyof GlyphStarProps<Datum>>): import("react").JSX.Element;
