...
export default function GlyphDot({ top, left, className, ...restProps }: GlyphDotProps & Omit<Octane.SVGProps<SVGCircleElement>, keyof GlyphDotProps>): import("react").JSX.Element;
