...
export default function GlyphCross<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphCrossProps<Datum> & Omit<SVGProps<SVGPathElement>, keyof GlyphCrossProps<Datum>>): import("react").JSX.Element;
