...
export default function LinkVerticalStep<Link, Node>({ className, innerRef, data, path, percent, x, y, source, target, children, ...restProps }: AddSVGProps<LinkVerticalStepProps<Link, Node>, SVGPathElement>): import("react").JSX.Element;
export {};
