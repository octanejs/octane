...
export default function LinkVerticalCurve<Link, Node>({ className, children, data, innerRef, path, percent, x, y, source, target, ...restProps }: AddSVGProps<LinkVerticalCurveProps<Link, Node>, SVGPathElement>): import("react").JSX.Element;
