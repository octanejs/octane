...
export default function LinkRadialCurve<Link, Node>({ className, children, data, innerRef, path, percent, x, y, source, target, ...restProps }: AddSVGProps<LinkRadialCurveProps<Link, Node>, SVGPathElement>): import("react").JSX.Element;
