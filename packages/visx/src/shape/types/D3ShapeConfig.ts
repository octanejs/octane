...
export type AreaPathConfig<Datum> = {
	...
	/** Sets the curve factory (from @octanejs/visx/curve or d3-curve) for the area generator. Defaults to curveLinear. */
	curve?: CurveFactory;
...
export type RadialLinePathConfig<Datum> = {
	...
	defined?: AccessorForArrayItem<Datum, boolean>;
	/** Sets the curve factory (from @octanejs/visx/curve or d3-curve) for the radialLine generator. Defaults to curveLinear. */
	curve?: CurveFactory | CurveFactoryLineOnly;
