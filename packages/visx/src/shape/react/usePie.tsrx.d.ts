...
export default function usePie<Datum>({ data, innerRadius, outerRadius, cornerRadius, startAngle, endAngle, padAngle, padRadius, pieSort, pieSortValues, pieValue, }?: UsePieOptions<Datum>): UsePieResult<Datum>;
