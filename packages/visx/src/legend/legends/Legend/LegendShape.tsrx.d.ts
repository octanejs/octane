...
import type { FillAccessor, FormattedLabel, LegendShape as LegendShapeType, SizeAccessor, ShapeStyleAccessor } from '../../types';
...
export default function LegendShape<Data, Output>({ shape, width, height, margin, label, item, itemIndex, fill, size, shapeStyle, }: LegendShapeProps<Data, Output>): import("react").JSX.Element;
