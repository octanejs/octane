...
export default function CircleClipPath({ id, cx, cy, r, ...restProps }: CircleClipPathProps & Omit<Octane.SVGProps<SVGCircleElement>, keyof CircleClipPathProps>): import("react").JSX.Element;
