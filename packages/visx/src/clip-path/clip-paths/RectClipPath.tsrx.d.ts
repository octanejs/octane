...
export default function RectClipPath({ id, x, y, width, height, ...restProps }: RectClipPathProps & Omit<Octane.SVGProps<SVGRectElement>, keyof RectClipPathProps>): import("react").JSX.Element;
