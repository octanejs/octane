...
export default function Graticule({ graticule, lines, outline, extent, extentMajor, extentMinor, step, stepMajor, stepMinor, precision, children, ...restProps }: GraticuleProps & Omit<SVGProps<SVGPathElement>, keyof GraticuleProps>): import("react").JSX.Element;
