...
export default function Waves({ id, width, height, fill, stroke, strokeWidth, strokeDasharray, strokeLinecap, shapeRendering, background, className, }: PatternWavesProps): import("react").JSX.Element;
