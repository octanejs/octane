...
export default function Path({ id, width, height, path, fill, stroke, strokeWidth, strokeDasharray, strokeLinecap, shapeRendering, background, className, }: PatternPathProps): import("react").JSX.Element;
