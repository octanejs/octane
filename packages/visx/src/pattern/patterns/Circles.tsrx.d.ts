...
export default function Circles({ id, width, height, radius, fill, stroke, strokeWidth, strokeDasharray, background, complement, className, }: PatternCirclesProps): import("react").JSX.Element;
