...
export default function Hexagons({ id, height, fill, stroke, strokeWidth, strokeDasharray, strokeLinecap, shapeRendering, background, className, size, }: PatternHexagonsProps): import("react").JSX.Element;
