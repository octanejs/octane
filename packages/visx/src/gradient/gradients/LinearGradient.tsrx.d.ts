...
export type LinearGradientProps = LinearGradientOwnProps & Omit<Octane.SVGProps<SVGLinearGradientElement>, keyof LinearGradientOwnProps>;
export default function LinearGradient({ children, id, from, to, x1: _x1, y1: _y1, x2: _x2, y2: _y2, fromOffset, fromOpacity, toOffset, toOpacity, rotate, transform, vertical, ...restProps }: LinearGradientProps): import("react").JSX.Element;
export {};
