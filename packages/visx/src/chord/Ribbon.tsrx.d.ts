...
export default function Ribbon({ chord, source, target, radius, startAngle, endAngle, children, className, ...restProps }: Omit<SVGProps<SVGPathElement>, keyof RibbonProps> & RibbonProps): import("react").JSX.Element;
export {};
