...
import type { Options as ReactMarkdownOptions } from '@octanejs/markdown';
...
export const DEFAULT_REHYPE_PLUGINS_BEFORE_USER: PluggableList = [rehypeRaw, rehypeHighlight];
