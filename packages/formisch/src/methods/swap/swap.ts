 ...
 */
export interface SwapConfig<TSchema extends FormSchema, TFieldArrayPath extends RequiredPath> {
	/**
 ...
 */
export function swap<TSchema extends FormSchema, TFieldArrayPath extends RequiredPath>(
