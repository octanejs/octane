 ...
 *   :1794 throw on children for void elements                      → ported (children — compile/runtime validation)
 *   :1807 throw on dangerouslySetInnerHTML for void elements       → ported (children — compile/runtime validation)
 *   :1820 menuitem void element closing tag                        → skipped (obsolete element; React-specific void list + DEV warning)
 *   :1852 validate against multiple children props (mount)         → ported (children — direct/spread/de-opt validation)
 ...
 *   :2068 validate against multiple children props (update)        → ported (children — source-ordered runtime validation)
