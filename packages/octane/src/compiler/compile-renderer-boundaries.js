...
import {
	...
	lowerUniversalRendererRegionAst,
 ...
 */
function prepareRendererBoundaryRegionsText(source, filename, ownerRenderer, options = {}) {
 ...
 */
function prepareServerRendererBoundaryRegionsText(
	source,
	filename,
	ownerRenderer,
