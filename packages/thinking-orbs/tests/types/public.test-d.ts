import * as Orbs from '@octanejs/thinking-orbs';
...
const withRef: Orbs.ThinkingOrbProps = {
	ref: (canvas) => {
...
// @ts-expect-error The consumer ref targets a canvas.
const invalidRef: Orbs.ThinkingOrbProps = { ref: (canvas: HTMLInputElement) => {} };
