...
import { type SuspendTerminal, type TerminalSuspension } from './components/AppContext.js';
import { InkRoot, type InkRootProps } from './components/InkRoot.ink.tsrx';
...
export default class Ink {
	...
	*/
	...
	private readonly container: UniversalRoot;
	...
	constructor(options: Options) {
		...
		this.container = createUniversalRoot(createInkContainer(this.rootNode), createInkDriver());
	...
	render<P>(component: InkComponent<P>, props: P): void {
		this.container.render(InkRoot as unknown as UniversalComponent<InkRootProps<P>>, {
			component,
