// Adapted side: @octanejs/react-map-gl, compiled with tsrx-tsc. Assertion
...
// Permitted transformation 2: Octane has no React types, so the container style
// type comes from the binding's own prop rather than React.CSSProperties.
type ContainerStyle = NonNullable<MapProps['style']>;
...
const mapProps: MapProps = {
	...
	latitude: 38,
	zoom: 14,
	style: { height: 400 } satisfies ContainerStyle,
};
void mapProps;
void Map;
