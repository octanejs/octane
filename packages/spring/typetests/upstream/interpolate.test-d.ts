...
import { interpolate } from '@octanejs/spring';
import { SpringValue } from '@octanejs/spring';
import { Interpolation } from '@octanejs/spring';
...
it('with an array of SpringValues', () => {
	function scenario() {
		...
		// 2 values
		const out2 = interpolate(_ as [SpringValue<number>, SpringValue<string>], args);
