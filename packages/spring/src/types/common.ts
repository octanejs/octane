import type { Any, Remap } from './utils';
...
type NeverProps<T, P extends keyof T> = Remap<Pick<T, Exclude<keyof T, P>> & { [K in P]: never }>;
 ...
 */
export type IsPlainObject<T> = T extends ReadonlyArray<any> ? Any : T extends object ? object : Any;

export type StringKeys<T> = T extends IsPlainObject<T> ? string & keyof T : string;
