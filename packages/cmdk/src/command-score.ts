// Vendored from cmdk@1.1.1 (source: cmdk/src/command-score.ts, upstream repo
// dip/cmdk). The algorithm and every score constant are unchanged. The only
// edits are toolchain adaptations: the inner helpers gained explicit parameter
// type annotations for this package's `strict` typecheck (upstream ships them
// untyped), and the file is formatted to repo style. No logic was touched.
