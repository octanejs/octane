...
export type ReactFlowStore<NodeType extends Node = Node, EdgeType extends Edge = Edge> = {
	...
	onNodesChangeMiddlewareMap: Map<
		symbol,
		(changes: NodeChange<NodeType>[]) => NodeChange<NodeType>[]
	>;
	onEdgesChangeMiddlewareMap: Map<
		symbol,
		(changes: EdgeChange<EdgeType>[]) => EdgeChange<EdgeType>[]
	>;
};
...
> = ReactFlowStore<NodeType, EdgeType> & ReactFlowActions<NodeType, EdgeType>;
