...
// Pinned React counterpart of published-contract.ts.
...
import type * as Native0 from 'react-resizable-panels';
...
type Contract3 = Assert<Equal<Parameters<typeof Native0.useGroupCallbackRef>['length'], 0>>;
type Contract4 = Assert<Equal<Parameters<typeof Native0.useGroupRef>['length'], 0>>;
type Contract5 = Assert<Equal<Parameters<typeof Native0.useDefaultLayout>['length'], 1>>;
type Contract6 = Assert<Equal<Parameters<typeof Native0.usePanelCallbackRef>['length'], 0>>;
type Contract7 = Assert<Equal<Parameters<typeof Native0.usePanelRef>['length'], 0>>;
