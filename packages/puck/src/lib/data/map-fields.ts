import { ComponentData, Config, Content, Field, Fields, RootData } from '../../types';
...
const isPromise = <T = unknown>(v: any): v is Promise<T> => !!v && typeof v.then === 'function';
...
export const walkField = ({
	...
	if (value && typeof value === 'object') {
		if (Array.isArray(value)) {
			...
			const objectFields =
				fields[propKey]?.type === 'object' ? fields[propKey].objectFields : fields;
