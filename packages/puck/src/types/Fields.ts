import { ReactElement } from '../react-shim.js';
...
// DEPRECATED
export type ExternalFieldWithAdaptor<Props extends any = { [key: string]: any }> = BaseField & {
	type: 'external';
	placeholder?: string;
...
export type ExternalField<Props extends any = { [key: string]: any }> = BaseField & {
	type: 'external';
	placeholder?: string;
...
export type Field<ValueType = any, UserField extends {} = {}> =
	...
	| SelectField
	| RadioField
	| ArrayField<ValueType extends { [key: string]: any }[] ? ValueType : never, UserField>
