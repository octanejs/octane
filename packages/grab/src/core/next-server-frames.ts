import { formatOwnerStack, hasDebugStack, parseStack, type StackFrame } from '../bippy/source.js';
import { traverseFiber, type ScopedFiber } from '../bippy/index.js';
...
const extractServerFramesFromDebugStack = (rootFiber: ScopedFiber): Map<string, StackFrame> => {
