import { getOwnerStack, getSource, type StackFrame } from '../octane-adapter.js';
import {
			...
			try {
				...
				return {
					...
					componentName:
						...
						getSourceComponentName(fiber._debugOwner ?? undefined, isNextProject),
...
const getComponentNamesFromFiber = (
	...
	traverseFiber(getLatestFiber(fiber), (currentFiber) => {
