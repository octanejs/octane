...
import type { Fiber } from './octane-adapter.js';
import type { StackFrame as StackFrameType } from './octane-adapter.js';
export type StackFrame = StackFrameType;
...
import type {
	ElementAtPointOptions as ElementAtPointOptionsType,
	ElementBounds as ElementBoundsType,
} from './types.js';
import { resolveThreeElementAtPoint } from './core/three-selection.js';

export type ElementAtPointOptions = ElementAtPointOptionsType;
export type ElementBounds = ElementBoundsType;
