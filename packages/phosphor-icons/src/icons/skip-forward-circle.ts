...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M128,32a96,96,0,1,0,96,96A96,96,0,0,0,128,32ZM96,168V88l64,40Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('SkipForwardCircle', weights);

export { Component as SkipForwardCircle, Component as SkipForwardCircleIcon };
