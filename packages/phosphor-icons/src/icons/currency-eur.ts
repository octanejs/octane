...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M184,58.33V197.67A72,72,0,0,1,64,144V112A72,72,0,0,1,184,58.33Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('CurrencyEur', weights);

export { Component as CurrencyEur, Component as CurrencyEurIcon };
