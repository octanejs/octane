...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M208,144a80,80,0,0,1-160,0c0-72,80-128,80-128S208,72,208,144Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('DropSimple', weights);

export { Component as DropSimple, Component as DropSimpleIcon };
