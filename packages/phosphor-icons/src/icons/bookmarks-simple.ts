...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M168,72V224l-56-40L56,224V72a8,8,0,0,1,8-8h96A8,8,0,0,1,168,72Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('BookmarksSimple', weights);

export { Component as BookmarksSimple, Component as BookmarksSimpleIcon };
