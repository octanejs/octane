...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M224,136l-96,96L32,136H80V48a8,8,0,0,1,8-8h80a8,8,0,0,1,8,8v88Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('ArrowFatDown', weights);

export { Component as ArrowFatDown, Component as ArrowFatDownIcon };
