...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M128,32a96,96,0,1,0,96,96A96,96,0,0,0,128,32Zm32,128H96V96h64Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('StopCircle', weights);

export { Component as StopCircle, Component as StopCircleIcon };
