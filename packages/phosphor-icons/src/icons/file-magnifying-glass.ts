...
const Component = createIcon('FileMagnifyingGlass', weights);

export { Component as FileMagnifyingGlass, Component as FileMagnifyingGlassIcon };

export { Component as FileSearchIcon };
