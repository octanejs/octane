...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M240,168v16H176V168a48,48,0,0,0-96,0v16H16V168a112,112,0,0,1,224,0Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('Rainbow', weights);

export { Component as Rainbow, Component as RainbowIcon };
