...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M208,152a80,80,0,0,1-160,0C48,88,96,24,128,24S208,88,208,152Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('Egg', weights);

export { Component as Egg, Component as EggIcon };
