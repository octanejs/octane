...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M224,128a96,96,0,1,1-28.12-67.88l-45.25,45.25h0A32,32,0,1,0,160,128Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('Disc', weights);

export { Component as Disc, Component as DiscIcon };
