...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M154.91,202.91a72,72,0,1,1,0-101.82A72,72,0,0,1,154.91,202.91Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('GenderMale', weights);

export { Component as GenderMale, Component as GenderMaleIcon };
