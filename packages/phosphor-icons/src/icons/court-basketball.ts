...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M232,88v80H216a40,40,0,0,1,0-80ZM40,88H24v80H40a40,40,0,0,0,0-80Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('CourtBasketball', weights);

export { Component as CourtBasketball, Component as CourtBasketballIcon };
