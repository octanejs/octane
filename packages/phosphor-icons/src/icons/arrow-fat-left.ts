...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M216,88v80a8,8,0,0,1-8,8H120v48L24,128l96-96V80h88A8,8,0,0,1,216,88Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('ArrowFatLeft', weights);

export { Component as ArrowFatLeft, Component as ArrowFatLeftIcon };
