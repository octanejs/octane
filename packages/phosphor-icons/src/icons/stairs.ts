...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M208,40V96H152v40H104v40H48V40a8,8,0,0,1,8-8H200A8,8,0,0,1,208,40Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('Stairs', weights);

export { Component as Stairs, Component as StairsIcon };
