...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M192,48V224l-64-40L64,224V48a8,8,0,0,1,8-8H184A8,8,0,0,1,192,48Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('BookmarkSimple', weights);

export { Component as BookmarkSimple, Component as BookmarkSimpleIcon };
