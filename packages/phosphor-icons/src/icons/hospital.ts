...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M160,48V216H128V160H80v56H48V48a8,8,0,0,1,8-8h96A8,8,0,0,1,160,48Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('Hospital', weights);

export { Component as Hospital, Component as HospitalIcon };
