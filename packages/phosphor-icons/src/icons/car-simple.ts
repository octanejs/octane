...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M224,112H32L61.89,44.75A8,8,0,0,1,69.2,40H186.8a8,8,0,0,1,7.31,4.75Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('CarSimple', weights);

export { Component as CarSimple, Component as CarSimpleIcon };
