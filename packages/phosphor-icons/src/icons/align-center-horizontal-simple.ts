...
const Component = createIcon('AlignCenterHorizontalSimple', weights);

export { Component as AlignCenterHorizontalSimple, Component as AlignCenterHorizontalSimpleIcon };
