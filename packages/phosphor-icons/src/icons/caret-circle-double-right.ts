...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M195.88,195.88a96,96,0,1,1,0-135.76A96,96,0,0,1,195.88,195.88Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('CaretCircleDoubleRight', weights);

export { Component as CaretCircleDoubleRight, Component as CaretCircleDoubleRightIcon };
