...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M128,32a96,96,0,1,0,96,96A96,96,0,0,0,128,32Zm32,136L96,128l64-40Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('SkipBackCircle', weights);

export { Component as SkipBackCircle, Component as SkipBackCircleIcon };
