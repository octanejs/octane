...
const weights = {
	...
	duotone: [
		[
			'path',
			{ d: 'M232,192H24a8,8,0,0,1-4.8-14.4L128,96l108.79,81.6A8,8,0,0,1,232,192Z', opacity: '0.2' },
		],
		[
			'path',
			{
...
const Component = createIcon('CoatHanger', weights);

export { Component as CoatHanger, Component as CoatHangerIcon };
