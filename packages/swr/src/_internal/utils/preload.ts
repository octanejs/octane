import type { Middleware, Key, BareFetcher, GlobalState, FetcherResponse } from '../types.js';
import { serialize } from './serialize.js';
import { cache } from './config.js';
import { SWRGlobalState } from './global-state.js';
import { isUndefined } from './shared.js';
...
type PreloadFetcher<Data = unknown, SWRKey extends Key = Key> = SWRKey extends () => infer Arg
...
export const middleware: Middleware = (useSWRNext) => (key_, fetcher_, config) => {
