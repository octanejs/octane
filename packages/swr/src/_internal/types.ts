import type { SWRGlobalConfig } from '../index/index.js';
import type * as revalidateEvents from './events.js';
 ...
 * @public
 */
export type BareFetcher<Data = unknown> = (...args: any[]) => FetcherResponse<Data>;
 ...
 * @public
 */
export type Fetcher<Data = unknown, SWRKey extends Key = Key> = SWRKey extends () =>
	infer Arg | null | undefined | false
 ...
 * @internal
 */
export type BlockingData<Data = any, Options = SWRDefaultOptions<Data>> = SWRGlobalConfig extends {
	suspense: true;
}
	? true
...
export type MutatorOptions<Data = any, MutationData = Data> = {
	 ...
	 */
	optimisticData?:
		Data | ((currentData: Data | undefined, displayedData: Data | undefined) => Data);
...
export type MutatorWrapper<Fn> = Fn extends (...args: [...infer Parameters]) => infer Result
...
type SWRConfigurationWithOptionalFallback<Options> =
	...
	Options extends SWRConfiguration & Required<Pick<SWRConfiguration, 'fallbackData'>>
...
export type KeyLoader<Args extends Arguments = Arguments> =
	((index: number, previousPageData: any | null) => Args) | null;
...
export type Revalidator = (revalidateOpts?: RevalidatorOptions) => Promise<boolean> | void;
