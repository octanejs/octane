...
export interface SWRInfiniteMutatorOptions<Data = any, MutationData = Data> extends Omit<
...
export interface SWRInfiniteHook {
	...
	>(
		getKey: KeyLoader,
		config: SWRInfiniteConfiguration<Data, Error, SWRInfiniteFetcher<Data, KeyLoader>> | undefined,
	): SWRInfiniteResponse<Data, Error>;
	<
		Data = any,
		Error = any,
