...
export declare function removeBindingsDependingOnRoute(
	bindings: Set<string>,
...
export declare function compileCodeSplitReferenceRoute(
	opts: ParseAstOptions &
		CompileCodeSplitReferenceRouteOptions & {
			compilerPlugins?: Array<ReferenceRouteCompilerPlugin>;
		},
): GeneratorResult | null;
export declare function compileCodeSplitVirtualRoute(
	opts: ParseAstOptions & {
 ...
 */
export declare function compileCodeSplitSharedRoute(
	opts: ParseAstOptions & {
		sharedBindings: Set<string>;
		filename: string;
	},
