...
export declare function multiSortBy<T>(
	arr: Array<T>,
	accessors?: Array<(item: T) => any>,
): Array<T>;
/**
 ...
 * values are the same.
 */
export declare function sortRouteNodes(
...
export declare function hasRoutePathSegmentMetadata(
	metadata: RoutePathSegmentMetadata | undefined,
): metadata is RoutePathSegmentMetadata;
export declare function createRoutePathSegmentMetadata(
	routePath?: string,
	originalPath?: string,
): Array<RoutePathSegmentMetadata | undefined> | undefined;
export declare function createLiteralRoutePathSegmentMetadata(
	routePath: string,
	parent?: RouteNode,
	literalNewSegments?: boolean,
): Array<RoutePathSegmentMetadata | undefined> | undefined;
export declare function joinRoutePathSegmentMetadata(
	routePath: string,
	prefixPath: string,
 ...
 */
export declare function removeUnderscoresWithEscape(
	routePath?: string,
	originalPath?: string,
): string;
export declare function removeLayoutSegmentsAndUnderscoresWithEscape(
	routePath?: string,
	originalPath?: string,
 ...
 */
export declare function removeLayoutSegmentsWithEscape(
	routePath?: string,
	originalPath?: string,
): string;
/**
...
export declare function createTokenRegex(
	token: TokenMatcher,
	opts: {
 ...
 */
export declare function writeIfDifferent(
	filepath: string,
	content: string,
 ...
 */
export declare function hasParentRoute(
 ...
 */
export declare const createRouteNodesByFullPath: (
	routeNodes: Array<RouteNode>,
...
export declare function checkRouteFullPathUniqueness(
	_routes: Array<RouteNode>,
	config: Config,
): void;
export declare function buildRouteTreeConfig(
	nodes: Array<RouteNode>,
	disableTypes: boolean,
	depth?: number,
): Array<string>;
export declare function buildImportString(importDeclaration: ImportDeclaration): string;
export declare function mergeImportDeclarations(
...
export declare function getImportForRouteNode(
	node: RouteNode,
	config: Config,
