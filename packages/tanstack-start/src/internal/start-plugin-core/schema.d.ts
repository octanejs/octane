...
declare const importProtectionEnvRulesSchema: z.ZodObject<
	...
	z.core.$strip
>;
declare const importProtectionOptionsSchema: z.ZodOptional<
	z.ZodObject<
		{
...
declare const pageBaseSchema: z.ZodObject<
	...
	z.core.$strip
>;
declare const inlineCssSchema: z.ZodPipe<
	z.ZodDefault<
		z.ZodOptional<
			z.ZodUnion<
				readonly [
...
export declare const tanstackStartOptionsObjectSchema: z.ZodObject<
	...
	z.core.$strip
>;
export declare const tanstackStartOptionsSchema: z.ZodPrefault<
	z.ZodOptional<
		z.ZodObject<
			{
				srcDirectory: z.ZodDefault<z.ZodOptional<z.ZodString>>;
