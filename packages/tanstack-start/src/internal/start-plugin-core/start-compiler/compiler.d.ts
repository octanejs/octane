...
export declare function isCompilerTransformEnabledForEnv(
	transform: StartCompilerImportTransform,
	env: StartCompilerEnvironment,
): boolean;
export declare function isStartCompilerPluginEnabledForEnv(
...
export declare function getLookupKindsForEnv(
	env: 'client' | 'server',
	opts?: {
 ...
 */
export declare function detectKindsInCode(
	code: string,
	env: 'client' | 'server',
	opts?: {
		compilerTransforms?: Array<StartCompilerImportTransform> | undefined;
