	...
	return {
		...
		onExportSplitRouteProperty(ctx) {
			...
			if (!hmrIdent || !hmrSymbolIdent) {
				...
				ctx.programPath.unshiftContainer("body", t.importDeclaration([t.importSpecifier(hmrIdent, t.identifier("hmr")), t.importSpecifier(hmrSymbolIdent, t.identifier("HMR"))], t.stringLiteral("octane")));
			}
			...
			const candidateIdent = getUniqueProgramIdentifier(ctx.programPath, `TSROctane${name}Candidate`);
...
//# sourceMappingURL=octane-hmr-split-route-components.js.map