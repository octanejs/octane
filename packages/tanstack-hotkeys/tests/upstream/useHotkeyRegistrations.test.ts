// Ported from @tanstack/react-hotkeys@0.10.0 packages/react-hotkeys/tests/useHotkeyRegistrations.test.tsx
...
import { useHotkeyRegistrations } from '@octanejs/tanstack-hotkeys';
...
describe('useHotkeyRegistrations', () => {
	...
	// @parity-case adapted:upstream-usehotkeyregistrations:should-return-empty-arrays-when-no-registrations-exist
	...
	// @parity-case adapted:upstream-usehotkeyregistrations:should-return-hotkey-registrations-after-registering-hotkeys
	...
	// @parity-case adapted:upstream-usehotkeyregistrations:should-return-sequence-registrations-after-registering-sequences
	...
	// @parity-case adapted:upstream-usehotkeyregistrations:should-return-both-hotkeys-and-sequences
	...
	// @parity-case adapted:upstream-usehotkeyregistrations:should-not-expose-callback-on-hotkey-registrations
	...
	// @parity-case adapted:upstream-usehotkeyregistrations:should-update-reactively-when-hotkey-registrations-are-added
	...
	// @parity-case adapted:upstream-usehotkeyregistrations:should-update-reactively-when-hotkey-registrations-are-removed
	...
	// @parity-case adapted:upstream-usehotkeyregistrations:should-update-reactively-when-sequence-registrations-are-added
	...
	// @parity-case adapted:upstream-usehotkeyregistrations:should-work-without-hotkeysprovider-standalone-
	...
	// @parity-case adapted:upstream-usehotkeyregistrations:should-include-meta-accessible-via-options-meta
	it('should include meta accessible via options.meta', () => {
		...
		expect(result.current.hotkeys[0]!.options.meta?.description).toBe('Save document');
		expect(result.current.sequences[0]!.options.meta?.name).toBe('Go to top');
		expect(result.current.sequences[0]!.options.meta?.description).toBe('Scroll to the top');
	});
});
