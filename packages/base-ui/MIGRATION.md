# Migrating to `@octanejs/base-ui` 1.8

This binding now targets Base UI 1.8.0 and ships a companion `@octanejs/base-ui-utils` 0.4.0 package. Upstream 1.8 parity does not by itself preserve the previously published Octane binding surface.
