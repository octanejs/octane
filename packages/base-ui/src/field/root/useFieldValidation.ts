...
import type { WithBaseUIEvent } from '../../internals/types';
('use client');
import * as React from 'octane';
import { EMPTY_OBJECT } from '@octanejs/base-ui-utils/empty';
import { useTimeout } from '@octanejs/base-ui-utils/useTimeout';
...
import type { FieldValidityData, FieldRootState } from './FieldRoot.tsrx';
...
export function useFieldValidation(
	...
	const getValidationProps = React.useCallback(
		(disabled: boolean, externalProps: WithBaseUIEvent<HTMLProps> = {}) =>
			mergeProps<any>(
...
export interface UseFieldValidationReturnValue {
	getValidationProps: (disabled: boolean, props?: WithBaseUIEvent<HTMLProps>) => HTMLProps;
