...
import { type DialogRoot } from '../root/DialogRoot.tsrx';
...
function createInitialContext(triggerElements: PopupTriggerMap): Context {
	return {
		...
		backdropRef: { current: null } as React.RefObject<HTMLDivElement | null>,
		internalBackdropRef: { current: null } as React.RefObject<HTMLDivElement | null>,
