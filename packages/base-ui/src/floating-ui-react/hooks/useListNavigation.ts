...
import { useAnimationFrame } from '@octanejs/base-ui-utils/useAnimationFrame';
...
import { useFloatingParentNodeId, useFloatingTree } from '../components/FloatingTree.tsrx';
...
export interface UseListNavigationProps {
	 ...
	 */
	onNavigate?:
		((activeIndex: number | null, event: React.NativeEvent | undefined) => void) | undefined;
	/**
...
export function useListNavigation(
	...
	const onNavigate = useStableCallback((event?: React.NativeEvent) => {
	...
	const syncCurrentTarget = useStableCallback((event: React.NativeEvent<any>) => {
