...
export function stopEvent(event: Event | React.NativeEvent) {
	event.preventDefault();
	event.stopPropagation();
}

export function isReactEvent(event: any): event is React.NativeEvent {
...
export function isClickLikeEvent(event: Event | React.NativeEvent) {
