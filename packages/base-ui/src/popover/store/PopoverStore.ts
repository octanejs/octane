...
import { Timeout } from '@octanejs/base-ui-utils/useTimeout';
import { NOOP } from '@octanejs/base-ui-utils/empty';
import { type InteractionType } from '@octanejs/base-ui-utils/useEnhancedClickHandler';
import { type PopoverRoot } from '../root/PopoverRoot.tsrx';
...
function createInitialContext(triggerElements: PopupTriggerMap): Context {
	return {
		popupRef: { current: null } as React.RefObject<HTMLElement | null>,
