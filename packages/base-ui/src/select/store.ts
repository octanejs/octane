...
import {
	...
	hasNullItemLabel,
	stringifyAsValue,
} from '../internals/resolveValueLabel.tsrx';
import type { SelectRoot } from './root/SelectRoot.tsrx';
...
export type State = {
	...
	items:
		| Record<string, React.OctaneNode>
		| ReadonlyArray<{ label: React.OctaneNode; value: any }>
