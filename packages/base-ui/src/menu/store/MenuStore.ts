...
import { ReactStore } from '@octanejs/base-ui-utils/store';
import { EMPTY_OBJECT, NOOP } from '@octanejs/base-ui-utils/empty';
import type { InteractionType } from '@octanejs/base-ui-utils/useEnhancedClickHandler';
import type { MenuParent, MenuRoot } from '../root/MenuRoot.tsrx';
...
function createInitialContext(triggerElements: PopupTriggerMap): Context {
	return {
		positionerRef: { current: null } as React.RefObject<HTMLElement | null | null>,
		popupRef: { current: null } as React.RefObject<HTMLElement | null | null>,
		typingRef: { current: false },
		itemDomElements: { current: [] },
		itemLabels: { current: [] },
		allowMouseUpTriggerRef: { current: false },
		triggerFocusTargetRef: { current: null } as React.RefObject<HTMLElement | null>,
		beforeContentFocusGuardRef: { current: null } as React.RefObject<HTMLElement | null>,
