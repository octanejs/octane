...
import type { NavigationMenuRoot } from './NavigationMenuRoot.tsrx';
...
export const NavigationMenuRootContext = Object.assign(
	React.createContext<NavigationMenuRootContext<any> | undefined>(undefined),
	process.env.NODE_ENV !== 'production' ? { displayName: 'NavigationMenuRootContext' } : {},
);
