...
import { AnimationFrame } from '@octanejs/base-ui-utils/useAnimationFrame';
import { useStableCallback } from '@octanejs/base-ui-utils/useStableCallback';
import { useValueAsRef } from '@octanejs/base-ui-utils/useValueAsRef';
import { warn } from '@octanejs/base-ui-utils/warn';
import { ownerWindow } from '@octanejs/base-ui-utils/owner';
import type { HTMLProps } from '../../internals/types';
import { createChangeEventDetails } from '../../internals/createBaseUIEventDetails';
import { REASONS } from '../../internals/reasons';
import { useOpenChangeComplete } from '../../internals/useOpenChangeComplete.tsrx';
import { useAnimationsFinished } from '../../internals/useAnimationsFinished';
import * as CollapsiblePanelDataAttributes from './CollapsiblePanelDataAttributes';
import type { CollapsibleRoot } from '../root/CollapsibleRoot.tsrx';
...
export function useCollapsiblePanel(
	...
	useIsoLayoutEffect(() => {
		if (
			...
			// The measured pixel size has committed. Flush that starting layout
			// before the next animation-frame update applies the ending style;
			// Octane can commit that update before the browser's next style flush.
			panelRef.current?.getBoundingClientRect();
		}
	}, [open, mounted, transitionStatus, dimensions]);
...
// Bundlers replace this expression; keep the build constant local to this module.
