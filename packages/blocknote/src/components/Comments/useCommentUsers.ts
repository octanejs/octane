 ...
 */
export function useCommentUsers<U extends User = User>(userIds: string[]): Map<string, U> {
...
export function useCommentUser<U extends User = User>(userId: string): U | undefined {
