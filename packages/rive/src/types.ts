...
export type CanvasElementProps = {
	className?: string;
	style?: Record<string, string | number | undefined> | null;
	children?: OctaneNode;
...
export type RiveState = {
	...
	rive: Rive | null;
	RiveComponent: (props: CanvasElementProps) => OctaneNode;
};
...
export type UseViewModelParameters =
	{ name: string; useDefault?: never } | { useDefault?: boolean; name?: never };
