// Vendored verbatim from recharts@3.9.2 es6/state/selectors/polarAxisSelectors.js (framework-agnostic).
...
export var selectAngleAxis = createSelector(
	...
	(angleAxisSettings, layout) => {
		...
		return _objectSpread(
			_objectSpread({}, implicitAngleAxis),
			{},
			{
				type: evaluatedType,
			},
...
export var selectRadiusAxis = createSelector(
	...
	(radiusAxisSettings, layout) => {
		...
		var evaluatedType =
			(_getAxisTypeBasedOnLa2 = getAxisTypeBasedOnLayout(
				...
				: 'category';
		return _objectSpread(
			_objectSpread({}, implicitRadiusAxis),
			{},
			{
				type: evaluatedType,
			},
...
export var selectMaxRadius = createSelector(
...
export var selectOuterRadius = createSelector(
	[selectPolarOptions, selectMaxRadius],
	(polarChartOptions, maxRadius) => {
		if (polarChartOptions == null) {
			return undefined;
...
export var selectAngleAxisRangeWithReversed = createSelector(
	[selectAngleAxis, selectAngleAxisRange],
	combineAxisRangeWithReverse,
);
export var selectRadiusAxisRange = createSelector(
...
export var selectRadiusAxisRangeWithReversed = createSelector(
	[selectRadiusAxis, selectRadiusAxisRange],
	combineAxisRangeWithReverse,
);
export var selectPolarViewBox = createSelector(
	[
		selectChartLayout,
		selectPolarOptions,
		selectInnerRadius,
