// Vendored verbatim from recharts@3.9.2 es6/state/selectors/selectChartOffsetInternal.js (framework-agnostic).
 ...
 */
export var selectChartOffsetInternal = createSelector(
	[
		selectChartWidth,
		selectChartHeight,
		selectMargin,
...
export var selectAxisViewBox = createSelector(
	selectChartWidth,
	selectChartHeight,
	(width, height) => ({
		x: 0,
