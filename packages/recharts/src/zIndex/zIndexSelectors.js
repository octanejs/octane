// Vendored verbatim from recharts@3.9.2 es6/zIndex/zIndexSelectors.js (framework-agnostic).
 ...
 */
export var selectZIndexPortalElement = createSelector(
...
export var selectAllRegisteredZIndexes = createSelector(
	(state) => state.zIndex.zIndexMap,
	(zIndexMap) => {
