...
import iconData from '@lucide/icons/icons/decimals-arrow-left';
import createLucideIcon from '../createLucideIcon';

const DecimalsArrowLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/decimals-arrow-left';
