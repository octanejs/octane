...
import iconData from '@lucide/icons/icons/square-square';
import createLucideIcon from '../createLucideIcon';

const SquareSquare = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-square';
