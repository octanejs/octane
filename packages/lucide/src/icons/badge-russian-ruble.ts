...
import iconData from '@lucide/icons/icons/badge-russian-ruble';
import createLucideIcon from '../createLucideIcon';

const BadgeRussianRuble = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/badge-russian-ruble';
