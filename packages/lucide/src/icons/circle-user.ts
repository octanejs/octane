...
import iconData from '@lucide/icons/icons/circle-user';
import createLucideIcon from '../createLucideIcon';

const CircleUser = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-user';
