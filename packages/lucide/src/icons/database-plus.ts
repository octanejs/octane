...
import iconData from '@lucide/icons/icons/database-plus';
import createLucideIcon from '../createLucideIcon';

const DatabasePlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/database-plus';
