...
import iconData from '@lucide/icons/icons/navigation-2';
import createLucideIcon from '../createLucideIcon';

const Navigation2 = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/navigation-2';
