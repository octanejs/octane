...
import iconData from '@lucide/icons/icons/hourglass';
import createLucideIcon from '../createLucideIcon';

const Hourglass = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/hourglass';
