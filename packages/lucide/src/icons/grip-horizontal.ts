...
import iconData from '@lucide/icons/icons/grip-horizontal';
import createLucideIcon from '../createLucideIcon';

const GripHorizontal = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/grip-horizontal';
