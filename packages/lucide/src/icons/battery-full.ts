...
import iconData from '@lucide/icons/icons/battery-full';
import createLucideIcon from '../createLucideIcon';

const BatteryFull = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/battery-full';
