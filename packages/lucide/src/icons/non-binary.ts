...
import iconData from '@lucide/icons/icons/non-binary';
import createLucideIcon from '../createLucideIcon';

const NonBinary = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/non-binary';
