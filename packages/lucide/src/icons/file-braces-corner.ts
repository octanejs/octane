...
import iconData from '@lucide/icons/icons/file-braces-corner';
import createLucideIcon from '../createLucideIcon';

const FileBracesCorner = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-braces-corner';
