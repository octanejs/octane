...
import iconData from '@lucide/icons/icons/file-down';
import createLucideIcon from '../createLucideIcon';

const FileDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-down';
