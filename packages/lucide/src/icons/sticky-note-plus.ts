...
import iconData from '@lucide/icons/icons/sticky-note-plus';
import createLucideIcon from '../createLucideIcon';

const StickyNotePlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/sticky-note-plus';
