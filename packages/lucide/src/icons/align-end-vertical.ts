...
import iconData from '@lucide/icons/icons/align-end-vertical';
import createLucideIcon from '../createLucideIcon';

const AlignEndVertical = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/align-end-vertical';
