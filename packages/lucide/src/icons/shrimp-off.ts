...
import iconData from '@lucide/icons/icons/shrimp-off';
import createLucideIcon from '../createLucideIcon';

const ShrimpOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/shrimp-off';
