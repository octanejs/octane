...
import iconData from '@lucide/icons/icons/arrow-big-left';
import createLucideIcon from '../createLucideIcon';

const ArrowBigLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-big-left';
