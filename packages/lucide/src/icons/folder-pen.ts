...
import iconData from '@lucide/icons/icons/folder-pen';
import createLucideIcon from '../createLucideIcon';

const FolderPen = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-pen';
