...
import iconData from '@lucide/icons/icons/rotate-cw';
import createLucideIcon from '../createLucideIcon';

const RotateCw = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/rotate-cw';
