...
import iconData from '@lucide/icons/icons/rectangle-horizontal';
import createLucideIcon from '../createLucideIcon';

const RectangleHorizontal = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/rectangle-horizontal';
