...
import iconData from '@lucide/icons/icons/mic-audio-lines';
import createLucideIcon from '../createLucideIcon';

const MicAudioLines = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/mic-audio-lines';
