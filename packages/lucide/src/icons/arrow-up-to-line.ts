...
import iconData from '@lucide/icons/icons/arrow-up-to-line';
import createLucideIcon from '../createLucideIcon';

const ArrowUpToLine = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-up-to-line';
