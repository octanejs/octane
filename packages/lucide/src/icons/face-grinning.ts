...
import iconData from '@lucide/icons/icons/face-grinning';
import createLucideIcon from '../createLucideIcon';

const FaceGrinning = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/face-grinning';
