...
import iconData from '@lucide/icons/icons/camera-off';
import createLucideIcon from '../createLucideIcon';

const CameraOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/camera-off';
