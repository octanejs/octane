...
import iconData from '@lucide/icons/icons/phone-call';
import createLucideIcon from '../createLucideIcon';

const PhoneCall = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/phone-call';
