...
import iconData from '@lucide/icons/icons/phone-off';
import createLucideIcon from '../createLucideIcon';

const PhoneOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/phone-off';
