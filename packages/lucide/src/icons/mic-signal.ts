...
import iconData from '@lucide/icons/icons/mic-signal';
import createLucideIcon from '../createLucideIcon';

const MicSignal = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/mic-signal';
