...
import iconData from '@lucide/icons/icons/bed-double';
import createLucideIcon from '../createLucideIcon';

const BedDouble = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/bed-double';
