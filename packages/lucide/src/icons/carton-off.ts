...
import iconData from '@lucide/icons/icons/carton-off';
import createLucideIcon from '../createLucideIcon';

const CartonOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/carton-off';
