...
import iconData from '@lucide/icons/icons/list-plus';
import createLucideIcon from '../createLucideIcon';

const ListPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/list-plus';
