...
import iconData from '@lucide/icons/icons/audio-lines';
import createLucideIcon from '../createLucideIcon';

const AudioLines = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/audio-lines';
