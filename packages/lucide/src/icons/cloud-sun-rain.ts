...
import iconData from '@lucide/icons/icons/cloud-sun-rain';
import createLucideIcon from '../createLucideIcon';

const CloudSunRain = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cloud-sun-rain';
