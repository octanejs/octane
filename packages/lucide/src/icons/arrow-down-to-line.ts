...
import iconData from '@lucide/icons/icons/arrow-down-to-line';
import createLucideIcon from '../createLucideIcon';

const ArrowDownToLine = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-down-to-line';
