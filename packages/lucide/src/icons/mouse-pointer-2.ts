...
import iconData from '@lucide/icons/icons/mouse-pointer-2';
import createLucideIcon from '../createLucideIcon';

const MousePointer2 = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/mouse-pointer-2';
