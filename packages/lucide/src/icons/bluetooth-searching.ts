...
import iconData from '@lucide/icons/icons/bluetooth-searching';
import createLucideIcon from '../createLucideIcon';

const BluetoothSearching = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/bluetooth-searching';
