...
import iconData from '@lucide/icons/icons/circle-arrow-left';
import createLucideIcon from '../createLucideIcon';

const CircleArrowLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-arrow-left';
