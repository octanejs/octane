...
import iconData from '@lucide/icons/icons/message-circle-dashed-check';
import createLucideIcon from '../createLucideIcon';

const MessageCircleDashedCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-circle-dashed-check';
