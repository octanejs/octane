...
import iconData from '@lucide/icons/icons/phone-forwarded';
import createLucideIcon from '../createLucideIcon';

const PhoneForwarded = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/phone-forwarded';
