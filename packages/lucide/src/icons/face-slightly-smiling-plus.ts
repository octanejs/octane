...
import iconData from '@lucide/icons/icons/face-slightly-smiling-plus';
import createLucideIcon from '../createLucideIcon';

const FaceSlightlySmilingPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/face-slightly-smiling-plus';
