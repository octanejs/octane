...
import iconData from '@lucide/icons/icons/square-arrow-out-up-left';
import createLucideIcon from '../createLucideIcon';

const SquareArrowOutUpLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-arrow-out-up-left';
