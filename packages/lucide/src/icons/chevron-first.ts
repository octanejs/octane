...
import iconData from '@lucide/icons/icons/chevron-first';
import createLucideIcon from '../createLucideIcon';

const ChevronFirst = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chevron-first';
