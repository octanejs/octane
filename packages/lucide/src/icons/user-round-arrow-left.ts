...
import iconData from '@lucide/icons/icons/user-round-arrow-left';
import createLucideIcon from '../createLucideIcon';

const UserRoundArrowLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/user-round-arrow-left';
