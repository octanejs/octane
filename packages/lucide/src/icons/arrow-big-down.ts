...
import iconData from '@lucide/icons/icons/arrow-big-down';
import createLucideIcon from '../createLucideIcon';

const ArrowBigDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-big-down';
