...
import iconData from '@lucide/icons/icons/circle-chevron-left';
import createLucideIcon from '../createLucideIcon';

const CircleChevronLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-chevron-left';
