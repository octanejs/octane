...
import iconData from '@lucide/icons/icons/square-arrow-left';
import createLucideIcon from '../createLucideIcon';

const SquareArrowLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-arrow-left';
