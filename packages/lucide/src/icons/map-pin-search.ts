...
import iconData from '@lucide/icons/icons/map-pin-search';
import createLucideIcon from '../createLucideIcon';

const MapPinSearch = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/map-pin-search';
