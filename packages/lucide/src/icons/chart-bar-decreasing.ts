...
import iconData from '@lucide/icons/icons/chart-bar-decreasing';
import createLucideIcon from '../createLucideIcon';

const ChartBarDecreasing = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chart-bar-decreasing';
