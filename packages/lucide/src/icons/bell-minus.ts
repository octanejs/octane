...
import iconData from '@lucide/icons/icons/bell-minus';
import createLucideIcon from '../createLucideIcon';

const BellMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/bell-minus';
