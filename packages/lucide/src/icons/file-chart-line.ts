...
import iconData from '@lucide/icons/icons/file-chart-line';
import createLucideIcon from '../createLucideIcon';

const FileChartLine = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-chart-line';
