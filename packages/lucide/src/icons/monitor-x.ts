...
import iconData from '@lucide/icons/icons/monitor-x';
import createLucideIcon from '../createLucideIcon';

const MonitorX = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/monitor-x';
