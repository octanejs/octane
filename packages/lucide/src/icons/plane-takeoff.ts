...
import iconData from '@lucide/icons/icons/plane-takeoff';
import createLucideIcon from '../createLucideIcon';

const PlaneTakeoff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/plane-takeoff';
