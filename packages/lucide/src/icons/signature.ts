...
import iconData from '@lucide/icons/icons/signature';
import createLucideIcon from '../createLucideIcon';

const Signature = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/signature';
