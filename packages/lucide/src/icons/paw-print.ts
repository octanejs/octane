...
import iconData from '@lucide/icons/icons/paw-print';
import createLucideIcon from '../createLucideIcon';

const PawPrint = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/paw-print';
