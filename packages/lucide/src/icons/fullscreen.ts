...
import iconData from '@lucide/icons/icons/fullscreen';
import createLucideIcon from '../createLucideIcon';

const Fullscreen = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/fullscreen';
