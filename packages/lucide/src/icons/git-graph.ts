...
import iconData from '@lucide/icons/icons/git-graph';
import createLucideIcon from '../createLucideIcon';

const GitGraph = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/git-graph';
