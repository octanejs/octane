...
import iconData from '@lucide/icons/icons/panel-bottom-dashed';
import createLucideIcon from '../createLucideIcon';

const PanelBottomDashed = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/panel-bottom-dashed';
