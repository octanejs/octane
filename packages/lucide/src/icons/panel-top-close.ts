...
import iconData from '@lucide/icons/icons/panel-top-close';
import createLucideIcon from '../createLucideIcon';

const PanelTopClose = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/panel-top-close';
