...
import iconData from '@lucide/icons/icons/folder-output';
import createLucideIcon from '../createLucideIcon';

const FolderOutput = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-output';
