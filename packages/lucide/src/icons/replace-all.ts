...
import iconData from '@lucide/icons/icons/replace-all';
import createLucideIcon from '../createLucideIcon';

const ReplaceAll = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/replace-all';
