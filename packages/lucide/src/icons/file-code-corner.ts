...
import iconData from '@lucide/icons/icons/file-code-corner';
import createLucideIcon from '../createLucideIcon';

const FileCodeCorner = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-code-corner';
