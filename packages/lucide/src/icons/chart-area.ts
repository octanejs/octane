...
import iconData from '@lucide/icons/icons/chart-area';
import createLucideIcon from '../createLucideIcon';

const ChartArea = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chart-area';
