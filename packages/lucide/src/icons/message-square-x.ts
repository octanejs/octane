...
import iconData from '@lucide/icons/icons/message-square-x';
import createLucideIcon from '../createLucideIcon';

const MessageSquareX = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-square-x';
