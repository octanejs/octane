...
import iconData from '@lucide/icons/icons/file-archive';
import createLucideIcon from '../createLucideIcon';

const FileArchive = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-archive';
