...
import iconData from '@lucide/icons/icons/newspaper';
import createLucideIcon from '../createLucideIcon';

const Newspaper = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/newspaper';
