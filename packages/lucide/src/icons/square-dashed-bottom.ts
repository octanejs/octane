...
import iconData from '@lucide/icons/icons/square-dashed-bottom';
import createLucideIcon from '../createLucideIcon';

const SquareDashedBottom = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-dashed-bottom';
