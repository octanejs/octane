...
import iconData from '@lucide/icons/icons/message-square-off';
import createLucideIcon from '../createLucideIcon';

const MessageSquareOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-square-off';
