...
import iconData from '@lucide/icons/icons/move-up-right';
import createLucideIcon from '../createLucideIcon';

const MoveUpRight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/move-up-right';
