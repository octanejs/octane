...
import iconData from '@lucide/icons/icons/badge-check';
import createLucideIcon from '../createLucideIcon';

const BadgeCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/badge-check';
