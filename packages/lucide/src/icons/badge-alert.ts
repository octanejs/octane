...
import iconData from '@lucide/icons/icons/badge-alert';
import createLucideIcon from '../createLucideIcon';

const BadgeAlert = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/badge-alert';
