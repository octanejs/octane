...
import iconData from '@lucide/icons/icons/columns-2';
import createLucideIcon from '../createLucideIcon';

const Columns2 = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/columns-2';
