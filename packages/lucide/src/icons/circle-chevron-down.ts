...
import iconData from '@lucide/icons/icons/circle-chevron-down';
import createLucideIcon from '../createLucideIcon';

const CircleChevronDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-chevron-down';
