...
import iconData from '@lucide/icons/icons/paperclip';
import createLucideIcon from '../createLucideIcon';

const Paperclip = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/paperclip';
