...
import iconData from '@lucide/icons/icons/life-buoy';
import createLucideIcon from '../createLucideIcon';

const LifeBuoy = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/life-buoy';
