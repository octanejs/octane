...
import iconData from '@lucide/icons/icons/fold-vertical';
import createLucideIcon from '../createLucideIcon';

const FoldVertical = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/fold-vertical';
