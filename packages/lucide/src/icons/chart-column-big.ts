...
import iconData from '@lucide/icons/icons/chart-column-big';
import createLucideIcon from '../createLucideIcon';

const ChartColumnBig = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chart-column-big';
