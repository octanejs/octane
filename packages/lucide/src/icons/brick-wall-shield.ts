...
import iconData from '@lucide/icons/icons/brick-wall-shield';
import createLucideIcon from '../createLucideIcon';

const BrickWallShield = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/brick-wall-shield';
