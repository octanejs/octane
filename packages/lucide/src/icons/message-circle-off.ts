...
import iconData from '@lucide/icons/icons/message-circle-off';
import createLucideIcon from '../createLucideIcon';

const MessageCircleOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-circle-off';
