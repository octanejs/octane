...
import iconData from '@lucide/icons/icons/heading-6';
import createLucideIcon from '../createLucideIcon';

const Heading6 = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/heading-6';
