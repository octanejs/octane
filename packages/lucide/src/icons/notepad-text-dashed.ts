...
import iconData from '@lucide/icons/icons/notepad-text-dashed';
import createLucideIcon from '../createLucideIcon';

const NotepadTextDashed = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/notepad-text-dashed';
