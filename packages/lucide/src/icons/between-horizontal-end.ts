...
import iconData from '@lucide/icons/icons/between-horizontal-end';
import createLucideIcon from '../createLucideIcon';

const BetweenHorizontalEnd = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/between-horizontal-end';
