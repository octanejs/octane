...
import iconData from '@lucide/icons/icons/align-start-vertical';
import createLucideIcon from '../createLucideIcon';

const AlignStartVertical = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/align-start-vertical';
