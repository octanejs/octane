...
import iconData from '@lucide/icons/icons/banknote-arrow-down';
import createLucideIcon from '../createLucideIcon';

const BanknoteArrowDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/banknote-arrow-down';
