...
import iconData from '@lucide/icons/icons/building-complex';
import createLucideIcon from '../createLucideIcon';

const BuildingComplex = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/building-complex';
