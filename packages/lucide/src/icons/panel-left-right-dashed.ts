...
import iconData from '@lucide/icons/icons/panel-left-right-dashed';
import createLucideIcon from '../createLucideIcon';

const PanelLeftRightDashed = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/panel-left-right-dashed';
