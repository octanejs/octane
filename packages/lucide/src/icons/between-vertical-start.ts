...
import iconData from '@lucide/icons/icons/between-vertical-start';
import createLucideIcon from '../createLucideIcon';

const BetweenVerticalStart = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/between-vertical-start';
