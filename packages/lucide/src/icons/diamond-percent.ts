...
import iconData from '@lucide/icons/icons/diamond-percent';
import createLucideIcon from '../createLucideIcon';

const DiamondPercent = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/diamond-percent';
