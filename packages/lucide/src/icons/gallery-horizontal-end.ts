...
import iconData from '@lucide/icons/icons/gallery-horizontal-end';
import createLucideIcon from '../createLucideIcon';

const GalleryHorizontalEnd = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/gallery-horizontal-end';
