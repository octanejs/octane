...
import iconData from '@lucide/icons/icons/archive-restore';
import createLucideIcon from '../createLucideIcon';

const ArchiveRestore = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/archive-restore';
