...
import iconData from '@lucide/icons/icons/keyboard-off';
import createLucideIcon from '../createLucideIcon';

const KeyboardOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/keyboard-off';
