...
import iconData from '@lucide/icons/icons/arrow-left-from-line';
import createLucideIcon from '../createLucideIcon';

const ArrowLeftFromLine = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-left-from-line';
