...
import iconData from '@lucide/icons/icons/badge-info';
import createLucideIcon from '../createLucideIcon';

const BadgeInfo = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/badge-info';
