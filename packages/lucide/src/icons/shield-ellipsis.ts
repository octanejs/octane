...
import iconData from '@lucide/icons/icons/shield-ellipsis';
import createLucideIcon from '../createLucideIcon';

const ShieldEllipsis = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/shield-ellipsis';
