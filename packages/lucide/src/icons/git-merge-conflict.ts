...
import iconData from '@lucide/icons/icons/git-merge-conflict';
import createLucideIcon from '../createLucideIcon';

const GitMergeConflict = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/git-merge-conflict';
