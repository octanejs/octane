...
import iconData from '@lucide/icons/icons/panel-left-open';
import createLucideIcon from '../createLucideIcon';

const PanelLeftOpen = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/panel-left-open';
