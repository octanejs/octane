...
import iconData from '@lucide/icons/icons/decimals-arrow-right';
import createLucideIcon from '../createLucideIcon';

const DecimalsArrowRight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/decimals-arrow-right';
