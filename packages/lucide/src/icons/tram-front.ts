...
import iconData from '@lucide/icons/icons/tram-front';
import createLucideIcon from '../createLucideIcon';

const TramFront = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/tram-front';
