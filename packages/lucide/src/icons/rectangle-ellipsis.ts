...
import iconData from '@lucide/icons/icons/rectangle-ellipsis';
import createLucideIcon from '../createLucideIcon';

const RectangleEllipsis = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/rectangle-ellipsis';
