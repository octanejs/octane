...
import iconData from '@lucide/icons/icons/cloud-drizzle';
import createLucideIcon from '../createLucideIcon';

const CloudDrizzle = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cloud-drizzle';
