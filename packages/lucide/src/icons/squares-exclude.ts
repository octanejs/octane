...
import iconData from '@lucide/icons/icons/squares-exclude';
import createLucideIcon from '../createLucideIcon';

const SquaresExclude = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/squares-exclude';
