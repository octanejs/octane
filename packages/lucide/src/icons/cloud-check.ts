...
import iconData from '@lucide/icons/icons/cloud-check';
import createLucideIcon from '../createLucideIcon';

const CloudCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cloud-check';
