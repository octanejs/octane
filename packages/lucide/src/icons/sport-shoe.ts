...
import iconData from '@lucide/icons/icons/sport-shoe';
import createLucideIcon from '../createLucideIcon';

const SportShoe = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/sport-shoe';
