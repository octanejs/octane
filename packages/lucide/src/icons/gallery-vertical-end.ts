...
import iconData from '@lucide/icons/icons/gallery-vertical-end';
import createLucideIcon from '../createLucideIcon';

const GalleryVerticalEnd = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/gallery-vertical-end';
