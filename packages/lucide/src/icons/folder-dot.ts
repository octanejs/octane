...
import iconData from '@lucide/icons/icons/folder-dot';
import createLucideIcon from '../createLucideIcon';

const FolderDot = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-dot';
