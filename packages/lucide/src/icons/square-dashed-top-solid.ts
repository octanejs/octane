...
import iconData from '@lucide/icons/icons/square-dashed-top-solid';
import createLucideIcon from '../createLucideIcon';

const SquareDashedTopSolid = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-dashed-top-solid';
