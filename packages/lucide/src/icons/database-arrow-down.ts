...
import iconData from '@lucide/icons/icons/database-arrow-down';
import createLucideIcon from '../createLucideIcon';

const DatabaseArrowDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/database-arrow-down';
