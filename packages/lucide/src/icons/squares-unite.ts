...
import iconData from '@lucide/icons/icons/squares-unite';
import createLucideIcon from '../createLucideIcon';

const SquaresUnite = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/squares-unite';
