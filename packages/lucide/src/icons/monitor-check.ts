...
import iconData from '@lucide/icons/icons/monitor-check';
import createLucideIcon from '../createLucideIcon';

const MonitorCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/monitor-check';
