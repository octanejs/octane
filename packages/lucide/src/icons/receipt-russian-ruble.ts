...
import iconData from '@lucide/icons/icons/receipt-russian-ruble';
import createLucideIcon from '../createLucideIcon';

const ReceiptRussianRuble = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/receipt-russian-ruble';
