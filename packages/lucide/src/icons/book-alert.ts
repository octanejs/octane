...
import iconData from '@lucide/icons/icons/book-alert';
import createLucideIcon from '../createLucideIcon';

const BookAlert = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/book-alert';
