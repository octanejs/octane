...
import iconData from '@lucide/icons/icons/layers-plus';
import createLucideIcon from '../createLucideIcon';

const LayersPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/layers-plus';
