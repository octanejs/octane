...
import iconData from '@lucide/icons/icons/thumbs-down';
import createLucideIcon from '../createLucideIcon';

const ThumbsDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/thumbs-down';
