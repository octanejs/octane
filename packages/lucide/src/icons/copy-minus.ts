...
import iconData from '@lucide/icons/icons/copy-minus';
import createLucideIcon from '../createLucideIcon';

const CopyMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/copy-minus';
