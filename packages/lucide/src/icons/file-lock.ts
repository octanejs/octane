...
import iconData from '@lucide/icons/icons/file-lock';
import createLucideIcon from '../createLucideIcon';

const FileLock = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-lock';
