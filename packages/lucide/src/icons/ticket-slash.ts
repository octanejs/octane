...
import iconData from '@lucide/icons/icons/ticket-slash';
import createLucideIcon from '../createLucideIcon';

const TicketSlash = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/ticket-slash';
