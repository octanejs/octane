...
import iconData from '@lucide/icons/icons/bow-arrow';
import createLucideIcon from '../createLucideIcon';

const BowArrow = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/bow-arrow';
