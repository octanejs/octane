...
import iconData from '@lucide/icons/icons/circle-arrow-right';
import createLucideIcon from '../createLucideIcon';

const CircleArrowRight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-arrow-right';
