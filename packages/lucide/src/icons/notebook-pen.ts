...
import iconData from '@lucide/icons/icons/notebook-pen';
import createLucideIcon from '../createLucideIcon';

const NotebookPen = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/notebook-pen';
