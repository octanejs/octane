...
import iconData from '@lucide/icons/icons/id-card-lanyard';
import createLucideIcon from '../createLucideIcon';

const IdCardLanyard = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/id-card-lanyard';
