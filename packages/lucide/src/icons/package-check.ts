...
import iconData from '@lucide/icons/icons/package-check';
import createLucideIcon from '../createLucideIcon';

const PackageCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/package-check';
