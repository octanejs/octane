...
import iconData from '@lucide/icons/icons/waypoints';
import createLucideIcon from '../createLucideIcon';

const Waypoints = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/waypoints';
