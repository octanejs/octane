...
import iconData from '@lucide/icons/icons/star-plus';
import createLucideIcon from '../createLucideIcon';

const StarPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/star-plus';
