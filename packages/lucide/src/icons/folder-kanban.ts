...
import iconData from '@lucide/icons/icons/folder-kanban';
import createLucideIcon from '../createLucideIcon';

const FolderKanban = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-kanban';
