...
import iconData from '@lucide/icons/icons/piggy-bank';
import createLucideIcon from '../createLucideIcon';

const PiggyBank = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/piggy-bank';
