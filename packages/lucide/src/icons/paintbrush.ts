...
import iconData from '@lucide/icons/icons/paintbrush';
import createLucideIcon from '../createLucideIcon';

const Paintbrush = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/paintbrush';
