...
import iconData from '@lucide/icons/icons/bed-single';
import createLucideIcon from '../createLucideIcon';

const BedSingle = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/bed-single';
