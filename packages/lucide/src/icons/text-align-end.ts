...
import iconData from '@lucide/icons/icons/text-align-end';
import createLucideIcon from '../createLucideIcon';

const TextAlignEnd = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/text-align-end';
