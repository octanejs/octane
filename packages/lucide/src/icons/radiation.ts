...
import iconData from '@lucide/icons/icons/radiation';
import createLucideIcon from '../createLucideIcon';

const Radiation = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/radiation';
