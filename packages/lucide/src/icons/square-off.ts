...
import iconData from '@lucide/icons/icons/square-off';
import createLucideIcon from '../createLucideIcon';

const SquareOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-off';
