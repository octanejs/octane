...
import iconData from '@lucide/icons/icons/map-pin-plus';
import createLucideIcon from '../createLucideIcon';

const MapPinPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/map-pin-plus';
