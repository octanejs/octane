...
import iconData from '@lucide/icons/icons/receipt-indian-rupee';
import createLucideIcon from '../createLucideIcon';

const ReceiptIndianRupee = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/receipt-indian-rupee';
