...
import iconData from '@lucide/icons/icons/shield-user';
import createLucideIcon from '../createLucideIcon';

const ShieldUser = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/shield-user';
