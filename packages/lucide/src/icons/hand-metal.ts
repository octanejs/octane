...
import iconData from '@lucide/icons/icons/hand-metal';
import createLucideIcon from '../createLucideIcon';

const HandMetal = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/hand-metal';
