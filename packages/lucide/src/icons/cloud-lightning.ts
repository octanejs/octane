...
import iconData from '@lucide/icons/icons/cloud-lightning';
import createLucideIcon from '../createLucideIcon';

const CloudLightning = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cloud-lightning';
