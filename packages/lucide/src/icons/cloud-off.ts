...
import iconData from '@lucide/icons/icons/cloud-off';
import createLucideIcon from '../createLucideIcon';

const CloudOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cloud-off';
