...
import iconData from '@lucide/icons/icons/badge-pound-sterling';
import createLucideIcon from '../createLucideIcon';

const BadgePoundSterling = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/badge-pound-sterling';
