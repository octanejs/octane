...
import iconData from '@lucide/icons/icons/square-stop';
import createLucideIcon from '../createLucideIcon';

const SquareStop = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-stop';
