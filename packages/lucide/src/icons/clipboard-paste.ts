...
import iconData from '@lucide/icons/icons/clipboard-paste';
import createLucideIcon from '../createLucideIcon';

const ClipboardPaste = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/clipboard-paste';
