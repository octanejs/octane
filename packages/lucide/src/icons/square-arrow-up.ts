...
import iconData from '@lucide/icons/icons/square-arrow-up';
import createLucideIcon from '../createLucideIcon';

const SquareArrowUp = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-arrow-up';
