...
import iconData from '@lucide/icons/icons/circle-slash-2';
import createLucideIcon from '../createLucideIcon';

const CircleSlash2 = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-slash-2';
