...
import iconData from '@lucide/icons/icons/brain-circuit';
import createLucideIcon from '../createLucideIcon';

const BrainCircuit = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/brain-circuit';
