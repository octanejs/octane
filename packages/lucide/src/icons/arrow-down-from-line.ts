...
import iconData from '@lucide/icons/icons/arrow-down-from-line';
import createLucideIcon from '../createLucideIcon';

const ArrowDownFromLine = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-down-from-line';
