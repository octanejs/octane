...
import iconData from '@lucide/icons/icons/disc-album';
import createLucideIcon from '../createLucideIcon';

const DiscAlbum = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/disc-album';
