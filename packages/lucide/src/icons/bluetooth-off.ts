...
import iconData from '@lucide/icons/icons/bluetooth-off';
import createLucideIcon from '../createLucideIcon';

const BluetoothOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/bluetooth-off';
