...
import iconData from '@lucide/icons/icons/folder-archive';
import createLucideIcon from '../createLucideIcon';

const FolderArchive = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-archive';
