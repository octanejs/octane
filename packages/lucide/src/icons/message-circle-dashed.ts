...
import iconData from '@lucide/icons/icons/message-circle-dashed';
import createLucideIcon from '../createLucideIcon';

const MessageCircleDashed = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-circle-dashed';
