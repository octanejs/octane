...
import iconData from '@lucide/icons/icons/indian-rupee';
import createLucideIcon from '../createLucideIcon';

const IndianRupee = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/indian-rupee';
