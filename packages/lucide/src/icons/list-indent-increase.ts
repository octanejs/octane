...
import iconData from '@lucide/icons/icons/list-indent-increase';
import createLucideIcon from '../createLucideIcon';

const ListIndentIncrease = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/list-indent-increase';
