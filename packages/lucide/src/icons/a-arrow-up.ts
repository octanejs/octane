...
import iconData from '@lucide/icons/icons/a-arrow-up';
import createLucideIcon from '../createLucideIcon';

const AArrowUp = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/a-arrow-up';
