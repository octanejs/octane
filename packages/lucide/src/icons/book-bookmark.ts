...
import iconData from '@lucide/icons/icons/book-bookmark';
import createLucideIcon from '../createLucideIcon';

const BookBookmark = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/book-bookmark';
