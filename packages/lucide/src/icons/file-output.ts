...
import iconData from '@lucide/icons/icons/file-output';
import createLucideIcon from '../createLucideIcon';

const FileOutput = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-output';
