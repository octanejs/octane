...
import iconData from '@lucide/icons/icons/ticket-check';
import createLucideIcon from '../createLucideIcon';

const TicketCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/ticket-check';
