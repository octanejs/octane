...
import iconData from '@lucide/icons/icons/chess-rook';
import createLucideIcon from '../createLucideIcon';

const ChessRook = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chess-rook';
