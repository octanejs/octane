...
import iconData from '@lucide/icons/icons/align-start-horizontal';
import createLucideIcon from '../createLucideIcon';

const AlignStartHorizontal = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/align-start-horizontal';
