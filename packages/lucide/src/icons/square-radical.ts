...
import iconData from '@lucide/icons/icons/square-radical';
import createLucideIcon from '../createLucideIcon';

const SquareRadical = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-radical';
