...
import iconData from '@lucide/icons/icons/soap-dispenser-droplet';
import createLucideIcon from '../createLucideIcon';

const SoapDispenserDroplet = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/soap-dispenser-droplet';
