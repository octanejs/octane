...
import iconData from '@lucide/icons/icons/closed-caption';
import createLucideIcon from '../createLucideIcon';

const ClosedCaption = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/closed-caption';
