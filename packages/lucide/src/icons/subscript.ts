...
import iconData from '@lucide/icons/icons/subscript';
import createLucideIcon from '../createLucideIcon';

const Subscript = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/subscript';
