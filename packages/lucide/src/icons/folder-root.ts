...
import iconData from '@lucide/icons/icons/folder-root';
import createLucideIcon from '../createLucideIcon';

const FolderRoot = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-root';
