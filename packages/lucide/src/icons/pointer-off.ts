...
import iconData from '@lucide/icons/icons/pointer-off';
import createLucideIcon from '../createLucideIcon';

const PointerOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/pointer-off';
