...
import iconData from '@lucide/icons/icons/message-square-warning';
import createLucideIcon from '../createLucideIcon';

const MessageSquareWarning = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-square-warning';
