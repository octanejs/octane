...
import iconData from '@lucide/icons/icons/flashlight';
import createLucideIcon from '../createLucideIcon';

const Flashlight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/flashlight';
