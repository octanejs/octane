...
import iconData from '@lucide/icons/icons/message-square-reply';
import createLucideIcon from '../createLucideIcon';

const MessageSquareReply = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-square-reply';
