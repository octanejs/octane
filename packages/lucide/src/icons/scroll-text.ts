...
import iconData from '@lucide/icons/icons/scroll-text';
import createLucideIcon from '../createLucideIcon';

const ScrollText = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/scroll-text';
