...
import iconData from '@lucide/icons/icons/git-branch';
import createLucideIcon from '../createLucideIcon';

const GitBranch = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/git-branch';
