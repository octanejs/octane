...
import iconData from '@lucide/icons/icons/shield-question-mark';
import createLucideIcon from '../createLucideIcon';

const ShieldQuestionMark = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/shield-question-mark';
