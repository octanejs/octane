...
import iconData from '@lucide/icons/icons/cloud-moon';
import createLucideIcon from '../createLucideIcon';

const CloudMoon = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cloud-moon';
