...
import iconData from '@lucide/icons/icons/book-minus';
import createLucideIcon from '../createLucideIcon';

const BookMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/book-minus';
