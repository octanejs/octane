...
import iconData from '@lucide/icons/icons/webcam-off';
import createLucideIcon from '../createLucideIcon';

const WebcamOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/webcam-off';
