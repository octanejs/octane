...
import iconData from '@lucide/icons/icons/mouse-left';
import createLucideIcon from '../createLucideIcon';

const MouseLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/mouse-left';
