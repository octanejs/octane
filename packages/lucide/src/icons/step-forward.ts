...
import iconData from '@lucide/icons/icons/step-forward';
import createLucideIcon from '../createLucideIcon';

const StepForward = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/step-forward';
