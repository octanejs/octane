...
import iconData from '@lucide/icons/icons/bell-check';
import createLucideIcon from '../createLucideIcon';

const BellCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/bell-check';
