...
import iconData from '@lucide/icons/icons/dollar-sign';
import createLucideIcon from '../createLucideIcon';

const DollarSign = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/dollar-sign';
