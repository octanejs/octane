...
import iconData from '@lucide/icons/icons/phone-outgoing';
import createLucideIcon from '../createLucideIcon';

const PhoneOutgoing = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/phone-outgoing';
