...
import iconData from '@lucide/icons/icons/ethernet-port';
import createLucideIcon from '../createLucideIcon';

const EthernetPort = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/ethernet-port';
