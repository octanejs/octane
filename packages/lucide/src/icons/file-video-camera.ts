...
import iconData from '@lucide/icons/icons/file-video-camera';
import createLucideIcon from '../createLucideIcon';

const FileVideoCamera = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-video-camera';
