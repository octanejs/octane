...
import iconData from '@lucide/icons/icons/chess-king';
import createLucideIcon from '../createLucideIcon';

const ChessKing = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chess-king';
