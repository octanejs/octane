...
import iconData from '@lucide/icons/icons/remove-formatting';
import createLucideIcon from '../createLucideIcon';

const RemoveFormatting = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/remove-formatting';
