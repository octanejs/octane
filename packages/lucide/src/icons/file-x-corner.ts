...
import iconData from '@lucide/icons/icons/file-x-corner';
import createLucideIcon from '../createLucideIcon';

const FileXCorner = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-x-corner';
