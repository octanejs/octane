...
import iconData from '@lucide/icons/icons/message-circle-plus';
import createLucideIcon from '../createLucideIcon';

const MessageCirclePlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-circle-plus';
