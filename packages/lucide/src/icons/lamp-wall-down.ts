...
import iconData from '@lucide/icons/icons/lamp-wall-down';
import createLucideIcon from '../createLucideIcon';

const LampWallDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/lamp-wall-down';
