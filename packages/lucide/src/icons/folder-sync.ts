...
import iconData from '@lucide/icons/icons/folder-sync';
import createLucideIcon from '../createLucideIcon';

const FolderSync = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-sync';
