...
import iconData from '@lucide/icons/icons/heart-pulse';
import createLucideIcon from '../createLucideIcon';

const HeartPulse = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/heart-pulse';
