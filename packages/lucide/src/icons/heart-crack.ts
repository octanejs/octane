...
import iconData from '@lucide/icons/icons/heart-crack';
import createLucideIcon from '../createLucideIcon';

const HeartCrack = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/heart-crack';
