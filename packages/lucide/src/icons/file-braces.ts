...
import iconData from '@lucide/icons/icons/file-braces';
import createLucideIcon from '../createLucideIcon';

const FileBraces = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-braces';
