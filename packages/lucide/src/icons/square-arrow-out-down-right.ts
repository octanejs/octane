...
import iconData from '@lucide/icons/icons/square-arrow-out-down-right';
import createLucideIcon from '../createLucideIcon';

const SquareArrowOutDownRight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-arrow-out-down-right';
