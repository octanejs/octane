...
import iconData from '@lucide/icons/icons/captions-off';
import createLucideIcon from '../createLucideIcon';

const CaptionsOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/captions-off';
