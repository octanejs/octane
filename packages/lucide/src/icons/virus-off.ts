...
import iconData from '@lucide/icons/icons/virus-off';
import createLucideIcon from '../createLucideIcon';

const VirusOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/virus-off';
