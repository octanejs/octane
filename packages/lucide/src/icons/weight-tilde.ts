...
import iconData from '@lucide/icons/icons/weight-tilde';
import createLucideIcon from '../createLucideIcon';

const WeightTilde = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/weight-tilde';
