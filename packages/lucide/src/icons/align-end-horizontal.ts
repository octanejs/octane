...
import iconData from '@lucide/icons/icons/align-end-horizontal';
import createLucideIcon from '../createLucideIcon';

const AlignEndHorizontal = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/align-end-horizontal';
