...
import iconData from '@lucide/icons/icons/user-round-minus';
import createLucideIcon from '../createLucideIcon';

const UserRoundMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/user-round-minus';
