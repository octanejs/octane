...
import iconData from '@lucide/icons/icons/wallpaper';
import createLucideIcon from '../createLucideIcon';

const Wallpaper = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/wallpaper';
