...
import iconData from '@lucide/icons/icons/chart-column-stacked';
import createLucideIcon from '../createLucideIcon';

const ChartColumnStacked = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chart-column-stacked';
