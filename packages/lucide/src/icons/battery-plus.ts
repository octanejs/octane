...
import iconData from '@lucide/icons/icons/battery-plus';
import createLucideIcon from '../createLucideIcon';

const BatteryPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/battery-plus';
