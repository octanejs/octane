...
import iconData from '@lucide/icons/icons/line-style';
import createLucideIcon from '../createLucideIcon';

const LineStyle = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/line-style';
