...
import iconData from '@lucide/icons/icons/calendar-minus';
import createLucideIcon from '../createLucideIcon';

const CalendarMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/calendar-minus';
