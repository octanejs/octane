...
import iconData from '@lucide/icons/icons/circle-euro';
import createLucideIcon from '../createLucideIcon';

const CircleEuro = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-euro';
