...
import iconData from '@lucide/icons/icons/arrow-right';
import createLucideIcon from '../createLucideIcon';

const ArrowRight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-right';
