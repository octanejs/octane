...
import iconData from '@lucide/icons/icons/file-badge';
import createLucideIcon from '../createLucideIcon';

const FileBadge = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-badge';
