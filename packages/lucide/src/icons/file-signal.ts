...
import iconData from '@lucide/icons/icons/file-signal';
import createLucideIcon from '../createLucideIcon';

const FileSignal = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-signal';
