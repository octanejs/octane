...
import iconData from '@lucide/icons/icons/file-diff';
import createLucideIcon from '../createLucideIcon';

const FileDiff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-diff';
