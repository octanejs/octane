...
import iconData from '@lucide/icons/icons/image-minus';
import createLucideIcon from '../createLucideIcon';

const ImageMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/image-minus';
