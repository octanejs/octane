...
import iconData from '@lucide/icons/icons/circle-pile';
import createLucideIcon from '../createLucideIcon';

const CirclePile = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-pile';
