...
import iconData from '@lucide/icons/icons/mouse-pointer-2-off';
import createLucideIcon from '../createLucideIcon';

const MousePointer2Off = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/mouse-pointer-2-off';
