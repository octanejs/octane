...
import iconData from '@lucide/icons/icons/mirror-round';
import createLucideIcon from '../createLucideIcon';

const MirrorRound = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/mirror-round';
