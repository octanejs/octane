...
import iconData from '@lucide/icons/icons/headphones';
import createLucideIcon from '../createLucideIcon';

const Headphones = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/headphones';
