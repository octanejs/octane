...
import iconData from '@lucide/icons/icons/columns-3';
import createLucideIcon from '../createLucideIcon';

const Columns3 = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/columns-3';
