...
import iconData from '@lucide/icons/icons/footprints';
import createLucideIcon from '../createLucideIcon';

const Footprints = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/footprints';
