...
import iconData from '@lucide/icons/icons/waves-horizontal';
import createLucideIcon from '../createLucideIcon';

const WavesHorizontal = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/waves-horizontal';
