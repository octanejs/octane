...
import iconData from '@lucide/icons/icons/receipt-cent';
import createLucideIcon from '../createLucideIcon';

const ReceiptCent = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/receipt-cent';
