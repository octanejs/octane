...
import iconData from '@lucide/icons/icons/component';
import createLucideIcon from '../createLucideIcon';

const Component = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/component';
