...
import iconData from '@lucide/icons/icons/building-complex-plus';
import createLucideIcon from '../createLucideIcon';

const BuildingComplexPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/building-complex-plus';
