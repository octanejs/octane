...
import iconData from '@lucide/icons/icons/message-square-dot';
import createLucideIcon from '../createLucideIcon';

const MessageSquareDot = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-square-dot';
