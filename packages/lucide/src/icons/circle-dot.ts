...
import iconData from '@lucide/icons/icons/circle-dot';
import createLucideIcon from '../createLucideIcon';

const CircleDot = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-dot';
