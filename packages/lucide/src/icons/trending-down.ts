...
import iconData from '@lucide/icons/icons/trending-down';
import createLucideIcon from '../createLucideIcon';

const TrendingDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/trending-down';
