...
import iconData from '@lucide/icons/icons/biohazard';
import createLucideIcon from '../createLucideIcon';

const Biohazard = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/biohazard';
