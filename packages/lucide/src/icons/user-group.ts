...
import iconData from '@lucide/icons/icons/user-group';
import createLucideIcon from '../createLucideIcon';

const UserGroup = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/user-group';
