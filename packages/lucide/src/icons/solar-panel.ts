...
import iconData from '@lucide/icons/icons/solar-panel';
import createLucideIcon from '../createLucideIcon';

const SolarPanel = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/solar-panel';
