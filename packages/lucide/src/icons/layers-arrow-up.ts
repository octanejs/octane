...
import iconData from '@lucide/icons/icons/layers-arrow-up';
import createLucideIcon from '../createLucideIcon';

const LayersArrowUp = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/layers-arrow-up';
