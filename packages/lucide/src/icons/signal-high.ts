...
import iconData from '@lucide/icons/icons/signal-high';
import createLucideIcon from '../createLucideIcon';

const SignalHigh = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/signal-high';
