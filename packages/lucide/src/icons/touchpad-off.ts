...
import iconData from '@lucide/icons/icons/touchpad-off';
import createLucideIcon from '../createLucideIcon';

const TouchpadOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/touchpad-off';
