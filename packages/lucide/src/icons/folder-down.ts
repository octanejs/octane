...
import iconData from '@lucide/icons/icons/folder-down';
import createLucideIcon from '../createLucideIcon';

const FolderDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-down';
