...
import iconData from '@lucide/icons/icons/arrow-big-right-dash';
import createLucideIcon from '../createLucideIcon';

const ArrowBigRightDash = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-big-right-dash';
