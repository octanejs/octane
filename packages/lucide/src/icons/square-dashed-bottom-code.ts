...
import iconData from '@lucide/icons/icons/square-dashed-bottom-code';
import createLucideIcon from '../createLucideIcon';

const SquareDashedBottomCode = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-dashed-bottom-code';
