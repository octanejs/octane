...
import iconData from '@lucide/icons/icons/thumbs-up';
import createLucideIcon from '../createLucideIcon';

const ThumbsUp = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/thumbs-up';
