...
import iconData from '@lucide/icons/icons/flag-triangle-left';
import createLucideIcon from '../createLucideIcon';

const FlagTriangleLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/flag-triangle-left';
