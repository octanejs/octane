...
import iconData from '@lucide/icons/icons/candy-cane';
import createLucideIcon from '../createLucideIcon';

const CandyCane = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/candy-cane';
