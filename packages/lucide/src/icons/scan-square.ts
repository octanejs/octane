...
import iconData from '@lucide/icons/icons/scan-square';
import createLucideIcon from '../createLucideIcon';

const ScanSquare = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/scan-square';
