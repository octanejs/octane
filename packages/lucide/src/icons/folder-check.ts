...
import iconData from '@lucide/icons/icons/folder-check';
import createLucideIcon from '../createLucideIcon';

const FolderCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-check';
