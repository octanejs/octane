...
import iconData from '@lucide/icons/icons/usb-c-port';
import createLucideIcon from '../createLucideIcon';

const UsbCPort = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/usb-c-port';
