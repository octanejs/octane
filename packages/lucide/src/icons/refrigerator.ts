...
import iconData from '@lucide/icons/icons/refrigerator';
import createLucideIcon from '../createLucideIcon';

const Refrigerator = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/refrigerator';
