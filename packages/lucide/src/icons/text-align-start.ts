...
import iconData from '@lucide/icons/icons/text-align-start';
import createLucideIcon from '../createLucideIcon';

const TextAlignStart = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/text-align-start';
