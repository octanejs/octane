...
import iconData from '@lucide/icons/icons/image-upscale';
import createLucideIcon from '../createLucideIcon';

const ImageUpscale = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/image-upscale';
