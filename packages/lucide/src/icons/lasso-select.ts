...
import iconData from '@lucide/icons/icons/lasso-select';
import createLucideIcon from '../createLucideIcon';

const LassoSelect = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/lasso-select';
