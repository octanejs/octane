...
import iconData from '@lucide/icons/icons/file-chart-pie';
import createLucideIcon from '../createLucideIcon';

const FileChartPie = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-chart-pie';
