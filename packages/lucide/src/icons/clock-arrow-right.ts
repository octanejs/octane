...
import iconData from '@lucide/icons/icons/clock-arrow-right';
import createLucideIcon from '../createLucideIcon';

const ClockArrowRight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/clock-arrow-right';
