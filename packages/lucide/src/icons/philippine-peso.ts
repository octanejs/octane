...
import iconData from '@lucide/icons/icons/philippine-peso';
import createLucideIcon from '../createLucideIcon';

const PhilippinePeso = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/philippine-peso';
