...
import iconData from '@lucide/icons/icons/vibrate-off';
import createLucideIcon from '../createLucideIcon';

const VibrateOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/vibrate-off';
