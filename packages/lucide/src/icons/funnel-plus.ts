...
import iconData from '@lucide/icons/icons/funnel-plus';
import createLucideIcon from '../createLucideIcon';

const FunnelPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/funnel-plus';
