...
import iconData from '@lucide/icons/icons/calendar-x-2';
import createLucideIcon from '../createLucideIcon';

const CalendarX2 = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/calendar-x-2';
