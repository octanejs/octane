...
import iconData from '@lucide/icons/icons/toothbrush-sparkles';
import createLucideIcon from '../createLucideIcon';

const ToothbrushSparkles = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/toothbrush-sparkles';
