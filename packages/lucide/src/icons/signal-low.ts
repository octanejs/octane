...
import iconData from '@lucide/icons/icons/signal-low';
import createLucideIcon from '../createLucideIcon';

const SignalLow = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/signal-low';
