...
import iconData from '@lucide/icons/icons/mail-plus';
import createLucideIcon from '../createLucideIcon';

const MailPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/mail-plus';
