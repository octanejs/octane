...
import iconData from '@lucide/icons/icons/clock-alert';
import createLucideIcon from '../createLucideIcon';

const ClockAlert = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/clock-alert';
