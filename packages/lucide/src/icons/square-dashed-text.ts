...
import iconData from '@lucide/icons/icons/square-dashed-text';
import createLucideIcon from '../createLucideIcon';

const SquareDashedText = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-dashed-text';
