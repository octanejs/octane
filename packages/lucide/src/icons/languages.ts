...
import iconData from '@lucide/icons/icons/languages';
import createLucideIcon from '../createLucideIcon';

const Languages = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/languages';
