...
import iconData from '@lucide/icons/icons/book-text';
import createLucideIcon from '../createLucideIcon';

const BookText = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/book-text';
