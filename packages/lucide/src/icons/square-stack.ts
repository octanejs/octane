...
import iconData from '@lucide/icons/icons/square-stack';
import createLucideIcon from '../createLucideIcon';

const SquareStack = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-stack';
