...
import iconData from '@lucide/icons/icons/spline-pointer';
import createLucideIcon from '../createLucideIcon';

const SplinePointer = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/spline-pointer';
