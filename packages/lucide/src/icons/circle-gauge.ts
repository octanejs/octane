...
import iconData from '@lucide/icons/icons/circle-gauge';
import createLucideIcon from '../createLucideIcon';

const CircleGauge = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-gauge';
