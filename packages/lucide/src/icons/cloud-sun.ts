...
import iconData from '@lucide/icons/icons/cloud-sun';
import createLucideIcon from '../createLucideIcon';

const CloudSun = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cloud-sun';
