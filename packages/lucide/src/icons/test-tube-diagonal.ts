...
import iconData from '@lucide/icons/icons/test-tube-diagonal';
import createLucideIcon from '../createLucideIcon';

const TestTubeDiagonal = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/test-tube-diagonal';
