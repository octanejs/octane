...
import iconData from '@lucide/icons/icons/package-search';
import createLucideIcon from '../createLucideIcon';

const PackageSearch = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/package-search';
