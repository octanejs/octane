...
import iconData from '@lucide/icons/icons/volleyball';
import createLucideIcon from '../createLucideIcon';

const Volleyball = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/volleyball';
