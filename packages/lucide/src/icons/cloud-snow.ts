...
import iconData from '@lucide/icons/icons/cloud-snow';
import createLucideIcon from '../createLucideIcon';

const CloudSnow = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cloud-snow';
