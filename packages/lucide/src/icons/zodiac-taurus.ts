...
import iconData from '@lucide/icons/icons/zodiac-taurus';
import createLucideIcon from '../createLucideIcon';

const ZodiacTaurus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/zodiac-taurus';
