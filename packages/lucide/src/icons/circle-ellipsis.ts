...
import iconData from '@lucide/icons/icons/circle-ellipsis';
import createLucideIcon from '../createLucideIcon';

const CircleEllipsis = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-ellipsis';
