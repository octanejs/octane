...
import iconData from '@lucide/icons/icons/move-diagonal';
import createLucideIcon from '../createLucideIcon';

const MoveDiagonal = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/move-diagonal';
