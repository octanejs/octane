...
import iconData from '@lucide/icons/icons/wrench-off';
import createLucideIcon from '../createLucideIcon';

const WrenchOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/wrench-off';
