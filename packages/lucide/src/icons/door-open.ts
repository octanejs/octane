...
import iconData from '@lucide/icons/icons/door-open';
import createLucideIcon from '../createLucideIcon';

const DoorOpen = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/door-open';
