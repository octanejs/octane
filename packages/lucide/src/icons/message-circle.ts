...
import iconData from '@lucide/icons/icons/message-circle';
import createLucideIcon from '../createLucideIcon';

const MessageCircle = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-circle';
