...
import iconData from '@lucide/icons/icons/power-off';
import createLucideIcon from '../createLucideIcon';

const PowerOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/power-off';
