...
import iconData from '@lucide/icons/icons/message-circle-reply';
import createLucideIcon from '../createLucideIcon';

const MessageCircleReply = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-circle-reply';
