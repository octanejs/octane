...
import iconData from '@lucide/icons/icons/file-volume';
import createLucideIcon from '../createLucideIcon';

const FileVolume = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-volume';
