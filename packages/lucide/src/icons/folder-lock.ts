...
import iconData from '@lucide/icons/icons/folder-lock';
import createLucideIcon from '../createLucideIcon';

const FolderLock = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-lock';
