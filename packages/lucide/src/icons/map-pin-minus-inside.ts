...
import iconData from '@lucide/icons/icons/map-pin-minus-inside';
import createLucideIcon from '../createLucideIcon';

const MapPinMinusInside = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/map-pin-minus-inside';
