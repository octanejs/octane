...
import iconData from '@lucide/icons/icons/calendar-minus-2';
import createLucideIcon from '../createLucideIcon';

const CalendarMinus2 = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/calendar-minus-2';
