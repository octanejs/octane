...
import iconData from '@lucide/icons/icons/zodiac-virgo';
import createLucideIcon from '../createLucideIcon';

const ZodiacVirgo = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/zodiac-virgo';
