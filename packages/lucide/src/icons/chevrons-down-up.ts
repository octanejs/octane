...
import iconData from '@lucide/icons/icons/chevrons-down-up';
import createLucideIcon from '../createLucideIcon';

const ChevronsDownUp = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chevrons-down-up';
