...
import iconData from '@lucide/icons/icons/utility-pole';
import createLucideIcon from '../createLucideIcon';

const UtilityPole = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/utility-pole';
