...
import iconData from '@lucide/icons/icons/arrow-up-left';
import createLucideIcon from '../createLucideIcon';

const ArrowUpLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-up-left';
