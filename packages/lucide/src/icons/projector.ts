...
import iconData from '@lucide/icons/icons/projector';
import createLucideIcon from '../createLucideIcon';

const Projector = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/projector';
