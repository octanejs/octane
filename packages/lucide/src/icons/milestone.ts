...
import iconData from '@lucide/icons/icons/milestone';
import createLucideIcon from '../createLucideIcon';

const Milestone = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/milestone';
