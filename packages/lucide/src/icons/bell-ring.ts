...
import iconData from '@lucide/icons/icons/bell-ring';
import createLucideIcon from '../createLucideIcon';

const BellRing = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/bell-ring';
