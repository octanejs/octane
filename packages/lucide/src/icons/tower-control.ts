...
import iconData from '@lucide/icons/icons/tower-control';
import createLucideIcon from '../createLucideIcon';

const TowerControl = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/tower-control';
