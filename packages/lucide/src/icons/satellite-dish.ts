...
import iconData from '@lucide/icons/icons/satellite-dish';
import createLucideIcon from '../createLucideIcon';

const SatelliteDish = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/satellite-dish';
