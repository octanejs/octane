...
import iconData from '@lucide/icons/icons/spell-check-2';
import createLucideIcon from '../createLucideIcon';

const SpellCheck2 = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/spell-check-2';
