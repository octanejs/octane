...
import iconData from '@lucide/icons/icons/align-vertical-justify-end';
import createLucideIcon from '../createLucideIcon';

const AlignVerticalJustifyEnd = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/align-vertical-justify-end';
