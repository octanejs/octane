...
import iconData from '@lucide/icons/icons/circle-off';
import createLucideIcon from '../createLucideIcon';

const CircleOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-off';
