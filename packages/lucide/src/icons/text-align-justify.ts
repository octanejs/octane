...
import iconData from '@lucide/icons/icons/text-align-justify';
import createLucideIcon from '../createLucideIcon';

const TextAlignJustify = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/text-align-justify';
