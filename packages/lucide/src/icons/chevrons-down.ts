...
import iconData from '@lucide/icons/icons/chevrons-down';
import createLucideIcon from '../createLucideIcon';

const ChevronsDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chevrons-down';
