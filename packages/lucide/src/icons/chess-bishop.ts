...
import iconData from '@lucide/icons/icons/chess-bishop';
import createLucideIcon from '../createLucideIcon';

const ChessBishop = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chess-bishop';
