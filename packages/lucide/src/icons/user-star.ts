...
import iconData from '@lucide/icons/icons/user-star';
import createLucideIcon from '../createLucideIcon';

const UserStar = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/user-star';
