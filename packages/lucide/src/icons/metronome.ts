...
import iconData from '@lucide/icons/icons/metronome';
import createLucideIcon from '../createLucideIcon';

const Metronome = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/metronome';
