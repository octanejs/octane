...
import iconData from '@lucide/icons/icons/credit-card-x';
import createLucideIcon from '../createLucideIcon';

const CreditCardX = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/credit-card-x';
