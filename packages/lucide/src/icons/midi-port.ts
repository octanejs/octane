...
import iconData from '@lucide/icons/icons/midi-port';
import createLucideIcon from '../createLucideIcon';

const MidiPort = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/midi-port';
