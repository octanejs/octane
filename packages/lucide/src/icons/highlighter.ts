...
import iconData from '@lucide/icons/icons/highlighter';
import createLucideIcon from '../createLucideIcon';

const Highlighter = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/highlighter';
