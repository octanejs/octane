...
import iconData from '@lucide/icons/icons/monitor-dot';
import createLucideIcon from '../createLucideIcon';

const MonitorDot = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/monitor-dot';
