...
import iconData from '@lucide/icons/icons/cannabis-off';
import createLucideIcon from '../createLucideIcon';

const CannabisOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cannabis-off';
