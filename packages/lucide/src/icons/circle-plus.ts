...
import iconData from '@lucide/icons/icons/circle-plus';
import createLucideIcon from '../createLucideIcon';

const CirclePlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-plus';
