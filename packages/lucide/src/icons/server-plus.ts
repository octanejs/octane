...
import iconData from '@lucide/icons/icons/server-plus';
import createLucideIcon from '../createLucideIcon';

const ServerPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/server-plus';
