...
import iconData from '@lucide/icons/icons/map-pin-house';
import createLucideIcon from '../createLucideIcon';

const MapPinHouse = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/map-pin-house';
