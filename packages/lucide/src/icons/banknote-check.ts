...
import iconData from '@lucide/icons/icons/banknote-check';
import createLucideIcon from '../createLucideIcon';

const BanknoteCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/banknote-check';
