...
import iconData from '@lucide/icons/icons/square-power';
import createLucideIcon from '../createLucideIcon';

const SquarePower = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-power';
