...
import iconData from '@lucide/icons/icons/square-plus';
import createLucideIcon from '../createLucideIcon';

const SquarePlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-plus';
