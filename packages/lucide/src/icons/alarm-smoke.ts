...
import iconData from '@lucide/icons/icons/alarm-smoke';
import createLucideIcon from '../createLucideIcon';

const AlarmSmoke = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/alarm-smoke';
