...
import iconData from '@lucide/icons/icons/chart-bar-increasing';
import createLucideIcon from '../createLucideIcon';

const ChartBarIncreasing = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chart-bar-increasing';
