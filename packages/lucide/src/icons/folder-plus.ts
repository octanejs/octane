...
import iconData from '@lucide/icons/icons/folder-plus';
import createLucideIcon from '../createLucideIcon';

const FolderPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-plus';
