...
import iconData from '@lucide/icons/icons/briefcase-medical';
import createLucideIcon from '../createLucideIcon';

const BriefcaseMedical = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/briefcase-medical';
