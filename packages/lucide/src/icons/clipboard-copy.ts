...
import iconData from '@lucide/icons/icons/clipboard-copy';
import createLucideIcon from '../createLucideIcon';

const ClipboardCopy = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/clipboard-copy';
