...
import iconData from '@lucide/icons/icons/mouse-pointer';
import createLucideIcon from '../createLucideIcon';

const MousePointer = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/mouse-pointer';
