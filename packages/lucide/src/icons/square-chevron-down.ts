...
import iconData from '@lucide/icons/icons/square-chevron-down';
import createLucideIcon from '../createLucideIcon';

const SquareChevronDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-chevron-down';
