...
import iconData from '@lucide/icons/icons/shield-ban';
import createLucideIcon from '../createLucideIcon';

const ShieldBan = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/shield-ban';
