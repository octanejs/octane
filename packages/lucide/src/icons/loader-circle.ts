...
import iconData from '@lucide/icons/icons/loader-circle';
import createLucideIcon from '../createLucideIcon';

const LoaderCircle = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/loader-circle';
