...
import iconData from '@lucide/icons/icons/sticky-note-minus';
import createLucideIcon from '../createLucideIcon';

const StickyNoteMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/sticky-note-minus';
