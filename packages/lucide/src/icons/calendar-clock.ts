...
import iconData from '@lucide/icons/icons/calendar-clock';
import createLucideIcon from '../createLucideIcon';

const CalendarClock = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/calendar-clock';
