...
import iconData from '@lucide/icons/icons/square-play';
import createLucideIcon from '../createLucideIcon';

const SquarePlay = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-play';
