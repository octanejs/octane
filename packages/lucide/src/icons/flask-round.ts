...
import iconData from '@lucide/icons/icons/flask-round';
import createLucideIcon from '../createLucideIcon';

const FlaskRound = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/flask-round';
