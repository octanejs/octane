...
import iconData from '@lucide/icons/icons/folder-open-dot';
import createLucideIcon from '../createLucideIcon';

const FolderOpenDot = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-open-dot';
