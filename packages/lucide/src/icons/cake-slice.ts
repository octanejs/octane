...
import iconData from '@lucide/icons/icons/cake-slice';
import createLucideIcon from '../createLucideIcon';

const CakeSlice = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cake-slice';
