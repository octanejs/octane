...
import iconData from '@lucide/icons/icons/phone-missed';
import createLucideIcon from '../createLucideIcon';

const PhoneMissed = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/phone-missed';
