...
import iconData from '@lucide/icons/icons/circle-star';
import createLucideIcon from '../createLucideIcon';

const CircleStar = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-star';
