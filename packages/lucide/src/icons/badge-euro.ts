...
import iconData from '@lucide/icons/icons/badge-euro';
import createLucideIcon from '../createLucideIcon';

const BadgeEuro = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/badge-euro';
