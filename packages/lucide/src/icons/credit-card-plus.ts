...
import iconData from '@lucide/icons/icons/credit-card-plus';
import createLucideIcon from '../createLucideIcon';

const CreditCardPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/credit-card-plus';
