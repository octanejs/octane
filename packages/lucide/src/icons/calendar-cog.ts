...
import iconData from '@lucide/icons/icons/calendar-cog';
import createLucideIcon from '../createLucideIcon';

const CalendarCog = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/calendar-cog';
