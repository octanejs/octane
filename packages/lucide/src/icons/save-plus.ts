...
import iconData from '@lucide/icons/icons/save-plus';
import createLucideIcon from '../createLucideIcon';

const SavePlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/save-plus';
