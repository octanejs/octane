...
import iconData from '@lucide/icons/icons/robot-vacuum';
import createLucideIcon from '../createLucideIcon';

const RobotVacuum = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/robot-vacuum';
