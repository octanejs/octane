...
import iconData from '@lucide/icons/icons/clock-check';
import createLucideIcon from '../createLucideIcon';

const ClockCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/clock-check';
