...
import iconData from '@lucide/icons/icons/arrow-left';
import createLucideIcon from '../createLucideIcon';

const ArrowLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-left';
