...
import iconData from '@lucide/icons/icons/paint-roller';
import createLucideIcon from '../createLucideIcon';

const PaintRoller = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/paint-roller';
