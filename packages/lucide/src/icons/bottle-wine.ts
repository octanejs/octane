...
import iconData from '@lucide/icons/icons/bottle-wine';
import createLucideIcon from '../createLucideIcon';

const BottleWine = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/bottle-wine';
