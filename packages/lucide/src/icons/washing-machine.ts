...
import iconData from '@lucide/icons/icons/washing-machine';
import createLucideIcon from '../createLucideIcon';

const WashingMachine = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/washing-machine';
