...
import iconData from '@lucide/icons/icons/cloud-sync';
import createLucideIcon from '../createLucideIcon';

const CloudSync = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cloud-sync';
