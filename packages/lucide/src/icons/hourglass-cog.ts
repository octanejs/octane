...
import iconData from '@lucide/icons/icons/hourglass-cog';
import createLucideIcon from '../createLucideIcon';

const HourglassCog = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/hourglass-cog';
