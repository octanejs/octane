...
import iconData from '@lucide/icons/icons/link-2-off';
import createLucideIcon from '../createLucideIcon';

const Link2Off = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/link-2-off';
