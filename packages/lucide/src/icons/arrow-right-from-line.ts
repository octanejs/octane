...
import iconData from '@lucide/icons/icons/arrow-right-from-line';
import createLucideIcon from '../createLucideIcon';

const ArrowRightFromLine = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-right-from-line';
