...
import iconData from '@lucide/icons/icons/house-wifi';
import createLucideIcon from '../createLucideIcon';

const HouseWifi = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/house-wifi';
