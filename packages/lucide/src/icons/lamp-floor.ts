...
import iconData from '@lucide/icons/icons/lamp-floor';
import createLucideIcon from '../createLucideIcon';

const LampFloor = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/lamp-floor';
