...
import iconData from '@lucide/icons/icons/diamond-minus';
import createLucideIcon from '../createLucideIcon';

const DiamondMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/diamond-minus';
