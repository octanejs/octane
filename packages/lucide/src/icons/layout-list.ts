...
import iconData from '@lucide/icons/icons/layout-list';
import createLucideIcon from '../createLucideIcon';

const LayoutList = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/layout-list';
