...
import iconData from '@lucide/icons/icons/list-todo';
import createLucideIcon from '../createLucideIcon';

const ListTodo = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/list-todo';
