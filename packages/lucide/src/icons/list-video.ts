...
import iconData from '@lucide/icons/icons/list-video';
import createLucideIcon from '../createLucideIcon';

const ListVideo = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/list-video';
