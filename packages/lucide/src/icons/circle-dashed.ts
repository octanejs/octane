...
import iconData from '@lucide/icons/icons/circle-dashed';
import createLucideIcon from '../createLucideIcon';

const CircleDashed = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-dashed';
