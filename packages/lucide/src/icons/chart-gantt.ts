...
import iconData from '@lucide/icons/icons/chart-gantt';
import createLucideIcon from '../createLucideIcon';

const ChartGantt = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chart-gantt';
