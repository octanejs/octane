...
import iconData from '@lucide/icons/icons/arrow-down';
import createLucideIcon from '../createLucideIcon';

const ArrowDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-down';
