...
import iconData from '@lucide/icons/icons/square-arrow-down-left';
import createLucideIcon from '../createLucideIcon';

const SquareArrowDownLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-arrow-down-left';
