...
import iconData from '@lucide/icons/icons/toy-brick';
import createLucideIcon from '../createLucideIcon';

const ToyBrick = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/toy-brick';
