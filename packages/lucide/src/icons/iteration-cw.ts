...
import iconData from '@lucide/icons/icons/iteration-cw';
import createLucideIcon from '../createLucideIcon';

const IterationCw = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/iteration-cw';
