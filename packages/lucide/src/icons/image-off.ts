...
import iconData from '@lucide/icons/icons/image-off';
import createLucideIcon from '../createLucideIcon';

const ImageOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/image-off';
