...
import iconData from '@lucide/icons/icons/candy-off';
import createLucideIcon from '../createLucideIcon';

const CandyOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/candy-off';
