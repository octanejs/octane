...
import iconData from '@lucide/icons/icons/equal-approximately';
import createLucideIcon from '../createLucideIcon';

const EqualApproximately = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/equal-approximately';
