...
import iconData from '@lucide/icons/icons/audio-lines-x';
import createLucideIcon from '../createLucideIcon';

const AudioLinesX = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/audio-lines-x';
