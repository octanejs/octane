...
import iconData from '@lucide/icons/icons/case-upper';
import createLucideIcon from '../createLucideIcon';

const CaseUpper = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/case-upper';
