...
import iconData from '@lucide/icons/icons/lock-keyhole';
import createLucideIcon from '../createLucideIcon';

const LockKeyhole = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/lock-keyhole';
