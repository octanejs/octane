...
import iconData from '@lucide/icons/icons/message-square-code';
import createLucideIcon from '../createLucideIcon';

const MessageSquareCode = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-square-code';
