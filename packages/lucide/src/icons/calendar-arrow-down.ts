...
import iconData from '@lucide/icons/icons/calendar-arrow-down';
import createLucideIcon from '../createLucideIcon';

const CalendarArrowDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/calendar-arrow-down';
