...
import iconData from '@lucide/icons/icons/list-restart';
import createLucideIcon from '../createLucideIcon';

const ListRestart = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/list-restart';
