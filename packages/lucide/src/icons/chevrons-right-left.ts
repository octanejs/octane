...
import iconData from '@lucide/icons/icons/chevrons-right-left';
import createLucideIcon from '../createLucideIcon';

const ChevronsRightLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chevrons-right-left';
