...
import iconData from '@lucide/icons/icons/square-arrow-out-up-right';
import createLucideIcon from '../createLucideIcon';

const SquareArrowOutUpRight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-arrow-out-up-right';
