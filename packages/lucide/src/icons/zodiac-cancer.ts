...
import iconData from '@lucide/icons/icons/zodiac-cancer';
import createLucideIcon from '../createLucideIcon';

const ZodiacCancer = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/zodiac-cancer';
