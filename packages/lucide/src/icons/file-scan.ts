...
import iconData from '@lucide/icons/icons/file-scan';
import createLucideIcon from '../createLucideIcon';

const FileScan = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-scan';
