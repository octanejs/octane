...
import iconData from '@lucide/icons/icons/train-front';
import createLucideIcon from '../createLucideIcon';

const TrainFront = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/train-front';
