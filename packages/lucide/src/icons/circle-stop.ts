...
import iconData from '@lucide/icons/icons/circle-stop';
import createLucideIcon from '../createLucideIcon';

const CircleStop = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-stop';
