...
import iconData from '@lucide/icons/icons/zodiac-leo';
import createLucideIcon from '../createLucideIcon';

const ZodiacLeo = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/zodiac-leo';
