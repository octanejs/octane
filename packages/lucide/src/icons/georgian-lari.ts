...
import iconData from '@lucide/icons/icons/georgian-lari';
import createLucideIcon from '../createLucideIcon';

const GeorgianLari = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/georgian-lari';
