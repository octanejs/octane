...
import iconData from '@lucide/icons/icons/badge-plus';
import createLucideIcon from '../createLucideIcon';

const BadgePlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/badge-plus';
