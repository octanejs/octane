...
import iconData from '@lucide/icons/icons/panel-top';
import createLucideIcon from '../createLucideIcon';

const PanelTop = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/panel-top';
