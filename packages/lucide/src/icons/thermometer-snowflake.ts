...
import iconData from '@lucide/icons/icons/thermometer-snowflake';
import createLucideIcon from '../createLucideIcon';

const ThermometerSnowflake = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/thermometer-snowflake';
