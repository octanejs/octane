...
import iconData from '@lucide/icons/icons/book-down';
import createLucideIcon from '../createLucideIcon';

const BookDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/book-down';
