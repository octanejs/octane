...
import iconData from '@lucide/icons/icons/test-tubes';
import createLucideIcon from '../createLucideIcon';

const TestTubes = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/test-tubes';
