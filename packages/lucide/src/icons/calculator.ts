...
import iconData from '@lucide/icons/icons/calculator';
import createLucideIcon from '../createLucideIcon';

const Calculator = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/calculator';
