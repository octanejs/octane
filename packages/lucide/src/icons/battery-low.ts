...
import iconData from '@lucide/icons/icons/battery-low';
import createLucideIcon from '../createLucideIcon';

const BatteryLow = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/battery-low';
