...
import iconData from '@lucide/icons/icons/snowflake';
import createLucideIcon from '../createLucideIcon';

const Snowflake = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/snowflake';
