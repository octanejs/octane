...
import iconData from '@lucide/icons/icons/file-code';
import createLucideIcon from '../createLucideIcon';

const FileCode = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-code';
