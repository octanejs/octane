...
import iconData from '@lucide/icons/icons/rotate-ccw-clock';
import createLucideIcon from '../createLucideIcon';

const RotateCcwClock = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/rotate-ccw-clock';
