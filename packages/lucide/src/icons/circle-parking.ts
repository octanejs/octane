...
import iconData from '@lucide/icons/icons/circle-parking';
import createLucideIcon from '../createLucideIcon';

const CircleParking = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-parking';
