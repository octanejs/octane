...
import iconData from '@lucide/icons/icons/receipt-text';
import createLucideIcon from '../createLucideIcon';

const ReceiptText = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/receipt-text';
