...
import iconData from '@lucide/icons/icons/file-symlink';
import createLucideIcon from '../createLucideIcon';

const FileSymlink = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-symlink';
