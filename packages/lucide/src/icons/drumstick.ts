...
import iconData from '@lucide/icons/icons/drumstick';
import createLucideIcon from '../createLucideIcon';

const Drumstick = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/drumstick';
