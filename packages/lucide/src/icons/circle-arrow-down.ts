...
import iconData from '@lucide/icons/icons/circle-arrow-down';
import createLucideIcon from '../createLucideIcon';

const CircleArrowDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-arrow-down';
