...
import iconData from '@lucide/icons/icons/sun-medium';
import createLucideIcon from '../createLucideIcon';

const SunMedium = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/sun-medium';
