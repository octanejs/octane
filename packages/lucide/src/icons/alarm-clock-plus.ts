...
import iconData from '@lucide/icons/icons/alarm-clock-plus';
import createLucideIcon from '../createLucideIcon';

const AlarmClockPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/alarm-clock-plus';
