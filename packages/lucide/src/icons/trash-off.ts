...
import iconData from '@lucide/icons/icons/trash-off';
import createLucideIcon from '../createLucideIcon';

const TrashOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/trash-off';
