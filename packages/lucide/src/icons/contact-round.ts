...
import iconData from '@lucide/icons/icons/contact-round';
import createLucideIcon from '../createLucideIcon';

const ContactRound = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/contact-round';
