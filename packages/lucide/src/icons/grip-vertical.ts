...
import iconData from '@lucide/icons/icons/grip-vertical';
import createLucideIcon from '../createLucideIcon';

const GripVertical = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/grip-vertical';
