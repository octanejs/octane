...
import iconData from '@lucide/icons/icons/egg-fried';
import createLucideIcon from '../createLucideIcon';

const EggFried = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/egg-fried';
