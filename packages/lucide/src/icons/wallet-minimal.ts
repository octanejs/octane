...
import iconData from '@lucide/icons/icons/wallet-minimal';
import createLucideIcon from '../createLucideIcon';

const WalletMinimal = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/wallet-minimal';
