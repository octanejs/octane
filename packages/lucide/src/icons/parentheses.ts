...
import iconData from '@lucide/icons/icons/parentheses';
import createLucideIcon from '../createLucideIcon';

const Parentheses = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/parentheses';
