...
import iconData from '@lucide/icons/icons/presentation';
import createLucideIcon from '../createLucideIcon';

const Presentation = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/presentation';
