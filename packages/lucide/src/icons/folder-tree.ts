...
import iconData from '@lucide/icons/icons/folder-tree';
import createLucideIcon from '../createLucideIcon';

const FolderTree = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-tree';
