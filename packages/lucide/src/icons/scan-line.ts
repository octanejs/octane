...
import iconData from '@lucide/icons/icons/scan-line';
import createLucideIcon from '../createLucideIcon';

const ScanLine = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/scan-line';
