...
import iconData from '@lucide/icons/icons/arrow-up-from-dot';
import createLucideIcon from '../createLucideIcon';

const ArrowUpFromDot = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-up-from-dot';
