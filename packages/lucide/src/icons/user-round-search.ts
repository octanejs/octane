...
import iconData from '@lucide/icons/icons/user-round-search';
import createLucideIcon from '../createLucideIcon';

const UserRoundSearch = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/user-round-search';
