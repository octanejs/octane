...
import iconData from '@lucide/icons/icons/save-check';
import createLucideIcon from '../createLucideIcon';

const SaveCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/save-check';
