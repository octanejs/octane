...
import iconData from '@lucide/icons/icons/star-minus';
import createLucideIcon from '../createLucideIcon';

const StarMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/star-minus';
