...
import iconData from '@lucide/icons/icons/university';
import createLucideIcon from '../createLucideIcon';

const University = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/university';
