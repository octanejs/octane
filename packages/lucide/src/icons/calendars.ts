...
import iconData from '@lucide/icons/icons/calendars';
import createLucideIcon from '../createLucideIcon';

const Calendars = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/calendars';
