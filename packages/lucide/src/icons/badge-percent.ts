...
import iconData from '@lucide/icons/icons/badge-percent';
import createLucideIcon from '../createLucideIcon';

const BadgePercent = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/badge-percent';
