...
import iconData from '@lucide/icons/icons/brain-cog';
import createLucideIcon from '../createLucideIcon';

const BrainCog = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/brain-cog';
