...
import iconData from '@lucide/icons/icons/brick-wall-fire';
import createLucideIcon from '../createLucideIcon';

const BrickWallFire = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/brick-wall-fire';
