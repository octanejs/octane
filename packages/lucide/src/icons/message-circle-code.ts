...
import iconData from '@lucide/icons/icons/message-circle-code';
import createLucideIcon from '../createLucideIcon';

const MessageCircleCode = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-circle-code';
