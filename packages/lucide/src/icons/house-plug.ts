...
import iconData from '@lucide/icons/icons/house-plug';
import createLucideIcon from '../createLucideIcon';

const HousePlug = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/house-plug';
