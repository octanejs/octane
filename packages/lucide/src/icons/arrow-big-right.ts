...
import iconData from '@lucide/icons/icons/arrow-big-right';
import createLucideIcon from '../createLucideIcon';

const ArrowBigRight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-big-right';
