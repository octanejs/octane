...
import iconData from '@lucide/icons/icons/equal-not';
import createLucideIcon from '../createLucideIcon';

const EqualNot = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/equal-not';
