...
import iconData from '@lucide/icons/icons/square-minus';
import createLucideIcon from '../createLucideIcon';

const SquareMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-minus';
