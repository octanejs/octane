...
import iconData from '@lucide/icons/icons/keyboard-music';
import createLucideIcon from '../createLucideIcon';

const KeyboardMusic = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/keyboard-music';
