...
import iconData from '@lucide/icons/icons/pocket-knife';
import createLucideIcon from '../createLucideIcon';

const PocketKnife = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/pocket-knife';
