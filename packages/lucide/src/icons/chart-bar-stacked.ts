...
import iconData from '@lucide/icons/icons/chart-bar-stacked';
import createLucideIcon from '../createLucideIcon';

const ChartBarStacked = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chart-bar-stacked';
