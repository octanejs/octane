...
import iconData from '@lucide/icons/icons/helicopter';
import createLucideIcon from '../createLucideIcon';

const Helicopter = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/helicopter';
