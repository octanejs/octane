...
import iconData from '@lucide/icons/icons/scan-qr-code';
import createLucideIcon from '../createLucideIcon';

const ScanQrCode = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/scan-qr-code';
