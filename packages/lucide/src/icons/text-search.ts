...
import iconData from '@lucide/icons/icons/text-search';
import createLucideIcon from '../createLucideIcon';

const TextSearch = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/text-search';
