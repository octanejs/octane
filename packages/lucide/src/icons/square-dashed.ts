...
import iconData from '@lucide/icons/icons/square-dashed';
import createLucideIcon from '../createLucideIcon';

const SquareDashed = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-dashed';
