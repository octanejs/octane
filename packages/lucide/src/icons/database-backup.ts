...
import iconData from '@lucide/icons/icons/database-backup';
import createLucideIcon from '../createLucideIcon';

const DatabaseBackup = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/database-backup';
