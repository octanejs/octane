...
import iconData from '@lucide/icons/icons/panel-right-close';
import createLucideIcon from '../createLucideIcon';

const PanelRightClose = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/panel-right-close';
