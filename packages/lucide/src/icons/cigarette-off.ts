...
import iconData from '@lucide/icons/icons/cigarette-off';
import createLucideIcon from '../createLucideIcon';

const CigaretteOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cigarette-off';
