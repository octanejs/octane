...
import iconData from '@lucide/icons/icons/chess-pawn';
import createLucideIcon from '../createLucideIcon';

const ChessPawn = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chess-pawn';
