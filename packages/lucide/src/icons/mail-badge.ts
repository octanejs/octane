...
import iconData from '@lucide/icons/icons/mail-badge';
import createLucideIcon from '../createLucideIcon';

const MailBadge = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/mail-badge';
