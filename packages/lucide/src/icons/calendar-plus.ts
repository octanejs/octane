...
import iconData from '@lucide/icons/icons/calendar-plus';
import createLucideIcon from '../createLucideIcon';

const CalendarPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/calendar-plus';
