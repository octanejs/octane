...
import iconData from '@lucide/icons/icons/laptop-minimal-check';
import createLucideIcon from '../createLucideIcon';

const LaptopMinimalCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/laptop-minimal-check';
