...
import iconData from '@lucide/icons/icons/rotate-ccw';
import createLucideIcon from '../createLucideIcon';

const RotateCcw = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/rotate-ccw';
