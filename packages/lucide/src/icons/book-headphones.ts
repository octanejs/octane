...
import iconData from '@lucide/icons/icons/book-headphones';
import createLucideIcon from '../createLucideIcon';

const BookHeadphones = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/book-headphones';
