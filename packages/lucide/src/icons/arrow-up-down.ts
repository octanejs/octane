...
import iconData from '@lucide/icons/icons/arrow-up-down';
import createLucideIcon from '../createLucideIcon';

const ArrowUpDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-up-down';
