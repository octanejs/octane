...
import iconData from '@lucide/icons/icons/train-track';
import createLucideIcon from '../createLucideIcon';

const TrainTrack = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/train-track';
