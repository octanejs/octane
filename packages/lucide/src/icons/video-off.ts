...
import iconData from '@lucide/icons/icons/video-off';
import createLucideIcon from '../createLucideIcon';

const VideoOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/video-off';
