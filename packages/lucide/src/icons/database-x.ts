...
import iconData from '@lucide/icons/icons/database-x';
import createLucideIcon from '../createLucideIcon';

const DatabaseX = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/database-x';
