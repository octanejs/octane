...
import iconData from '@lucide/icons/icons/file-minus';
import createLucideIcon from '../createLucideIcon';

const FileMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-minus';
