...
import iconData from '@lucide/icons/icons/hand-fist';
import createLucideIcon from '../createLucideIcon';

const HandFist = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/hand-fist';
