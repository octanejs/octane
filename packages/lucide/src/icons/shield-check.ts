...
import iconData from '@lucide/icons/icons/shield-check';
import createLucideIcon from '../createLucideIcon';

const ShieldCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/shield-check';
