...
import iconData from '@lucide/icons/icons/scan-text';
import createLucideIcon from '../createLucideIcon';

const ScanText = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/scan-text';
