...
import iconData from '@lucide/icons/icons/arrow-down-to-dot';
import createLucideIcon from '../createLucideIcon';

const ArrowDownToDot = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-down-to-dot';
