...
import iconData from '@lucide/icons/icons/folder-heart';
import createLucideIcon from '../createLucideIcon';

const FolderHeart = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-heart';
