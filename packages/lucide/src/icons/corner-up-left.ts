...
import iconData from '@lucide/icons/icons/corner-up-left';
import createLucideIcon from '../createLucideIcon';

const CornerUpLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/corner-up-left';
