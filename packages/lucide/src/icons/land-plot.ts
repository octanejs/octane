...
import iconData from '@lucide/icons/icons/land-plot';
import createLucideIcon from '../createLucideIcon';

const LandPlot = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/land-plot';
