...
import iconData from '@lucide/icons/icons/container';
import createLucideIcon from '../createLucideIcon';

const Container = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/container';
