...
import iconData from '@lucide/icons/icons/rotate-ccw-key';
import createLucideIcon from '../createLucideIcon';

const RotateCcwKey = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/rotate-ccw-key';
