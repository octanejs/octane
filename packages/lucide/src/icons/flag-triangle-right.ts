...
import iconData from '@lucide/icons/icons/flag-triangle-right';
import createLucideIcon from '../createLucideIcon';

const FlagTriangleRight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/flag-triangle-right';
