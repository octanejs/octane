...
import iconData from '@lucide/icons/icons/book-open';
import createLucideIcon from '../createLucideIcon';

const BookOpen = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/book-open';
