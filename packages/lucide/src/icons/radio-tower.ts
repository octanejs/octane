...
import iconData from '@lucide/icons/icons/radio-tower';
import createLucideIcon from '../createLucideIcon';

const RadioTower = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/radio-tower';
