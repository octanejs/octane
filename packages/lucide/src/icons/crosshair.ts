...
import iconData from '@lucide/icons/icons/crosshair';
import createLucideIcon from '../createLucideIcon';

const Crosshair = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/crosshair';
