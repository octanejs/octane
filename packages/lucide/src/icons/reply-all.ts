...
import iconData from '@lucide/icons/icons/reply-all';
import createLucideIcon from '../createLucideIcon';

const ReplyAll = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/reply-all';
