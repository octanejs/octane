...
import iconData from '@lucide/icons/icons/user-minus';
import createLucideIcon from '../createLucideIcon';

const UserMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/user-minus';
