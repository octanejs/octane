...
import iconData from '@lucide/icons/icons/stretch-horizontal';
import createLucideIcon from '../createLucideIcon';

const StretchHorizontal = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/stretch-horizontal';
