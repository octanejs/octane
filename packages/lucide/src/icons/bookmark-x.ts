...
import iconData from '@lucide/icons/icons/bookmark-x';
import createLucideIcon from '../createLucideIcon';

const BookmarkX = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/bookmark-x';
