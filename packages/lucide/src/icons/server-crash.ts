...
import iconData from '@lucide/icons/icons/server-crash';
import createLucideIcon from '../createLucideIcon';

const ServerCrash = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/server-crash';
