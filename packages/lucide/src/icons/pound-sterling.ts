...
import iconData from '@lucide/icons/icons/pound-sterling';
import createLucideIcon from '../createLucideIcon';

const PoundSterling = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/pound-sterling';
