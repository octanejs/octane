...
import iconData from '@lucide/icons/icons/star-half';
import createLucideIcon from '../createLucideIcon';

const StarHalf = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/star-half';
