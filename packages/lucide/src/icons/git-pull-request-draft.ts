...
import iconData from '@lucide/icons/icons/git-pull-request-draft';
import createLucideIcon from '../createLucideIcon';

const GitPullRequestDraft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/git-pull-request-draft';
