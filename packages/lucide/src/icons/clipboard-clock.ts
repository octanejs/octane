...
import iconData from '@lucide/icons/icons/clipboard-clock';
import createLucideIcon from '../createLucideIcon';

const ClipboardClock = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/clipboard-clock';
