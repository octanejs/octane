...
import iconData from '@lucide/icons/icons/zodiac-aries';
import createLucideIcon from '../createLucideIcon';

const ZodiacAries = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/zodiac-aries';
