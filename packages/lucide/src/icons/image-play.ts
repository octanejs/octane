...
import iconData from '@lucide/icons/icons/image-play';
import createLucideIcon from '../createLucideIcon';

const ImagePlay = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/image-play';
