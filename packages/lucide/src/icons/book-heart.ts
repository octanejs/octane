...
import iconData from '@lucide/icons/icons/book-heart';
import createLucideIcon from '../createLucideIcon';

const BookHeart = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/book-heart';
