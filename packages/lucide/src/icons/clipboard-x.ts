...
import iconData from '@lucide/icons/icons/clipboard-x';
import createLucideIcon from '../createLucideIcon';

const ClipboardX = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/clipboard-x';
