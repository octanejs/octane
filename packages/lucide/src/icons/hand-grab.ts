...
import iconData from '@lucide/icons/icons/hand-grab';
import createLucideIcon from '../createLucideIcon';

const HandGrab = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/hand-grab';
