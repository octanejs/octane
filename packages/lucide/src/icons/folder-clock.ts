...
import iconData from '@lucide/icons/icons/folder-clock';
import createLucideIcon from '../createLucideIcon';

const FolderClock = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-clock';
