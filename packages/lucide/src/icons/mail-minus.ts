...
import iconData from '@lucide/icons/icons/mail-minus';
import createLucideIcon from '../createLucideIcon';

const MailMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/mail-minus';
