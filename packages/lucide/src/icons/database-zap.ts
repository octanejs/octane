...
import iconData from '@lucide/icons/icons/database-zap';
import createLucideIcon from '../createLucideIcon';

const DatabaseZap = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/database-zap';
