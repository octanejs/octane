...
import iconData from '@lucide/icons/icons/circuit-board';
import createLucideIcon from '../createLucideIcon';

const CircuitBoard = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circuit-board';
