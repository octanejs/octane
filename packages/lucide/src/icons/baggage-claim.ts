...
import iconData from '@lucide/icons/icons/baggage-claim';
import createLucideIcon from '../createLucideIcon';

const BaggageClaim = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/baggage-claim';
