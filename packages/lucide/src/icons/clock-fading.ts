...
import iconData from '@lucide/icons/icons/clock-fading';
import createLucideIcon from '../createLucideIcon';

const ClockFading = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/clock-fading';
