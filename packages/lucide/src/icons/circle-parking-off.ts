...
import iconData from '@lucide/icons/icons/circle-parking-off';
import createLucideIcon from '../createLucideIcon';

const CircleParkingOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-parking-off';
