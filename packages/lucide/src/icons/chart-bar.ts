...
import iconData from '@lucide/icons/icons/chart-bar';
import createLucideIcon from '../createLucideIcon';

const ChartBar = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chart-bar';
