...
import iconData from '@lucide/icons/icons/credit-card';
import createLucideIcon from '../createLucideIcon';

const CreditCard = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/credit-card';
