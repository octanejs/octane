...
import iconData from '@lucide/icons/icons/thermometer';
import createLucideIcon from '../createLucideIcon';

const Thermometer = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/thermometer';
