...
import iconData from '@lucide/icons/icons/corner-right-up';
import createLucideIcon from '../createLucideIcon';

const CornerRightUp = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/corner-right-up';
