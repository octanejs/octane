...
import iconData from '@lucide/icons/icons/move-down-right';
import createLucideIcon from '../createLucideIcon';

const MoveDownRight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/move-down-right';
