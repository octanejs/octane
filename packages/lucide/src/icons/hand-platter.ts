...
import iconData from '@lucide/icons/icons/hand-platter';
import createLucideIcon from '../createLucideIcon';

const HandPlatter = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/hand-platter';
