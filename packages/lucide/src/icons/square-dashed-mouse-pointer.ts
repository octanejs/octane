...
import iconData from '@lucide/icons/icons/square-dashed-mouse-pointer';
import createLucideIcon from '../createLucideIcon';

const SquareDashedMousePointer = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-dashed-mouse-pointer';
