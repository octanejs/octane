...
import iconData from '@lucide/icons/icons/folder-symlink';
import createLucideIcon from '../createLucideIcon';

const FolderSymlink = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-symlink';
