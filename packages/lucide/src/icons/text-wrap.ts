...
import iconData from '@lucide/icons/icons/text-wrap';
import createLucideIcon from '../createLucideIcon';

const TextWrap = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/text-wrap';
