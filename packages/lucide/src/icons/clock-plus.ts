...
import iconData from '@lucide/icons/icons/clock-plus';
import createLucideIcon from '../createLucideIcon';

const ClockPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/clock-plus';
