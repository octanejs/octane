...
import iconData from '@lucide/icons/icons/chevron-down';
import createLucideIcon from '../createLucideIcon';

const ChevronDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chevron-down';
