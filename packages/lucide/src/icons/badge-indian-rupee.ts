...
import iconData from '@lucide/icons/icons/badge-indian-rupee';
import createLucideIcon from '../createLucideIcon';

const BadgeIndianRupee = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/badge-indian-rupee';
