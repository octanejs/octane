...
import iconData from '@lucide/icons/icons/monitor-up';
import createLucideIcon from '../createLucideIcon';

const MonitorUp = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/monitor-up';
