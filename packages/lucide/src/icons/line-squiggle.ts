...
import iconData from '@lucide/icons/icons/line-squiggle';
import createLucideIcon from '../createLucideIcon';

const LineSquiggle = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/line-squiggle';
