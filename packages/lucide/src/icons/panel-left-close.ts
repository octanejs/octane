...
import iconData from '@lucide/icons/icons/panel-left-close';
import createLucideIcon from '../createLucideIcon';

const PanelLeftClose = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/panel-left-close';
