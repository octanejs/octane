...
import iconData from '@lucide/icons/icons/heart-plus';
import createLucideIcon from '../createLucideIcon';

const HeartPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/heart-plus';
