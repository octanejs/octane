...
import iconData from '@lucide/icons/icons/shopping-cart-minus';
import createLucideIcon from '../createLucideIcon';

const ShoppingCartMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/shopping-cart-minus';
