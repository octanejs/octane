...
import iconData from '@lucide/icons/icons/panel-bottom-open';
import createLucideIcon from '../createLucideIcon';

const PanelBottomOpen = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/panel-bottom-open';
