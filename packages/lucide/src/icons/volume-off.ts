...
import iconData from '@lucide/icons/icons/volume-off';
import createLucideIcon from '../createLucideIcon';

const VolumeOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/volume-off';
