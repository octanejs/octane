...
import iconData from '@lucide/icons/icons/smartphone-charging';
import createLucideIcon from '../createLucideIcon';

const SmartphoneCharging = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/smartphone-charging';
