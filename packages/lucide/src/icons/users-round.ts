...
import iconData from '@lucide/icons/icons/users-round';
import createLucideIcon from '../createLucideIcon';

const UsersRound = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/users-round';
