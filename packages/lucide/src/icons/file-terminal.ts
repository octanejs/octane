...
import iconData from '@lucide/icons/icons/file-terminal';
import createLucideIcon from '../createLucideIcon';

const FileTerminal = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-terminal';
