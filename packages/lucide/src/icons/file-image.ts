...
import iconData from '@lucide/icons/icons/file-image';
import createLucideIcon from '../createLucideIcon';

const FileImage = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-image';
