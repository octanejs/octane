...
import iconData from '@lucide/icons/icons/calendar-1';
import createLucideIcon from '../createLucideIcon';

const Calendar1 = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/calendar-1';
