...
import iconData from '@lucide/icons/icons/image-down';
import createLucideIcon from '../createLucideIcon';

const ImageDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/image-down';
