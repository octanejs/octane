...
import iconData from '@lucide/icons/icons/folder-open';
import createLucideIcon from '../createLucideIcon';

const FolderOpen = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-open';
