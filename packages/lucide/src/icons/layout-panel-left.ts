...
import iconData from '@lucide/icons/icons/layout-panel-left';
import createLucideIcon from '../createLucideIcon';

const LayoutPanelLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/layout-panel-left';
