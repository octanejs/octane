...
import iconData from '@lucide/icons/icons/squircle-dashed';
import createLucideIcon from '../createLucideIcon';

const SquircleDashed = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/squircle-dashed';
