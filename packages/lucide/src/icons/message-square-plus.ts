...
import iconData from '@lucide/icons/icons/message-square-plus';
import createLucideIcon from '../createLucideIcon';

const MessageSquarePlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-square-plus';
