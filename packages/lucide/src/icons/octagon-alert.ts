...
import iconData from '@lucide/icons/icons/octagon-alert';
import createLucideIcon from '../createLucideIcon';

const OctagonAlert = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/octagon-alert';
