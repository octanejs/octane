...
import iconData from '@lucide/icons/icons/ship-wheel';
import createLucideIcon from '../createLucideIcon';

const ShipWheel = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/ship-wheel';
