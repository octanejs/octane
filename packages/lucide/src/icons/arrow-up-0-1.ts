...
import iconData from '@lucide/icons/icons/arrow-up-0-1';
import createLucideIcon from '../createLucideIcon';

const ArrowUp01 = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-up-0-1';
