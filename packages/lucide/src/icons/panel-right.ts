...
import iconData from '@lucide/icons/icons/panel-right';
import createLucideIcon from '../createLucideIcon';

const PanelRight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/panel-right';
