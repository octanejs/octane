...
import iconData from '@lucide/icons/icons/move-vertical';
import createLucideIcon from '../createLucideIcon';

const MoveVertical = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/move-vertical';
