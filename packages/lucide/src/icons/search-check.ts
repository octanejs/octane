...
import iconData from '@lucide/icons/icons/search-check';
import createLucideIcon from '../createLucideIcon';

const SearchCheck = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/search-check';
