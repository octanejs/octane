...
import iconData from '@lucide/icons/icons/bookmark-minus';
import createLucideIcon from '../createLucideIcon';

const BookmarkMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/bookmark-minus';
