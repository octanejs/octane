...
import iconData from '@lucide/icons/icons/text-quote';
import createLucideIcon from '../createLucideIcon';

const TextQuote = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/text-quote';
