...
import iconData from '@lucide/icons/icons/copy-plus';
import createLucideIcon from '../createLucideIcon';

const CopyPlus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/copy-plus';
