...
import iconData from '@lucide/icons/icons/git-branch-minus';
import createLucideIcon from '../createLucideIcon';

const GitBranchMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/git-branch-minus';
