...
import iconData from '@lucide/icons/icons/layer-arrow-down';
import createLucideIcon from '../createLucideIcon';

const LayerArrowDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/layer-arrow-down';
