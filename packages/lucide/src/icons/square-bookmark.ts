...
import iconData from '@lucide/icons/icons/square-bookmark';
import createLucideIcon from '../createLucideIcon';

const SquareBookmark = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-bookmark';
