...
import iconData from '@lucide/icons/icons/circle-alert';
import createLucideIcon from '../createLucideIcon';

const CircleAlert = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-alert';
