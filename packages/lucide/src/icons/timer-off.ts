...
import iconData from '@lucide/icons/icons/timer-off';
import createLucideIcon from '../createLucideIcon';

const TimerOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/timer-off';
