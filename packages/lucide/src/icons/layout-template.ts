...
import iconData from '@lucide/icons/icons/layout-template';
import createLucideIcon from '../createLucideIcon';

const LayoutTemplate = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/layout-template';
