...
import iconData from '@lucide/icons/icons/folder-key';
import createLucideIcon from '../createLucideIcon';

const FolderKey = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/folder-key';
