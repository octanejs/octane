...
import iconData from '@lucide/icons/icons/cloud-hail';
import createLucideIcon from '../createLucideIcon';

const CloudHail = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cloud-hail';
