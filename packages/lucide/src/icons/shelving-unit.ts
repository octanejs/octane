...
import iconData from '@lucide/icons/icons/shelving-unit';
import createLucideIcon from '../createLucideIcon';

const ShelvingUnit = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/shelving-unit';
