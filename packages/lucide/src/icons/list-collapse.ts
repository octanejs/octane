...
import iconData from '@lucide/icons/icons/list-collapse';
import createLucideIcon from '../createLucideIcon';

const ListCollapse = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/list-collapse';
