...
import iconData from '@lucide/icons/icons/satellite';
import createLucideIcon from '../createLucideIcon';

const Satellite = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/satellite';
