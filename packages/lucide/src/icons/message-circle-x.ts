...
import iconData from '@lucide/icons/icons/message-circle-x';
import createLucideIcon from '../createLucideIcon';

const MessageCircleX = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/message-circle-x';
