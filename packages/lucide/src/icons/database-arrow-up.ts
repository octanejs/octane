...
import iconData from '@lucide/icons/icons/database-arrow-up';
import createLucideIcon from '../createLucideIcon';

const DatabaseArrowUp = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/database-arrow-up';
