...
import iconData from '@lucide/icons/icons/monitor-cloud';
import createLucideIcon from '../createLucideIcon';

const MonitorCloud = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/monitor-cloud';
