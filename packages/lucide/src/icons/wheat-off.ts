...
import iconData from '@lucide/icons/icons/wheat-off';
import createLucideIcon from '../createLucideIcon';

const WheatOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/wheat-off';
