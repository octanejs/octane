...
import iconData from '@lucide/icons/icons/arrow-up-a-z';
import createLucideIcon from '../createLucideIcon';

const ArrowUpAZ = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-up-a-z';
