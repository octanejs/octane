...
import iconData from '@lucide/icons/icons/map-minus';
import createLucideIcon from '../createLucideIcon';

const MapMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/map-minus';
