...
import iconData from '@lucide/icons/icons/file-play';
import createLucideIcon from '../createLucideIcon';

const FilePlay = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-play';
