...
import iconData from '@lucide/icons/icons/arrow-down-wide-narrow';
import createLucideIcon from '../createLucideIcon';

const ArrowDownWideNarrow = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-down-wide-narrow';
