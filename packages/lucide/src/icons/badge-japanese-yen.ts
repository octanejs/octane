...
import iconData from '@lucide/icons/icons/badge-japanese-yen';
import createLucideIcon from '../createLucideIcon';

const BadgeJapaneseYen = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/badge-japanese-yen';
