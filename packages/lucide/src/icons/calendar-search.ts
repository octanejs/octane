...
import iconData from '@lucide/icons/icons/calendar-search';
import createLucideIcon from '../createLucideIcon';

const CalendarSearch = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/calendar-search';
