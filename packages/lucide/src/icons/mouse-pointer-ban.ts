...
import iconData from '@lucide/icons/icons/mouse-pointer-ban';
import createLucideIcon from '../createLucideIcon';

const MousePointerBan = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/mouse-pointer-ban';
