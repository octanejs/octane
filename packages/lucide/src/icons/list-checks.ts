...
import iconData from '@lucide/icons/icons/list-checks';
import createLucideIcon from '../createLucideIcon';

const ListChecks = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/list-checks';
