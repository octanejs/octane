...
import iconData from '@lucide/icons/icons/arrow-down-left';
import createLucideIcon from '../createLucideIcon';

const ArrowDownLeft = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/arrow-down-left';
