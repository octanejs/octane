...
import iconData from '@lucide/icons/icons/cloud-cog';
import createLucideIcon from '../createLucideIcon';

const CloudCog = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/cloud-cog';
