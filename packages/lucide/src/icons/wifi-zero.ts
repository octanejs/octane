...
import iconData from '@lucide/icons/icons/wifi-zero';
import createLucideIcon from '../createLucideIcon';

const WifiZero = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/wifi-zero';
