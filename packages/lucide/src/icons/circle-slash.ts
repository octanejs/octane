...
import iconData from '@lucide/icons/icons/circle-slash';
import createLucideIcon from '../createLucideIcon';

const CircleSlash = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-slash';
