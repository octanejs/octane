...
import iconData from '@lucide/icons/icons/audio-waveform';
import createLucideIcon from '../createLucideIcon';

const AudioWaveform = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/audio-waveform';
