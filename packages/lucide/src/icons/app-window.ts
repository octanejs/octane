...
import iconData from '@lucide/icons/icons/app-window';
import createLucideIcon from '../createLucideIcon';

const AppWindow = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/app-window';
