...
import iconData from '@lucide/icons/icons/scan-heart';
import createLucideIcon from '../createLucideIcon';

const ScanHeart = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/scan-heart';
