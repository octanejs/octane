...
import iconData from '@lucide/icons/icons/layout-arrow-right';
import createLucideIcon from '../createLucideIcon';

const LayoutArrowRight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/layout-arrow-right';
