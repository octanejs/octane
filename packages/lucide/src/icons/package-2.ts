...
import iconData from '@lucide/icons/icons/package-2';
import createLucideIcon from '../createLucideIcon';

const Package2 = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/package-2';
