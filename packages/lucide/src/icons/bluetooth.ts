...
import iconData from '@lucide/icons/icons/bluetooth';
import createLucideIcon from '../createLucideIcon';

const Bluetooth = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/bluetooth';
