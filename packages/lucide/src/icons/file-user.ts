...
import iconData from '@lucide/icons/icons/file-user';
import createLucideIcon from '../createLucideIcon';

const FileUser = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/file-user';
