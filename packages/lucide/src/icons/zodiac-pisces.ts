...
import iconData from '@lucide/icons/icons/zodiac-pisces';
import createLucideIcon from '../createLucideIcon';

const ZodiacPisces = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/zodiac-pisces';
