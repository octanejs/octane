...
import iconData from '@lucide/icons/icons/circle-dot-dashed';
import createLucideIcon from '../createLucideIcon';

const CircleDotDashed = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/circle-dot-dashed';
