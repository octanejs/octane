...
import iconData from '@lucide/icons/icons/book-open-text';
import createLucideIcon from '../createLucideIcon';

const BookOpenText = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/book-open-text';
