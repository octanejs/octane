...
import iconData from '@lucide/icons/icons/heart-minus';
import createLucideIcon from '../createLucideIcon';

const HeartMinus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/heart-minus';
