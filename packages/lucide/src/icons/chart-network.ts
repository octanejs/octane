...
import iconData from '@lucide/icons/icons/chart-network';
import createLucideIcon from '../createLucideIcon';

const ChartNetwork = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chart-network';
