...
import iconData from '@lucide/icons/icons/party-popper';
import createLucideIcon from '../createLucideIcon';

const PartyPopper = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/party-popper';
