...
import iconData from '@lucide/icons/icons/zodiac-ophiuchus';
import createLucideIcon from '../createLucideIcon';

const ZodiacOphiuchus = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/zodiac-ophiuchus';
