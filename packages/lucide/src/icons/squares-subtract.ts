...
import iconData from '@lucide/icons/icons/squares-subtract';
import createLucideIcon from '../createLucideIcon';

const SquaresSubtract = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/squares-subtract';
