...
import iconData from '@lucide/icons/icons/audio-lines-off';
import createLucideIcon from '../createLucideIcon';

const AudioLinesOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/audio-lines-off';
