...
import iconData from '@lucide/icons/icons/route-off';
import createLucideIcon from '../createLucideIcon';

const RouteOff = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/route-off';
