...
import iconData from '@lucide/icons/icons/pill-bottle';
import createLucideIcon from '../createLucideIcon';

const PillBottle = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/pill-bottle';
