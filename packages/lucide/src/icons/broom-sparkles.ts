...
import iconData from '@lucide/icons/icons/broom-sparkles';
import createLucideIcon from '../createLucideIcon';

const BroomSparkles = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/broom-sparkles';
