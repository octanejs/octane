...
import iconData from '@lucide/icons/icons/mail-search';
import createLucideIcon from '../createLucideIcon';

const MailSearch = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/mail-search';
