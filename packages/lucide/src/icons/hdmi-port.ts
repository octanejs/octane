...
import iconData from '@lucide/icons/icons/hdmi-port';
import createLucideIcon from '../createLucideIcon';

const HdmiPort = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/hdmi-port';
