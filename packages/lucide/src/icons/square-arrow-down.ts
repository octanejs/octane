...
import iconData from '@lucide/icons/icons/square-arrow-down';
import createLucideIcon from '../createLucideIcon';

const SquareArrowDown = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/square-arrow-down';
