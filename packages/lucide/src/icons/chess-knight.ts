...
import iconData from '@lucide/icons/icons/chess-knight';
import createLucideIcon from '../createLucideIcon';

const ChessKnight = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/chess-knight';
