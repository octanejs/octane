...
import iconData from '@lucide/icons/icons/thermometer-sun';
import createLucideIcon from '../createLucideIcon';

const ThermometerSun = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/thermometer-sun';
