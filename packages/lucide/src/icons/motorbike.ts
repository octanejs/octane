...
import iconData from '@lucide/icons/icons/motorbike';
import createLucideIcon from '../createLucideIcon';

const Motorbike = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/motorbike';
