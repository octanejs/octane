...
import iconData from '@lucide/icons/icons/git-pull-request-arrow';
import createLucideIcon from '../createLucideIcon';

const GitPullRequestArrow = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/git-pull-request-arrow';
