...
import iconData from '@lucide/icons/icons/brush-cleaning';
import createLucideIcon from '../createLucideIcon';

const BrushCleaning = createLucideIcon(iconData);

export { default as __iconData } from '@lucide/icons/icons/brush-cleaning';
