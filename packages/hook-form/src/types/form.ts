// Adapted from react-hook-form@7.88.0 src/types/form.ts for Octane.
...
// Renderables and native form attributes use Octane public types.
...
import type { FormHTMLAttributes as OctaneFormHTMLAttributes, OctaneNode } from 'octane';
type FormHTMLAttributes = OctaneFormHTMLAttributes<HTMLFormElement>;
...
export type SubmitHandler<T, TResult = unknown> = (data: T, event?: BaseSyntheticEvent) => TResult;
...
) => (e?: BaseSyntheticEvent) => Promise<Awaited<TResult> | undefined>;
...
> &
	Partial<{
		...
		method: 'post' | 'put' | 'delete';
		children: OctaneNode;
		render: (props: { submit: (e?: Event) => void }) => OctaneNode;
		encType:
