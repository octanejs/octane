...
import { type UseFormStateReturn } from '../src/types';
	...
	/** it should type the render function parameter as UseFormStateReturn<TFieldValues> */ {
		...
		void FormStateSubscribe({
			...
			render: (state) => {
				...
				type _t10 = Expect<Equal<typeof state.dirtyFields.foo, boolean | undefined>>;
				...
				type _t12 = Expect<Equal<typeof state.touchedFields.foo, boolean | undefined>>;
