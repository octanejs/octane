import type { ArrayPath, FieldPathValues, Path, PathValue } from '../../src/types';
...
/** {@link PathValue} */ {
	...
	/** it should traverse an object and apply optional type for optional arrays */ {
		const actual = _ as PathValue<Depth3Type<string[] | undefined>, 'foo.foo.value.3'>;
		type _t = Expect<Equal<typeof actual, string | undefined>>;
	}

	/** it should traverse a tuple and apply optional type for optional arrays */ {
		const actual = _ as PathValue<Depth3Type<string[] | undefined>, 'bar.0.value.3'>;
		type _t = Expect<Equal<typeof actual, string | undefined>>;
	}

	/** it should traverse an array and apply optional type for optional arrays */ {
		const actual = _ as PathValue<Depth3Type<string[] | undefined>, 'baz.0.value.3'>;
		type _t = Expect<Equal<typeof actual, string | undefined>>;
	}
}
