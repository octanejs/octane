// Ported from react-hook-form@7.81.0 src/__tests__/useFieldArray/prepend.test.tsx (jest → vitest, octane runtime).
...
describe('prepend', () => {
		...
		const Component = () => {
			...
			return (
				<form>
					...
					<button
						type={'button'}
						onClick={() => prepend([{ test: 'test-batch' }, { test: 'test-batch1' }])}
					>
						prependBatch
					</button>
				</form>
	...
	it('should return watched value with watch API', async () => {
		...
		const Component = () => {
			...
			const isPrepended = useRef(false);
		...
		const Component = () => {
			...
			return (
				<form>
					...
					<button type="button" onClick={() => prepend({ value: '' }, { shouldFocus: false })}>
						prepend
					</button>
				</form>
			);
			...
			const App = () => {
				...
				return (
					<form>
						...
						<button
							type="button"
							onClick={() => prepend([{ value: '1' }, { value: '2' }, { value: '3' }])}
						>
							prepend
						</button>
					</form>
