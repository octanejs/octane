// Ported from react-hook-form@7.81.0 src/__tests__/useForm/resetField.test.tsx (jest → vitest, octane runtime).
...
describe('resetField', () => {
	...
	describe('when provided with options', () => {
		it('should update input value and its defaultValue', () => {
			...
			expect((screen.getByRole('textbox') as HTMLInputElement).value).toEqual('test1234');
		});
