// Ported from react-hook-form@7.81.0 src/__tests__/useForm/getFieldState.test.tsx (jest → vitest, octane runtime).
...
describe('getFieldState', () => {
	...
	describe('with form state and field name supplied', () => {
		...
		describe('when input is nested data type', () => {
			it('should display error state', async () => {
				const App = () => {
					const { trigger, getFieldState, control, formState } = useForm<FormValues>({
						defaultValues: {
							nested: {
								first: '',
								last: '',
			...
			it('should display isValid state', async () => {
				const App = () => {
					const { trigger, control, getFieldState, formState } = useForm<FormValues>({
						defaultValues: {
							nested: {
								first: '',
								last: '',
