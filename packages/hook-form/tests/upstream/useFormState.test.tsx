// Ported from react-hook-form@7.81.0 src/__tests__/useFormState.test.tsx (jest → vitest, octane runtime).
...
describe('useFormState', () => {
	...
	it('should be able to access defaultValues', () => {
		...
		const Test = ({ control }: { control: Control<FormValues> }) => {
			...
			return <p>{deepEqual(formState.defaultValues, defaultValues) ? 'yes' : 'no'}</p>;
		};
