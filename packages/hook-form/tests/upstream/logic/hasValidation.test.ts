// Ported from react-hook-form@7.81.0 src/__tests__/logic/hasValidation.test.ts (jest → vitest, octane runtime).
import { describe, expect, it } from 'vitest';
import hasValidation from '../../../src/logic/hasValidation';
...
describe('hasValidation', () => {
	...
	it('should return false when pattern is undefined or null', () => {
		...
		expect(hasValidation({ ...base, pattern: null } as TestFieldForPatternOnly)).toBeFalsy();
	});
