// Ported from react-hook-form@7.81.0 src/__tests__/logic/validateField.test.tsx (jest → vitest, octane runtime).
import { describe, expect, it, test, vi, type Mock } from 'vitest';
import getCheckboxValue from '../../../src/logic/getCheckboxValue';
import getRadioValue from '../../../src/logic/getRadioValue';
import validateField from '../../../src/logic/validateField';

vi.mock('../../../src/logic/getRadioValue');
vi.mock('../../../src/logic/getCheckboxValue');
