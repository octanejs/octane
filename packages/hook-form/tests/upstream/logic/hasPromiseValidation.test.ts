// Ported from react-hook-form@7.81.0 src/__tests__/logic/hasPromiseValidation.test.ts (jest → vitest, octane runtime).
import { describe, expect, it } from 'vitest';
import hasPromiseValidation from '../../../src/logic/hasPromiseValidation';
