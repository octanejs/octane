// Ported from react-hook-form@7.81.0 src/__tests__/logic/schemaErrorLookup.test.ts (jest → vitest, octane runtime).
import { describe, expect, it, test } from 'vitest';
import schemaErrorLookup from '../../../src/logic/schemaErrorLookup';
