// Ported from react-hook-form@7.81.0 src/__tests__/logic/iterateFieldsByAction.test.ts (jest → vitest, octane runtime).
import { describe, expect, it, vi } from 'vitest';
import iterateFieldsByAction from '../../../src/logic/iterateFieldsByAction';
