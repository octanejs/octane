// Ported from react-hook-form@7.81.0 src/__tests__/utils/fillEmptyArray.test.ts (jest → vitest, octane runtime).
import { describe, expect, it } from 'vitest';
import fillEmptyArray from '../../../src/utils/fillEmptyArray';
