// Ported from react-hook-form@7.81.0 src/__tests__/utils/update.test.ts (jest → vitest, octane runtime).
...
describe('update', () => {
	...
	it('should update with falsy values', () => {
		...
		expect(update([true, true, true] as boolean[], 1, false)).toEqual([true, false, true]);
