...
// @parity-case pristine:zag-original-suite
it('runs the pinned @zag-js/react 1.42.0 suite unchanged', function runsPinnedZagSuite() {
	const expected = JSON.parse(
		readFileSync(resolve(repoRoot, 'packages/zag/audit/pristine-runtime.json'), 'utf8'),
	).tests as Identity[];
