import type { DbClient, LiveQueryObserver, UnhashableQueryIRError } from '@tanstack/db';
...
export function setLiveQueryResultInfo(result: object, info: LiveQueryResultInfo): void {
