...
import { runPristineUpstreamSuite } from '../../../scripts/react-parity/tanstack-db-pristine-runtime.mjs';

// @parity-case pristine:tanstack-db-original-suite
it('runs all 161 pinned DB runtime registrations unchanged', () => {
