...
import { createCollection, debounceStrategy, queueStrategy, throttleStrategy } from '@tanstack/db';
import { usePacedMutations } from '../src/usePacedMutations';
import { mockSyncCollectionOptionsNoInitialState } from './db-fixtures/utils';
...
describe(`usePacedMutations React hook`, () => {
	...
	describe(`memoization`, () => {
		...
		it(`should recreate instance when strategy options actually change`, () => {
			...
			const { result, rerender } = renderHook(({ opts }) => useDebouncedTransaction(opts), {
