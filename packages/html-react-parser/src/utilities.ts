 ...
 */
// OCTANE DIVERGENCE: octane.version is 0.x, but Octane matches React 16+ DOM
// attribute handling, so custom attributes are preserved.
export const PRESERVE_CUSTOM_ATTRIBUTES = true;
