...
describe('attributesToProps with HTML attribute', () => {
	...
	])('converts form attribute to uncontrolled component property', (attributes, props) => {
...
describe('attributesToProps with style attribute', () => {
	...
	it.each([undefined, null] as unknown as string[])('does not parse invalid value: %s', (style) => {
