...
describe('useClientCapability', () => {
	...
	// OCTANE DIVERGENCE[solana-react-capability-error][runtime:f55bf79ffdd7ffe2]
	...
	// OCTANE DIVERGENCE[solana-react-capability-error][runtime:697b90de86fb3bd4]: Octane reports the first missing entry.
	...
	// OCTANE DIVERGENCE[solana-react-capability-error][runtime:5f370d960e375ce4]: first missing only.
	...
	// OCTANE DIVERGENCE[solana-react-missing-provider-error][runtime:d775c531b3e8370b]
