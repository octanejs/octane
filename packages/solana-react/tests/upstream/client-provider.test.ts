...
describe('ClientProvider + useClient', () => {
	...
	// OCTANE DIVERGENCE[solana-react-missing-provider-error][runtime:32e73d9952587b2f]
	...
	describe('async client', () => {
		...
		// OCTANE DIVERGENCE[solana-react-sync-client-only][runtime:8dce5b0ab8f4ae0a]: resolve before mount.
		...
		// OCTANE DIVERGENCE[solana-react-sync-client-only][runtime:14c8d6af4a82769f]: no Promise client / Suspense path.
		...
		// OCTANE DIVERGENCE[solana-react-sync-client-only][runtime:fb3f27ba06fcb68d]: rejection is not an error-boundary path.
