...
> {
	<Props extends object = BaseObject, Statics extends object = BaseObject>(
		...
		OuterStatics &
		Statics &
		// Surface the wrapped component's hoisted statics on the styled type
		// (octane adaptation of upstream's `Omit<Target, keyof React.Component>`).
		(R extends 'web'
			? Target extends string
				? {}
				: Omit<Target, keyof Function | 'displayName' | 'defaultProps'>
			: {});
...
export default function constructWithOptions<
	...
	OuterProps extends object = Target extends KnownTarget ? TargetProps<Target> : BaseObject,
