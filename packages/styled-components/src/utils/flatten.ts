...
export default function flatten<Props extends object>(
	...
	if (t === 'function') {
		...
		// OCTANE: styled components are plain functions (no forwardRef exotic
		// object), so the component-selector case must be handled BEFORE the
		// interpolation-function branch or `${Button}` would invoke Button's
		// render body as if it were a style function. Upstream reaches its
		// object-typed isStyledComponent check below instead.
