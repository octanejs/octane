...
// packages/xstate-store-react/src/types.test.tsx
// (statelyai/xstate @ ddca0ff8c53dc2e85f9173514cc686308d65bd2c).
//
// Permitted transformation, and ONLY this — audit/type-parity.json is the
// authority:
//   1. import root `./index.ts` -> `../src/index.ts`
//
// The suite contains no JSX, so nothing else changes. Everything below this
// header is byte-identical to the vendored upstream file apart from that one
// line, and the file is prettier-ignored so that stays true. Every
// `describe`/`it` name, every assertion, and all thirteen `@ts-expect-error`
// markers are preserved verbatim. The file is compiled by `tsrx-tsc`, never
// executed; its accept/reject result IS the assertion.
import {
  createAtom,
  createAtomConfig,
  createStoreHook,
