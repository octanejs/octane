...
export function normalizeError(
	...
	return {
		name: stringFieldOf(error, 'name', fallbackName),
		message: stringFieldOf(error, 'message', function fallbackMsg() {
			return fallbackMessage;
		}),
		stack: stringFieldOf(error, 'stack', fallbackStack),
		innerError: error,
	};
}
...
function fallbackStack(): string | undefined {
...
function normalizeErrorFn(
	...
	return function normalize(error: unknown): ErrorContext {
		return {
