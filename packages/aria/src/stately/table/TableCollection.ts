// Ported from react-stately (source: .react-spectrum/packages/react-stately/src/table/TableCollection.ts).
// Verbatim (no React surface).
import type { Key } from '@react-types/shared';

import { getFirstItem, getLastItem } from '../collections/getChildNodes';
import { GridCollection, type GridNode, type IGridCollection } from '../grid/GridCollection';
