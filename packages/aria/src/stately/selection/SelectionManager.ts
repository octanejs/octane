// Ported from react-stately (source: .react-spectrum/packages/react-stately/src/selection/SelectionManager.ts).
// Verbatim (no React surface); import paths repointed to the ported collections utils.
import type {
	Collection,
	DisabledBehavior,
	FocusStrategy,
...
import type { MultipleSelectionManager, MultipleSelectionState } from './types';
