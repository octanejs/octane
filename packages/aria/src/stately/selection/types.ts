// Ported from react-stately (source: .react-spectrum/packages/react-stately/src/selection/types.ts).
// Verbatim (type-only; upstream's PressEvent/LongPressEvent types come from
// @react-types/shared and stay type-compatible with the ported interactions area).
import type {
	Collection,
	DisabledBehavior,
	FocusStrategy,
