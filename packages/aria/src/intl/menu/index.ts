// Generated locale-dictionary index for the menu area — the octane equivalent of
// upstream's Parcel glob import (`import intlMessages from '../../intl/menu/*.json'`).
// The JSON files are copied VERBATIM from .react-spectrum/packages/react-aria/intl/menu/;
