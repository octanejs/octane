// Generated locale-dictionary index for the spinbutton area — the octane equivalent of
// upstream's Parcel glob import (`import intlMessages from '../../intl/spinbutton/*.json'`).
// The JSON files are copied VERBATIM from .react-spectrum/packages/react-aria/intl/spinbutton/;
