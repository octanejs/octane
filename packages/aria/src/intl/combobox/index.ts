// Generated locale-dictionary index for the combobox area — the octane equivalent of
// upstream's Parcel glob import (`import intlMessages from '../../intl/combobox/*.json'`).
// The JSON files are copied VERBATIM from .react-spectrum/packages/react-aria/intl/combobox/;
