// Generated locale-dictionary index for the breadcrumbs area — the octane equivalent of
// upstream's Parcel glob import (`import intlMessages from '../../intl/breadcrumbs/*.json'`).
// The JSON files are copied VERBATIM from .react-spectrum/packages/react-aria/intl/breadcrumbs/;
