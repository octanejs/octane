// Generated locale-dictionary index for the searchfield area — the octane equivalent of
// upstream's Parcel glob import (`import intlMessages from '../../intl/searchfield/*.json'`).
// The JSON files are copied VERBATIM from .react-spectrum/packages/react-aria/intl/searchfield/;
