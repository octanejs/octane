...
export const TYPE_PARITY_CONFIG = 'packages/zag/audit/type-parity.json';
...
function normalizeSpecifier(specifier) {
	if (
		...
		specifier === '../src/index' ||
		specifier === '@octanejs/zag'
	) {
		return '#zag-public';
	}
	if (specifier === '../../upstream/src/portal.tsx' || specifier === '../src/portal.ts') {
		return '#zag-portal';
	}
...
export function verifyZagTypes(root, { configPath = TYPE_PARITY_CONFIG } = {}) {
