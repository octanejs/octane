...
const CONFIG = 'packages/colorful/audit/test-classifications.json';
const MANIFEST = 'packages/colorful/audit/react-parity.json';
const DISCOVERY_ROOTS = [
	...
	{
		root: 'packages/colorful/typetests',
		match: /\.test\.ts$/,
	},
];
...
const TYPE_PROBE_PREFIX = 'packages/colorful/audit/type-probes/';
...
export function verifyReactColorfulTestClassifications(root) {
	...
	if (JSON.stringify(discovered) !== JSON.stringify(declared)) {
		throw new Error('every port-authored colorful test must have exactly one classification');
	}
