...
export const TYPE_PARITY_CONFIG = 'packages/livestore/audit/type-parity.json';
...
function normalizeSpecifier(specifier) {
	if (
		specifier === '../../upstream/src/mod.ts' ||
		specifier === '../src/mod.ts' ||
		specifier === '../src/mod' ||
		specifier === '@octanejs/livestore'
	) {
		return '#livestore-public';
	}
...
export function verifyLivestoreTypes(root, { configPath = TYPE_PARITY_CONFIG } = {}) {
