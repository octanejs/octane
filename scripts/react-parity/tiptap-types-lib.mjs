...
export const TYPE_PARITY_CONFIG = 'packages/tiptap/audit/type-parity.json';
...
function normalizeSpecifier(specifier) {
	if (specifier === '@tiptap/react' || specifier === '@octanejs/tiptap') {
		return '#tiptap-public';
	}
	if (specifier === '@tiptap/react/menus' || specifier === '@octanejs/tiptap/menus') {
		return '#tiptap-menus';
	}
...
export function verifyTiptapTypes(root, { configPath = TYPE_PARITY_CONFIG } = {}) {
