...
const GROUPS = [
	{ id: 'library-bindings', title: 'Library bindings' },
	{ id: 'tooling-and-deployment', title: 'Tooling and deployment' },
	{ id: 'platforms-and-native-renderers', title: 'Platforms and native renderers' },
] as const;
