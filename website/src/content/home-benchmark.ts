...
export const HOME_SUMMARY: BenchCard = {
	...
	rows: [
		...
		},
		{
			...
			'octane-tsrx': 1,
			react: 1.2152593903654902,
			preact: 1.6628096141294315,
			solid: 1.1161839868983625,
			svelte: 1.871997021821925,
			ripple: 0.8687212769818896,
			'vue-vapor': 1.03455813977536,
		},
		{
			op: 'signal-favoring',
			'octane-tsrx': 1,
			react: 5.654154916714836,
			preact: 4.538656841722002,
			solid: 0.5427311642839104,
			svelte: 0.7165164404536954,
			ripple: 0.2543261360737126,
			'vue-vapor': 0.22782310334155886,
		},
		{
			op: 'portal-swarm',
			'octane-tsrx': 1,
