...
[lexically scoped `<style>` blocks and themes](/docs/styling) of the components that
rendered, collected per request inside each component body rather than at module
