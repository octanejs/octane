...
<div className="api-index-grid binding-grid">
	<section className="api-index-card binding-card">
		<h3>Shared state</h3>
		<ul>
			<li>
				...
				<span>Small stores, atoms, Redux, and RTK Query.</span>
			</li>
		</ul>
	</section>
	<section className="api-index-card binding-card">
		...
		<ul>
			<li>
				...
				<span>Server data, type-safe routes, and React Router-style APIs.</span>
			</li>
		</ul>
	</section>
	<section className="api-index-card binding-card">
	...
	<section className="api-index-card binding-card">
		...
		<ul>
			<li>
				...
				<span>Tables, large virtual lists, and charts. Recharts is currently partial.</span>
			</li>
		</ul>
	</section>
	<section className="api-index-card binding-card">
...
answers those questions for all 23 first-party bindings and is checked in CI.
...
<aside className="doc-callout tip">
	...
	<p>
		...
		{
			' provides routes, server rendering, hydration wiring, and a production build. The Quick start configures it; bindings are the library adapters you add afterwards.'
		}
	</p>
</aside>
