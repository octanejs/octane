...
on `octane` (or, outside `node_modules`, set `octane.source`), follow their runtime
dependencies recursively, and keep them in the compiler pipeline. Applications do not need package-specific build aliases or
