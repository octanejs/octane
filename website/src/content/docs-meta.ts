...
export const docsMeta: DocMeta[] = [
	...
	},
	{
		...
		sections: [
			{ id: 'scoped-by-default', title: 'Scoped by default' },
			{ id: 'scopes', title: 'What a scope is' },
			{ id: 'multiple-blocks', title: 'Several blocks, one scope' },
			{
				id: 'control-flow',
				title: 'Control flow: stamping follows the branch, CSS does not',
			},
			{ id: 'class-maps', title: 'Class maps and $class', searchTerms: ['$class', 'theme object'] },
			{ id: 'apply', title: 'Apply a theme to a scope', searchTerms: ['apply', 'compose themes'] },
			{ id: 'ordering', title: 'Ordering guarantees', searchTerms: ['injectStyle', 'precedence'] },
			{ id: 'float', title: 'Head resources are outside the model' },
			{
				id: 'diagnostics',
				title: 'Diagnostics',
				searchTerms: [
