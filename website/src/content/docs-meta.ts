	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				// compiler emits and the SCREAMING name docs and agents use.
				searchTerms: [
					'STYLE_APPLY_VALUE',
					...
					'octane-css-unknown-property',
					'OCTANE_CSS_UNKNOWN_PROPERTY',
					'octane-css-shorthand-longhand-clash',
					'OCTANE_CSS_SHORTHAND_LONGHAND_CLASH',
					'octane-css-unused-selector',
					'OCTANE_CSS_UNUSED_SELECTOR',
					'octane-style-unknown-class-key',
					'OCTANE_STYLE_UNKNOWN_CLASS_KEY',
					'octane-style-token-undeclared',
					'OCTANE_STYLE_TOKEN_UNDECLARED',
					'octane-style-token-contract-unresolved',
					'OCTANE_STYLE_TOKEN_CONTRACT_UNRESOLVED',
				],
			},
			{ id: 'next', title: 'Next' },
		],
