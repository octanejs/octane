...
- `packages/{zustand,jotai,i18next,tanstack-ai,tanstack-query,tanstack-store,tanstack-form,apollo-client,motion,dnd-kit,stylex,tanstack-router,remix-router,nuqs,tanstack-table,tanstack-virtual,lexical,tiptap,floating-ui,radix,hook-form,base-ui,sonner,shadcn,recharts,visx,three,lucide,redux,redux-toolkit,testing-library,mdx}/`
