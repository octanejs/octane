...
- `packages/{zustand,jotai,i18next,tanstack-query,motion,dnd-kit,stylex,tanstack-router,remix-router,tanstack-table,tanstack-virtual,lexical,floating-ui,radix,hook-form,base-ui,sonner,recharts,redux,redux-toolkit,testing-library,mdx}/`
  ...
  positioning, UI primitives, forms, toast notifications, charts,
