...
/**
 * Every journey must be free of page errors, console errors, and public
 * hydration-mismatch warnings — the React↔Octane boundary is exactly where a
 * silent mismatch would hide. Tests can opt out only when they deliberately
 * create a JavaScript-disabled context to prove server output.
 */
