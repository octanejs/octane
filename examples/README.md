...
| [Grab Playground](grab-playground) | Upstream react-grab e2e-app-vite ported to Octane for `@octanejs/grab` overlay, owner-stack, and toolbar validation | Strict TypeScript support code, production Vite build, and a grab overlay smoke Playwright journey |
