...
| [Signal Chat](signal-chat) | A ChatGPT-style lab using streaming SSR signals, independent panels, deferred adoption, cancellation, and reproducible captures | Production client/server builds, strict TSRX typechecking, HTTP captures, and early-input, catch-up, fault, and cancellation Playwright journeys |
