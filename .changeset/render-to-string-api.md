...
references a nonexistent `executeServerFunction` export. See the new `docs/ssr.md` for
the full SSR guide and the current gaps (streaming, selective hydration, production
server build).
