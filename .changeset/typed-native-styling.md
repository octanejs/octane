...
Error-severity findings now fail builds: the Vite plugin rejects the transform, the Rspack/Rsbuild loader routes them to `emitError`, and `octane analyze` exits nonzero.
