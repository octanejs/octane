...
// Preact portal-swarm twin. Same three sections as the octane app:
...
//              (Preact bails on identical element references).
// For Preact, A and B are the SAME mechanism (both produce a portal element
