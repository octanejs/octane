// Value-position portal helpers — the React twin of the octane app's tips.ts:
// plain React.createElement + ReactDOM.createPortal, no JSX. For React the A/B
// distinction collapses (both sections produce the same ReactPortal element
...
// target-mode). React bails on reference-identical elements, so this is the
// React baseline for octane's stable-descriptor bail question.
