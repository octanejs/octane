...
// cleanup. The Inferno row instance retains and invokes that cleanup on
// unmount, modeling the same per-element resource lifetime. A stable identity
// also means re-renders must NOT re-invoke it (the gate pins refs/refCleanups
// to row lifetime counts only).
