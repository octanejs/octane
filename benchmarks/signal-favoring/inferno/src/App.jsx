...
// Inferno re-renders the owning component and diffs its descendant VNodes.
...
class C91 extends Component {
	constructor(props) {
		super(props);
		this.state = { v: 0 };
		_set91 = (update) =>
			this.setState(({ v }) => ({ v: typeof update === 'function' ? update(v) : update }));
	}
