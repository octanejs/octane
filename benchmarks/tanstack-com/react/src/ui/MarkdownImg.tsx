...
export const MarkdownImg = React.memo(function MarkdownImg({
	...
	const inferredWidth =
		sourceDimensions && width === undefined ? Math.min(sourceDimensions.width, 800) : providedWidth;
	const inferredHeight =
		sourceDimensions && height === undefined && inferredWidth
			? Math.round(inferredWidth * (sourceDimensions.height / sourceDimensions.width))
			: providedHeight;
