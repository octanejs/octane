...
export const Route = createFileRoute('/_library/$libraryId/$version/docs/framework/')({
...
function RouteComponent() {
	...
	return (
		<DocContainer>
			...
			>
				<div className={twMerge('flex overflow-auto flex-col w-full p-4 lg:p-6')}>
					...
					<div className={twMerge('grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4')}>
						{frameworks.map((framework, i) => {
							const packageName = getFrameworkPackageName(framework.value, libraryId, library);
							return (
								<FrameworkCard
									key={framework.value}
									framework={framework}
					...
					<Card className="mt-12 p-6 md:p-8">
						<div className="text-center max-w-2xl mx-auto">
							...
							<p className="text-gray-600 dark:text-gray-400 mb-6">
								We'd love to help you create a framework adapter for {library.name}. Join our
								community to discuss implementation details and get support.
							</p>
