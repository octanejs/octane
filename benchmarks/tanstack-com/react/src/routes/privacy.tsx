	...
	return (
		<div className="flex flex-col max-w-full min-h-screen gap-12 p-4 md:p-8 pb-0">
			<div className="flex-1 space-y-12 w-full max-w-3xl mx-auto">
				...
				<section className="">
					<p className="text-lg">
						At <strong>TanStack.com</strong> (the "Site"), your privacy is important to us. This
						Privacy Policy explains how we collect, use, and protect your information when you
						access or use our website, products, and services. By using the Site, you agree to the
						practices described in this Privacy Policy. If you do not agree, please do not use the
						Site.
					</p>
				</section>
				...
				<section>
					...
					<ul className="list-disc pl-8">
						<li>
							...
							number, or other information you provide when you register for an account or interact
							with the Site.
						</li>
						<li>
							<strong>Usage Data:</strong> Information about how you access and use the Site,
							including your IP address, browser type, pages visited, and other diagnostic data.
						</li>
						<li>
							<strong>Cookies and Tracking Technologies:</strong> See the "Cookies and Tracking"
				...
				<section>
					...
					<ul className="list-disc pl-8">
						<li>To provide, operate, and maintain the Site and our services.</li>
				...
				<section>
					...
					<p>
						The Site uses cookies and similar tracking technologies to analyze trends, track user
						behavior, and gather demographic information. Cookies are small files stored on your
						device.
					</p>
					<p>
					...
					<ul className="list-disc pl-8">
						<li>Most browsers allow you to block or delete cookies through settings.</li>
				...
				<section>
					...
					<p>
						We do not sell or rent your personal information. However, we may share information in
						the following circumstances:
					</p>
					<ul className="list-disc pl-8">
						<li>
							<strong>Service Providers:</strong> With third parties who help us operate the Site,
							such as hosting or analytics providers.
						</li>
						<li>
							<strong>Legal Compliance:</strong> If required by law or to respond to legal requests.
						</li>
						<li>
				...
				<section>
					...
					<p>
						...
						or disclosure. However, no security measures are completely foolproof, and we cannot
				...
				<section>
					...
					<ul className="list-disc pl-8">
						...
						<li>
							<strong>Data Portability:</strong> Receive a copy of your data in a structured,
				...
				<section>
					...
					<p>
						The Site may contain links to third-party services or websites. We are not responsible
						for the privacy practices of those third parties. Please review their privacy policies
				...
				<section>
					...
					<p>
						...
						posted constitutes acceptance of the revised Privacy Policy.
					</p>
				</section>
