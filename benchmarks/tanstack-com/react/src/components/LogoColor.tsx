	...
	return (
		<BrandContextMenu {...props}>
			...
			>
				...
				<defs>
					<linearGradient x1="50%" y1="0%" x2="50%" y2="71.6497581%" id="linearGradient-1">
					...
					<linearGradient x1="57.9133333%" y1="0%" x2="44.88%" y2="100%" id="linearGradient-20">
						<stop stopColor="#FFA400" offset="0%"></stop>
						<stop stopColor="#FF5E00" offset="100%"></stop>
					</linearGradient>
					<linearGradient x1="50.4945833%" y1="0%" x2="49.68%" y2="100%" id="linearGradient-21">
						<stop stopColor="#FFA400" offset="0%"></stop>
						<stop stopColor="#FF5E00" offset="100%"></stop>
					</linearGradient>
					...
					<g id="Group-3-Copy" transform="translate(1, 0)">
						...
						<g id="Group" mask="url(#mask-3)">
							<g transform="translate(211.2377, 279.787) rotate(3) translate(-211.2377, -279.787)translate(79.8271, 117.9649)">
								...
								></path>
								<g id="Group-5" strokeWidth="1" fill="none" transform="translate(-0, 0)">
									<path
						...
						<circle stroke="#000000" strokeWidth="25" cx="315.5" cy="316.5" r="304"></circle>
					</g>
				</g>
			</svg>
		</BrandContextMenu>
