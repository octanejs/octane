					...
					{!hasNote && (
						<>
							...
							>
								...
								<div>
									<div className="font-medium text-sm text-gray-900 dark:text-white">Add Note</div>
					...
					{!hasImprovement && (
						...
						>
							...
							<div>
								...
								<div className="text-xs text-gray-500 dark:text-gray-400">Help improve docs</div>
							</div>
						</button>
					)}
				</div>
