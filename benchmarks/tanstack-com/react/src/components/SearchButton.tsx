...
function AiGlyph() {
	return (
		<span className="relative flex h-5 w-5 items-center justify-center">
			<span className="text-xs font-black leading-none tracking-normal">AI</span>
		</span>
	);
}

export function SearchButton({ className, iconOnly = false }: SearchButtonProps) {
	...
	return (
		<Button
			...
			title="Search"
			className={twMerge(
				iconOnly ? 'h-7 w-7 rounded-md p-0' : 'gap-2 bg-gray-500/5 dark:bg-gray-500/30',
				className,
			)}
		>
