...
if (allHistoricalMatch) {
	...
	console.log(`   All historical chunks will have identical cache keys regardless of when fetched`);
}
...
console.log('\n' + '='.repeat(80));
console.log('✅ Chunk consistency verified - cache deduplication will work correctly');
console.log('='.repeat(80) + '\n');
