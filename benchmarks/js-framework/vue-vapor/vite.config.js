...
// entry (see src/App.vue). The official entry pins vue@3.6.0-alpha.2, where
// the vapor runtime still shipped in vue's main bundler entry, so its vite
// config needs no alias; we track the current 3.6 beta instead, which is why
// (1) below exists. Two deliberate choices, same rationale as the solid
