	...
	loader: async () => {
		return {
			deferredStuff: new Promise<string>((r) =>
				setTimeout(() => r('Hello deferred!'), DEFER_MS * 2),
			),
...
function Deferred() {
	...
	return (
		<div className="p-2">
			...
			<div data-testid="deferred-count">Count: {count}</div>
			<div>
