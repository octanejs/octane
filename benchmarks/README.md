...
| `client-hot-paths` | client-hot-paths | none (Node and headless Chromium) | branch hydration lookups and descriptor-key work under output, identity, input/focus, events/effects, coercion, and hydration controls; function-tier diagnostics remain a separate audit |
