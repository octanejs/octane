...
| `universal-leaf-update` | universal-leaf-update | none (Node-only) | universal leaf `setState` locality beside 0–4,000 unrelated component siblings through the compiler and native object driver |
