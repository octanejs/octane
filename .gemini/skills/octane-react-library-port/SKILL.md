...
description: >-
  Complete a verified local @octanejs binding for React libraries from npm names
  or npm/GitHub links/lists. Use for plain-language requests to port, assess,
  create, or extend a React-library binding. Enforces immutable provenance,
  approved-license or clean-room boundaries, capability reuse, dependency
  ordering, full-surface parity, implementation, tests, and machine evidence.
---
