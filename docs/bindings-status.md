...
[`packages/better-auth`](../packages/better-auth) `0.0.4` — ports `better-auth@1.7.4`. Status data: [`packages/better-auth/status.json`](../packages/better-auth/status.json).
...
[`packages/tanstack-devtools`](../packages/tanstack-devtools) `0.0.46` — ports `@tanstack/react-devtools@0.10.12`. Status data: [`packages/tanstack-devtools/status.json`](../packages/tanstack-devtools/status.json).
...
[`packages/wagmi`](../packages/wagmi) `0.0.33` — ports `wagmi@3.7.7`. Status data: [`packages/wagmi/status.json`](../packages/wagmi/status.json).
