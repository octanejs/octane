...
- The map's children container is inserted ahead of the DOM mapbox-gl appends, where React appends it after. Both trees hold the same elements and no binding behavior depends on the order.
