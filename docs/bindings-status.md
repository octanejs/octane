...
- Refs are ordinary props and the nine retained upstream class controllers are exposed through functional Octane lifecycle adapters; React context/class/forwardRef object identities are therefore intentionally not type-identical.
