...
[`packages/react-error-boundary`](../packages/react-error-boundary) `0.1.0` — ports `react-error-boundary@6.1.2`. Status data: [`packages/react-error-boundary/status.json`](../packages/react-error-boundary/status.json).
