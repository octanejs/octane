...
The central status table for the 81 `@octanejs/*` framework bindings.
...
| [`@octanejs/virtua`](#octanejsvirtua) | `virtua@0.50.1` | Complete Virtua 0.50.1 React adapter surface for Octane: VList, Virtualizer, WindowVirtualizer, experimental_VGrid, imperative handles, lazy data, dynamic measurement, scrolling, keepMounted, custom container/item/cell elements, and SSR counts. Framework-neutral behavior is delegated to virtua/unstable_core. | Components are compiled Octane .tsrx modules and receive refs as ordinary props instead of using React forwardRef; Native DOM event types replace React synthetic event types on viewport attributes | VList, WindowVirtualizer, and experimental_VGrid render deterministic ssrCount/ssrRowCount/ssrColCount windows without browser globals. | 2026-08-15 |
...
[`packages/alien-signals`](../packages/alien-signals) `0.0.4` — ports `react-alien-signals@0.3.0`. Status data: [`packages/alien-signals/status.json`](../packages/alien-signals/status.json).
...
[`packages/animejs`](../packages/animejs) `0.0.8` — ports `animejs@4.5.0`. Status data: [`packages/animejs/status.json`](../packages/animejs/status.json).
...
[`packages/apollo-client`](../packages/apollo-client) `0.1.33` — ports `@apollo/client@4.2.6`. Status data: [`packages/apollo-client/status.json`](../packages/apollo-client/status.json).
...
[`packages/aria`](../packages/aria) `0.0.32` — ports `react-aria@3.50.0`. Status data: [`packages/aria/status.json`](../packages/aria/status.json).
...
[`packages/base-ui`](../packages/base-ui) `0.1.36` — ports `@base-ui/react@1.6.0`. Status data: [`packages/base-ui/status.json`](../packages/base-ui/status.json).
...
[`packages/cmdk`](../packages/cmdk) `0.1.21` — ports `cmdk@1.1.1`. Status data: [`packages/cmdk/status.json`](../packages/cmdk/status.json).
...
[`packages/colorful`](../packages/colorful) `0.0.4` — ports `react-colorful@5.8.0`. Status data: [`packages/colorful/status.json`](../packages/colorful/status.json).
...
[`packages/day-picker`](../packages/day-picker) `0.0.4` — ports `react-day-picker@10.0.1`. Status data: [`packages/day-picker/status.json`](../packages/day-picker/status.json).
...
[`packages/devtools`](../packages/devtools) `0.0.26` — ports `octane@workspace`. Status data: [`packages/devtools/status.json`](../packages/devtools/status.json).
...
[`packages/dexie`](../packages/dexie) `0.1.31` — ports `dexie-react-hooks@4.4.0`. Status data: [`packages/dexie/status.json`](../packages/dexie/status.json).
...
[`packages/dnd-kit`](../packages/dnd-kit) `0.1.33` — ports `@dnd-kit/react@0.5.0`. Status data: [`packages/dnd-kit/status.json`](../packages/dnd-kit/status.json).
...
[`packages/draggable`](../packages/draggable) `0.0.4` — ports `react-draggable@4.7.1`. Status data: [`packages/draggable/status.json`](../packages/draggable/status.json).
...
[`packages/drei`](../packages/drei) `0.0.4` — ports `@react-three/drei@10.7.7`. Status data: [`packages/drei/status.json`](../packages/drei/status.json).
...
[`packages/dropzone`](../packages/dropzone) `0.0.4` — ports `react-dropzone@20.0.0`. Status data: [`packages/dropzone/status.json`](../packages/dropzone/status.json).
...
[`packages/electron`](../packages/electron) `0.0.16` — ports `electron@43.2.0`. Status data: [`packages/electron/status.json`](../packages/electron/status.json).
...
[`packages/embla-carousel`](../packages/embla-carousel) `0.0.4` — ports `embla-carousel-react@8.6.0`. Status data: [`packages/embla-carousel/status.json`](../packages/embla-carousel/status.json).
...
[`packages/floating-ui`](../packages/floating-ui) `0.1.37` — ports `@floating-ui/react@0.27.19`. Status data: [`packages/floating-ui/status.json`](../packages/floating-ui/status.json).
...
[`packages/gsap`](../packages/gsap) `0.0.7` — ports `@gsap/react@2.1.2`. Status data: [`packages/gsap/status.json`](../packages/gsap/status.json).
...
[`packages/hook-form`](../packages/hook-form) `0.1.35` — ports `react-hook-form@7.81.0`. Status data: [`packages/hook-form/status.json`](../packages/hook-form/status.json).
...
[`packages/i18next`](../packages/i18next) `0.1.33` — ports `react-i18next@17.0.9`. Status data: [`packages/i18next/status.json`](../packages/i18next/status.json).
...
[`packages/inertia`](../packages/inertia) `0.0.7` — ports `@inertiajs/react@3.6.1`. Status data: [`packages/inertia/status.json`](../packages/inertia/status.json).
...
[`packages/input-otp`](../packages/input-otp) `0.0.4` — ports `input-otp@1.4.2`. Status data: [`packages/input-otp/status.json`](../packages/input-otp/status.json).
...
[`packages/intersection-observer`](../packages/intersection-observer) `0.0.4` — ports `react-intersection-observer@10.1.0`. Status data: [`packages/intersection-observer/status.json`](../packages/intersection-observer/status.json).
...
[`packages/jotai`](../packages/jotai) `0.1.35` — ports `jotai@2.20.2`. Status data: [`packages/jotai/status.json`](../packages/jotai/status.json).
...
[`packages/lexical`](../packages/lexical) `0.1.37` — ports `@lexical/react@0.46.0`. Status data: [`packages/lexical/status.json`](../packages/lexical/status.json).
...
[`packages/livestore`](../packages/livestore) `0.0.8` — ports `@livestore/react@0.4.0`. Status data: [`packages/livestore/status.json`](../packages/livestore/status.json).
...
[`packages/lucide`](../packages/lucide) `0.1.33` — ports `lucide-react@1.24.0`. Status data: [`packages/lucide/status.json`](../packages/lucide/status.json).
...
[`packages/mantine-hooks`](../packages/mantine-hooks) `0.1.19` — ports `@mantine/hooks@9.5.0`. Status data: [`packages/mantine-hooks/status.json`](../packages/mantine-hooks/status.json).
...
[`packages/markdown`](../packages/markdown) `0.0.4` — ports `react-markdown@10.1.0`. Status data: [`packages/markdown/status.json`](../packages/markdown/status.json).
...
[`packages/mdx`](../packages/mdx) `0.1.35` — ports `@mdx-js/mdx@3.1.1`. Status data: [`packages/mdx/status.json`](../packages/mdx/status.json).
...
[`packages/mobx`](../packages/mobx) `0.1.19` — ports `mobx-react-lite@4.1.1`. Status data: [`packages/mobx/status.json`](../packages/mobx/status.json).
...
[`packages/monaco-editor`](../packages/monaco-editor) `0.0.6` — ports `@monaco-editor/react@4.7.0`. Status data: [`packages/monaco-editor/status.json`](../packages/monaco-editor/status.json).
...
[`packages/motion`](../packages/motion) `0.1.37` — ports `motion@12.42.2`. Status data: [`packages/motion/status.json`](../packages/motion/status.json).
...
[`packages/nuqs`](../packages/nuqs) `0.1.27` — ports `nuqs@2.9.1`. Status data: [`packages/nuqs/status.json`](../packages/nuqs/status.json).
...
[`packages/pdf`](../packages/pdf) `0.0.4` — ports `react-pdf@10.4.1`. Status data: [`packages/pdf/status.json`](../packages/pdf/status.json).
...
[`packages/phosphor-icons`](../packages/phosphor-icons) `0.0.18` — ports `@phosphor-icons/react@2.1.10`. Status data: [`packages/phosphor-icons/status.json`](../packages/phosphor-icons/status.json).
...
[`packages/popper`](../packages/popper) `0.0.4` — ports `react-popper@2.3.0`. Status data: [`packages/popper/status.json`](../packages/popper/status.json).
...
[`packages/radix`](../packages/radix) `0.1.37` — ports `radix-ui@1.6.4`. Status data: [`packages/radix/status.json`](../packages/radix/status.json).
...
[`packages/rainbowkit`](../packages/rainbowkit) `0.0.18` — ports `@rainbow-me/rainbowkit@2.2.11`. Status data: [`packages/rainbowkit/status.json`](../packages/rainbowkit/status.json).
...
[`packages/react-error-boundary`](../packages/react-error-boundary) `0.1.19` — ports `react-error-boundary@6.1.2`. Status data: [`packages/react-error-boundary/status.json`](../packages/react-error-boundary/status.json).
...
[`packages/react-map-gl`](../packages/react-map-gl) `0.0.10` — ports `@vis.gl/react-mapbox@8.1.2 (b1e46fcf)`. Status data: [`packages/react-map-gl/status.json`](../packages/react-map-gl/status.json).
...
[`packages/recharts`](../packages/recharts) `0.1.35` — ports `recharts@3.9.2`. Status data: [`packages/recharts/status.json`](../packages/recharts/status.json).
...
[`packages/redux`](../packages/redux) `0.1.35` — ports `react-redux@9.3.0`. Status data: [`packages/redux/status.json`](../packages/redux/status.json).
...
[`packages/redux-toolkit`](../packages/redux-toolkit) `0.1.33` — ports `@reduxjs/toolkit@2.12.0`. Status data: [`packages/redux-toolkit/status.json`](../packages/redux-toolkit/status.json).
...
[`packages/remix-router`](../packages/remix-router) `0.1.34` — ports `react-router@8.2.0`. Status data: [`packages/remix-router/status.json`](../packages/remix-router/status.json).
...
[`packages/rxjs`](../packages/rxjs) `0.1.17` — ports `@react-rxjs/core + @react-rxjs/utils@0.10.8 / 0.9.7`. Status data: [`packages/rxjs/status.json`](../packages/rxjs/status.json).
...
[`packages/shadcn`](../packages/shadcn) `0.0.23` — ports `shadcn-ui/ui (radix base)@4baadbc6517070ae8f8feb2c97037adc2b305544 + shadcn@4.14.1`. Status data: [`packages/shadcn/status.json`](../packages/shadcn/status.json).
...
[`packages/solana-react`](../packages/solana-react) `0.0.7` — ports `@solana/react@7.0.0`. Status data: [`packages/solana-react/status.json`](../packages/solana-react/status.json).
...
[`packages/sonner`](../packages/sonner) `0.1.33` — ports `sonner@2.0.7`. Status data: [`packages/sonner/status.json`](../packages/sonner/status.json).
...
[`packages/spring`](../packages/spring) `0.0.4` — ports `@react-spring/web@10.1.2`. Status data: [`packages/spring/status.json`](../packages/spring/status.json).
...
[`packages/streamdown`](../packages/streamdown) `0.1.17` — ports `streamdown@2.5.0`. Status data: [`packages/streamdown/status.json`](../packages/streamdown/status.json).
...
[`packages/styled-components`](../packages/styled-components) `0.1.30` — ports `styled-components@6.4.3`. Status data: [`packages/styled-components/status.json`](../packages/styled-components/status.json).
...
[`packages/stylex`](../packages/stylex) `0.1.37` — ports `@stylexjs/stylex@0.19.0`. Status data: [`packages/stylex/status.json`](../packages/stylex/status.json).
...
[`packages/swr`](../packages/swr) `0.0.4` — ports `swr@2.4.2`. Status data: [`packages/swr/status.json`](../packages/swr/status.json).
...
[`packages/syntax-highlighter`](../packages/syntax-highlighter) `0.0.4` — ports `react-syntax-highlighter@16.1.1`. Status data: [`packages/syntax-highlighter/status.json`](../packages/syntax-highlighter/status.json).
...
[`packages/tanstack-ai`](../packages/tanstack-ai) `0.0.32` — ports `@tanstack/ai-react@0.17.0`. Status data: [`packages/tanstack-ai/status.json`](../packages/tanstack-ai/status.json).
...
[`packages/tanstack-devtools`](../packages/tanstack-devtools) `0.0.32` — ports `@tanstack/react-devtools@0.10.7`. Status data: [`packages/tanstack-devtools/status.json`](../packages/tanstack-devtools/status.json).
...
[`packages/tanstack-form`](../packages/tanstack-form) `0.0.32` — ports `@tanstack/react-form@1.33.2`. Status data: [`packages/tanstack-form/status.json`](../packages/tanstack-form/status.json).
...
[`packages/tanstack-hotkeys`](../packages/tanstack-hotkeys) `0.0.27` — ports `@tanstack/react-hotkeys@0.10.0`. Status data: [`packages/tanstack-hotkeys/status.json`](../packages/tanstack-hotkeys/status.json).
...
[`packages/tanstack-pacer`](../packages/tanstack-pacer) `0.0.27` — ports `@tanstack/react-pacer@0.22.1`. Status data: [`packages/tanstack-pacer/status.json`](../packages/tanstack-pacer/status.json).
...
[`packages/tanstack-query`](../packages/tanstack-query) `0.1.37` — ports `@tanstack/react-query@5.101.3`. Status data: [`packages/tanstack-query/status.json`](../packages/tanstack-query/status.json).
...
[`packages/tanstack-router`](../packages/tanstack-router) `0.1.37` — ports `@tanstack/react-router@1.170.18`. Status data: [`packages/tanstack-router/status.json`](../packages/tanstack-router/status.json).
...
[`packages/tanstack-router-ssr-query`](../packages/tanstack-router-ssr-query) `0.0.27` — ports `@tanstack/react-router-ssr-query@1.167.1`. Status data: [`packages/tanstack-router-ssr-query/status.json`](../packages/tanstack-router-ssr-query/status.json).
...
[`packages/tanstack-store`](../packages/tanstack-store) `0.0.32` — ports `@tanstack/react-store@0.11.0`. Status data: [`packages/tanstack-store/status.json`](../packages/tanstack-store/status.json).
...
[`packages/tanstack-table`](../packages/tanstack-table) `0.1.35` — ports `@tanstack/react-table@9.0.0-beta.58`. Status data: [`packages/tanstack-table/status.json`](../packages/tanstack-table/status.json).
...
[`packages/tanstack-virtual`](../packages/tanstack-virtual) `0.1.35` — ports `@tanstack/react-virtual@3.14.5`. Status data: [`packages/tanstack-virtual/status.json`](../packages/tanstack-virtual/status.json).
...
[`packages/tauri`](../packages/tauri) `0.0.21` — ports `@tauri-apps/api@2.11.1`. Status data: [`packages/tauri/status.json`](../packages/tauri/status.json).
...
[`packages/testing-library`](../packages/testing-library) `0.1.35` — ports `@testing-library/react@16.3.2`. Status data: [`packages/testing-library/status.json`](../packages/testing-library/status.json).
...
[`packages/textarea-autosize`](../packages/textarea-autosize) `0.0.4` — ports `react-textarea-autosize@8.5.9`. Status data: [`packages/textarea-autosize/status.json`](../packages/textarea-autosize/status.json).
...
[`packages/three`](../packages/three) `0.1.31` — ports `@react-three/fiber@9.6.1 (2a528745)`. Status data: [`packages/three/status.json`](../packages/three/status.json).
...
[`packages/tiptap`](../packages/tiptap) `0.0.32` — ports `@tiptap/react@3.28.0`. Status data: [`packages/tiptap/status.json`](../packages/tiptap/status.json).
...
[`packages/transition-group`](../packages/transition-group) `0.0.4` — ports `react-transition-group@4.4.5`. Status data: [`packages/transition-group/status.json`](../packages/transition-group/status.json).
...
[`packages/usehooks-ts`](../packages/usehooks-ts) `0.0.19` — ports `usehooks-ts@3.1.1`. Status data: [`packages/usehooks-ts/status.json`](../packages/usehooks-ts/status.json).
...
[`packages/valtio`](../packages/valtio) `0.1.21` — ports `valtio@2.3.2`. Status data: [`packages/valtio/status.json`](../packages/valtio/status.json).
...
[`packages/vaul`](../packages/vaul) `0.0.4` — ports `vaul@1.1.2`. Status data: [`packages/vaul/status.json`](../packages/vaul/status.json).
...
[`packages/virtua`](../packages/virtua) `0.0.1` — ports `virtua@0.50.1`. Status data: [`packages/virtua/status.json`](../packages/virtua/status.json).

Complete Virtua 0.50.1 React adapter surface for Octane: VList, Virtualizer, WindowVirtualizer, experimental_VGrid, imperative handles, lazy data, dynamic measurement, scrolling, keepMounted, custom container/item/cell elements, and SSR counts. Framework-neutral behavior is delegated to virtua/unstable_core.

Known divergences:

- Components are compiled Octane .tsrx modules and receive refs as ordinary props instead of using React forwardRef.
- Native DOM event types replace React synthetic event types on viewport attributes.

SSR / hydration: VList, WindowVirtualizer, and experimental_VGrid render deterministic ssrCount/ssrRowCount/ssrColCount windows without browser globals.

Scope/evidence last checked: 2026-08-15.

- Pinned to virtua 0.50.1 and reuses its published virtua/unstable_core export.
- The full four-component entry measures 9,002 gzip bytes versus React Virtua's 7,461 bytes under the same Vite build, within the binding's explicit 25% initial budget.
- Recorded-unverified provenance is retained until every upstream React test identity has a one-for-one adapted counterpart.

## @octanejs/visx

[`packages/visx`](../packages/visx) `0.1.32` — ports `@visx/visx@4.0.0 + master@485c035`. Status data: [`packages/visx/status.json`](../packages/visx/status.json).
...
[`packages/wagmi`](../packages/wagmi) `0.0.18` — ports `wagmi@3.7.4`. Status data: [`packages/wagmi/status.json`](../packages/wagmi/status.json).
...
[`packages/window`](../packages/window) `0.0.4` — ports `react-window@2.3.0`. Status data: [`packages/window/status.json`](../packages/window/status.json).
...
[`packages/zag`](../packages/zag) `0.0.4` — ports `@zag-js/react@1.42.0`. Status data: [`packages/zag/status.json`](../packages/zag/status.json).
...
[`packages/zustand`](../packages/zustand) `0.1.37` — ports `zustand@5.0.14`. Status data: [`packages/zustand/status.json`](../packages/zustand/status.json).
