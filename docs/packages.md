...
| --- | --- | --- | --- | --- |
| `@octanejs/adapter-cloudflare` | [`packages/adapter-cloudflare`](../packages/adapter-cloudflare) | deployment adapter | `0.0.12` | 1 |
| `@octanejs/adapter-vercel` | [`packages/adapter-vercel`](../packages/adapter-vercel) | deployment adapter | `0.0.19` | 1 |
...
| `@octanejs/jotai` | [`packages/jotai`](../packages/jotai) | framework binding | `0.1.19` | 7 |
| `@octanejs/lexical` | [`packages/lexical`](../packages/lexical) | framework binding | `0.1.21` | 42 |
| `@octanejs/lucide` | [`packages/lucide`](../packages/lucide) | framework binding | `0.1.17` | 4 |
| `@octanejs/mantine-hooks` | [`packages/mantine-hooks`](../packages/mantine-hooks) | framework binding | `0.1.3` | 1 |
| `@octanejs/mcp-server` | [`packages/octane-mcp-server`](../packages/octane-mcp-server) | agent tooling | `0.2.10` | 2 |
| `@octanejs/mdx` | [`packages/mdx`](../packages/mdx) | framework binding | `0.1.19` | 4 |
| `@octanejs/mobx` | [`packages/mobx`](../packages/mobx) | framework binding | `0.1.3` | 1 |
| `@octanejs/motion` | [`packages/motion`](../packages/motion) | framework binding | `0.1.21` | 1 |
| `@octanejs/nuqs` | [`packages/nuqs`](../packages/nuqs) | framework binding | `0.1.11` | 7 |
| `@octanejs/phosphor-icons` | [`packages/phosphor-icons`](../packages/phosphor-icons) | framework binding | `0.0.2` | 2 |
| `@octanejs/radix` | [`packages/radix`](../packages/radix) | framework binding | `0.1.21` | 1 |
| `@octanejs/rainbowkit` | [`packages/rainbowkit`](../packages/rainbowkit) | framework binding | `0.0.2` | 2 |
| `@octanejs/react-error-boundary` | [`packages/react-error-boundary`](../packages/react-error-boundary) | framework binding | `0.1.3` | 2 |
| `@octanejs/recharts` | [`packages/recharts`](../packages/recharts) | framework binding | `0.1.19` | 1 |
| `@octanejs/redux` | [`packages/redux`](../packages/redux) | framework binding | `0.1.19` | 1 |
| `@octanejs/redux-toolkit` | [`packages/redux-toolkit`](../packages/redux-toolkit) | framework binding | `0.1.17` | 4 |
| `@octanejs/remix-router` | [`packages/remix-router`](../packages/remix-router) | framework binding | `0.1.18` | 2 |
| `@octanejs/rsbuild-plugin` | [`packages/rsbuild-plugin-octane`](../packages/rsbuild-plugin-octane) | metaframework | `0.1.17` | 3 |
...
| `@octanejs/shadcn` | [`packages/shadcn`](../packages/shadcn) | framework binding | `0.0.7` | 81 |
...
| `@octanejs/stylex` | [`packages/stylex`](../packages/stylex) | framework binding | `0.1.21` | 2 |
| `@octanejs/tanstack-ai` | [`packages/tanstack-ai`](../packages/tanstack-ai) | framework binding | `0.0.16` | 1 |
| `@octanejs/tanstack-devtools` | [`packages/tanstack-devtools`](../packages/tanstack-devtools) | framework binding | `0.0.16` | 1 |
| `@octanejs/tanstack-form` | [`packages/tanstack-form`](../packages/tanstack-form) | framework binding | `0.0.16` | 1 |
| `@octanejs/tanstack-hotkeys` | [`packages/tanstack-hotkeys`](../packages/tanstack-hotkeys) | framework binding | `0.0.11` | 1 |
| `@octanejs/tanstack-pacer` | [`packages/tanstack-pacer`](../packages/tanstack-pacer) | framework binding | `0.0.11` | 15 |
...
| `@octanejs/tauri` | [`packages/tauri`](../packages/tauri) | framework binding | `0.0.5` | 1 |
| `@octanejs/testing-library` | [`packages/testing-library`](../packages/testing-library) | framework binding | `0.1.19` | 2 |
| `@octanejs/three` | [`packages/three`](../packages/three) | framework binding | `0.1.15` | 7 |
| `@octanejs/tiptap` | [`packages/tiptap`](../packages/tiptap) | framework binding | `0.0.16` | 2 |
| `@octanejs/usehooks-ts` | [`packages/usehooks-ts`](../packages/usehooks-ts) | framework binding | `0.0.3` | 1 |
| `@octanejs/valtio` | [`packages/valtio`](../packages/valtio) | framework binding | `0.1.5` | 5 |
| `@octanejs/visx` | [`packages/visx`](../packages/visx) | framework binding | `0.1.16` | 49 |
...
| `create-octane` | [`packages/create-octane`](../packages/create-octane) | other package | `0.0.1` | 2 |
