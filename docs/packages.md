...
| --- | --- | --- | --- | --- |
| `@octanejs/adapter-cloudflare` | [`packages/adapter-cloudflare`](../packages/adapter-cloudflare) | deployment adapter | `0.0.23` | 1 |
| `@octanejs/adapter-vercel` | [`packages/adapter-vercel`](../packages/adapter-vercel) | deployment adapter | `0.0.30` | 1 |
| `@octanejs/animejs` | [`packages/animejs`](../packages/animejs) | framework binding | `0.0.3` | 2 |
| `@octanejs/apollo-client` | [`packages/apollo-client`](../packages/apollo-client) | framework binding | `0.1.28` | 6 |
| `@octanejs/app-core` | [`packages/app-core`](../packages/app-core) | metaframework core | `0.0.29` | 9 |
| `@octanejs/aria` | [`packages/aria`](../packages/aria) | framework binding | `0.0.27` | 3 |
| `@octanejs/astro` | [`packages/astro`](../packages/astro) | framework integration | `0.0.12` | 5 |
...
| `@octanejs/i18next` | [`packages/i18next`](../packages/i18next) | framework binding | `0.1.28` | 3 |
| `@octanejs/inertia` | [`packages/inertia`](../packages/inertia) | framework binding | `0.0.2` | 3 |
| `@octanejs/jotai` | [`packages/jotai`](../packages/jotai) | framework binding | `0.1.30` | 7 |
| `@octanejs/lexical` | [`packages/lexical`](../packages/lexical) | framework binding | `0.1.32` | 42 |
| `@octanejs/livestore` | [`packages/livestore`](../packages/livestore) | framework binding | `0.0.3` | 2 |
| `@octanejs/lucide` | [`packages/lucide`](../packages/lucide) | framework binding | `0.1.28` | 4 |
| `@octanejs/mantine-hooks` | [`packages/mantine-hooks`](../packages/mantine-hooks) | framework binding | `0.1.14` | 1 |
...
| `@octanejs/remix-router` | [`packages/remix-router`](../packages/remix-router) | framework binding | `0.1.29` | 2 |
...
| `@octanejs/sonner` | [`packages/sonner`](../packages/sonner) | framework binding | `0.1.28` | 2 |
| `@octanejs/streamdown` | [`packages/streamdown`](../packages/streamdown) | framework binding | `0.1.12` | 6 |
| `@octanejs/styled-components` | [`packages/styled-components`](../packages/styled-components) | framework binding | `0.1.25` | 1 |
| `@octanejs/stylex` | [`packages/stylex`](../packages/stylex) | framework binding | `0.1.32` | 2 |
| `@octanejs/tanstack-ai` | [`packages/tanstack-ai`](../packages/tanstack-ai) | framework binding | `0.0.27` | 1 |
| `@octanejs/tanstack-devtools` | [`packages/tanstack-devtools`](../packages/tanstack-devtools) | framework binding | `0.0.27` | 1 |
| `@octanejs/tanstack-form` | [`packages/tanstack-form`](../packages/tanstack-form) | framework binding | `0.0.27` | 1 |
| `@octanejs/tanstack-hotkeys` | [`packages/tanstack-hotkeys`](../packages/tanstack-hotkeys) | framework binding | `0.0.22` | 1 |
| `@octanejs/tanstack-pacer` | [`packages/tanstack-pacer`](../packages/tanstack-pacer) | framework binding | `0.0.22` | 15 |
| `@octanejs/tanstack-query` | [`packages/tanstack-query`](../packages/tanstack-query) | framework binding | `0.1.32` | 1 |
| `@octanejs/tanstack-router` | [`packages/tanstack-router`](../packages/tanstack-router) | framework binding | `0.1.32` | 6 |
| `@octanejs/tanstack-router-ssr-query` | [`packages/tanstack-router-ssr-query`](../packages/tanstack-router-ssr-query) | framework binding | `0.0.22` | 1 |
| `@octanejs/tanstack-start` | [`packages/tanstack-start`](../packages/tanstack-start) | framework integration | `0.1.22` | 12 |
| `@octanejs/tanstack-store` | [`packages/tanstack-store`](../packages/tanstack-store) | framework binding | `0.0.27` | 1 |
| `@octanejs/tanstack-table` | [`packages/tanstack-table`](../packages/tanstack-table) | framework binding | `0.1.30` | 5 |
...
| `@octanejs/valtio` | [`packages/valtio`](../packages/valtio) | framework binding | `0.1.16` | 5 |
