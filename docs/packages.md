...
**40 publishable package(s), including 33 framework binding(s).**
...
| --- | --- | --- | --- | --- |
| `@octanejs/adapter-vercel` | [`packages/adapter-vercel`](../packages/adapter-vercel) | deployment adapter | `0.0.4` | 1 |
| `@octanejs/apollo-client` | [`packages/apollo-client`](../packages/apollo-client) | framework binding | `0.1.2` | 5 |
| `@octanejs/app-core` | [`packages/app-core`](../packages/app-core) | metaframework core | `0.0.3` | 9 |
| `@octanejs/aria` | [`packages/aria`](../packages/aria) | framework binding | `0.0.1` | 2 |
| `@octanejs/base-ui` | [`packages/base-ui`](../packages/base-ui) | framework binding | `0.1.5` | 2 |
| `@octanejs/dexie` | [`packages/dexie`](../packages/dexie) | framework binding | `0.1.0` | 1 |
| `@octanejs/dnd-kit` | [`packages/dnd-kit`](../packages/dnd-kit) | framework binding | `0.1.2` | 4 |
| `@octanejs/floating-ui` | [`packages/floating-ui`](../packages/floating-ui) | framework binding | `0.1.6` | 1 |
| `@octanejs/hook-form` | [`packages/hook-form`](../packages/hook-form) | framework binding | `0.1.4` | 1 |
| `@octanejs/i18next` | [`packages/i18next`](../packages/i18next) | framework binding | `0.1.2` | 3 |
...
| `@octanejs/recharts` | [`packages/recharts`](../packages/recharts) | framework binding | `0.1.4` | 1 |
| `@octanejs/redux` | [`packages/redux`](../packages/redux) | framework binding | `0.1.4` | 1 |
| `@octanejs/redux-toolkit` | [`packages/redux-toolkit`](../packages/redux-toolkit) | framework binding | `0.1.2` | 4 |
| `@octanejs/remix-router` | [`packages/remix-router`](../packages/remix-router) | framework binding | `0.1.3` | 2 |
| `@octanejs/rsbuild-plugin` | [`packages/rsbuild-plugin-octane`](../packages/rsbuild-plugin-octane) | metaframework | `0.1.2` | 3 |
...
| `@octanejs/tanstack-table` | [`packages/tanstack-table`](../packages/tanstack-table) | framework binding | `0.1.4` | 1 |
