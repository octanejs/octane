...
| `@octanejs/base-ui` | [`packages/base-ui`](../packages/base-ui) | framework binding | `0.1.57` | 79 |
| `@octanejs/base-ui-utils` | [`packages/base-ui-utils`](../packages/base-ui-utils) | framework binding | `0.1.5` | 45 |
| `@octanejs/better-auth` | [`packages/better-auth`](../packages/better-auth) | framework binding | `0.0.9` | 1 |
| `@octanejs/blocknote` | [`packages/blocknote`](../packages/blocknote) | framework binding | `0.1.1` | 2 |
| `@octanejs/calendar` | [`packages/calendar`](../packages/calendar) | framework binding | `0.0.13` | 4 |
| `@octanejs/cli` | [`packages/cli`](../packages/cli) | developer tooling | `0.0.12` | 2 |
| `@octanejs/cmdk` | [`packages/cmdk`](../packages/cmdk) | framework binding | `0.1.41` | 1 |
| `@octanejs/colorful` | [`packages/colorful`](../packages/colorful) | framework binding | `0.0.22` | 1 |
| `@octanejs/content-loader` | [`packages/content-loader`](../packages/content-loader) | framework binding | `0.0.12` | 2 |
| `@octanejs/day-picker` | [`packages/day-picker`](../packages/day-picker) | framework binding | `0.0.23` | 12 |
| `@octanejs/devtools` | [`packages/devtools`](../packages/devtools) | framework binding | `0.0.44` | 1 |
| `@octanejs/dexie` | [`packages/dexie`](../packages/dexie) | framework binding | `0.1.50` | 1 |
| `@octanejs/dnd-kit` | [`packages/dnd-kit`](../packages/dnd-kit) | framework binding | `0.1.51` | 4 |
| `@octanejs/docusaurus` | [`packages/docusaurus`](../packages/docusaurus) | framework integration | `0.0.43` | 8 |
| `@octanejs/draggable` | [`packages/draggable`](../packages/draggable) | framework binding | `0.0.22` | 2 |
| `@octanejs/drei` | [`packages/drei`](../packages/drei) | framework binding | `0.0.25` | 5 |
| `@octanejs/dropzone` | [`packages/dropzone`](../packages/dropzone) | framework binding | `0.0.22` | 2 |
| `@octanejs/electron` | [`packages/electron`](../packages/electron) | framework binding | `0.0.34` | 6 |
| `@octanejs/email` | [`packages/email`](../packages/email) | framework binding | `0.0.8` | 1 |
| `@octanejs/email-cli` | [`packages/email-cli`](../packages/email-cli) | framework binding | `0.0.8` | 2 |
| `@octanejs/embla-carousel` | [`packages/embla-carousel`](../packages/embla-carousel) | framework binding | `0.0.22` | 2 |
| `@octanejs/floating-ui` | [`packages/floating-ui`](../packages/floating-ui) | framework binding | `0.1.57` | 1 |
| `@octanejs/formisch` | [`packages/formisch`](../packages/formisch) | framework binding | `0.0.11` | 1 |
...
| `@octanejs/lexical` | [`packages/lexical`](../packages/lexical) | framework binding | `0.1.57` | 42 |
...
| `@octanejs/mcp-server` | [`packages/octane-mcp-server`](../packages/octane-mcp-server) | agent tooling | `0.2.34` | 2 |
| `@octanejs/mdx` | [`packages/mdx`](../packages/mdx) | framework binding | `0.1.54` | 4 |
| `@octanejs/mobx` | [`packages/mobx`](../packages/mobx) | framework binding | `0.1.37` | 1 |
| `@octanejs/monaco-editor` | [`packages/monaco-editor`](../packages/monaco-editor) | framework binding | `0.0.24` | 1 |
| `@octanejs/motion` | [`packages/motion`](../packages/motion) | framework binding | `0.1.56` | 2 |
| `@octanejs/nuqs` | [`packages/nuqs`](../packages/nuqs) | framework binding | `0.1.45` | 7 |
| `@octanejs/octane-is` | [`packages/octane-is`](../packages/octane-is) | framework binding | `0.0.5` | 1 |
| `@octanejs/opentui` | [`packages/opentui`](../packages/opentui) | framework binding | `0.0.11` | 6 |
| `@octanejs/pdf` | [`packages/pdf`](../packages/pdf) | framework binding | `0.0.22` | 3 |
| `@octanejs/phosphor-icons` | [`packages/phosphor-icons`](../packages/phosphor-icons) | framework binding | `0.0.36` | 2 |
...
| `@octanejs/redux` | [`packages/redux`](../packages/redux) | framework binding | `0.1.54` | 1 |
...
| `@octanejs/sanity-loader` | [`packages/sanity-loader`](../packages/sanity-loader) | framework binding | `0.1.6` | 3 |
| `@octanejs/sanity-logos` | [`packages/sanity-logos`](../packages/sanity-logos) | framework binding | `0.1.6` | 2 |
...
| `@octanejs/streamdown` | [`packages/streamdown`](../packages/streamdown) | framework binding | `0.1.36` | 6 |
| `@octanejs/styled-components` | [`packages/styled-components`](../packages/styled-components) | framework binding | `0.1.48` | 1 |
| `@octanejs/stylex` | [`packages/stylex`](../packages/stylex) | framework binding | `0.1.56` | 4 |
| `@octanejs/swr` | [`packages/swr`](../packages/swr) | framework binding | `0.0.22` | 7 |
| `@octanejs/syntax-highlighter` | [`packages/syntax-highlighter`](../packages/syntax-highlighter) | framework binding | `0.0.22` | 2634 |
| `@octanejs/tanstack-ai` | [`packages/tanstack-ai`](../packages/tanstack-ai) | framework binding | `0.0.50` | 1 |
| `@octanejs/tanstack-db` | [`packages/tanstack-db`](../packages/tanstack-db) | framework binding | `0.0.19` | 1 |
| `@octanejs/tanstack-devtools` | [`packages/tanstack-devtools`](../packages/tanstack-devtools) | framework binding | `0.0.51` | 1 |
...
| `@octanejs/tauri` | [`packages/tauri`](../packages/tauri) | framework binding | `0.0.39` | 1 |
| `@octanejs/testing-library` | [`packages/testing-library`](../packages/testing-library) | framework binding | `0.1.55` | 2 |
| `@octanejs/textarea-autosize` | [`packages/textarea-autosize`](../packages/textarea-autosize) | framework binding | `0.0.23` | 2 |
| `@octanejs/thinking-orbs` | [`packages/thinking-orbs`](../packages/thinking-orbs) | framework binding | `0.1.6` | 1 |
| `@octanejs/three` | [`packages/three`](../packages/three) | framework binding | `0.1.50` | 7 |
| `@octanejs/tiptap` | [`packages/tiptap`](../packages/tiptap) | framework binding | `0.0.50` | 2 |
| `@octanejs/to-print` | [`packages/to-print`](../packages/to-print) | framework binding | `0.0.13` | 2 |
| `@octanejs/transition-group` | [`packages/transition-group`](../packages/transition-group) | framework binding | `0.0.22` | 7 |
| `@octanejs/usehooks-ts` | [`packages/usehooks-ts`](../packages/usehooks-ts) | framework binding | `0.0.38` | 1 |
...
| `@octanejs/xstate` | [`packages/xstate`](../packages/xstate) | framework binding | `0.0.14` | 2 |
| `@octanejs/xstate-store` | [`packages/xstate-store`](../packages/xstate-store) | framework binding | `0.0.14` | 2 |
| `@octanejs/xyflow` | [`packages/xyflow`](../packages/xyflow) | framework binding | `0.1.12` | 3 |
...
| `octane` | [`packages/octane`](../packages/octane) | core runtime + compiler | `0.6.1` | 40 |
