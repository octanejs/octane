...
| --- | --- | --- | --- | --- |
| `@octanejs/adapter-cloudflare` | [`packages/adapter-cloudflare`](../packages/adapter-cloudflare) | deployment adapter | `0.0.31` | 1 |
| `@octanejs/adapter-vercel` | [`packages/adapter-vercel`](../packages/adapter-vercel) | deployment adapter | `0.0.38` | 1 |
| `@octanejs/alien-signals` | [`packages/alien-signals`](../packages/alien-signals) | framework binding | `0.0.7` | 1 |
| `@octanejs/animejs` | [`packages/animejs`](../packages/animejs) | framework binding | `0.0.11` | 2 |
| `@octanejs/apollo-client` | [`packages/apollo-client`](../packages/apollo-client) | framework binding | `0.1.36` | 6 |
...
| `@octanejs/dnd-kit` | [`packages/dnd-kit`](../packages/dnd-kit) | framework binding | `0.1.36` | 4 |
| `@octanejs/docusaurus` | [`packages/docusaurus`](../packages/docusaurus) | framework integration | `0.0.25` | 8 |
| `@octanejs/draggable` | [`packages/draggable`](../packages/draggable) | framework binding | `0.0.7` | 2 |
| `@octanejs/drei` | [`packages/drei`](../packages/drei) | framework binding | `0.0.7` | 5 |
...
| `@octanejs/markdown` | [`packages/markdown`](../packages/markdown) | framework binding | `0.0.7` | 1 |
| `@octanejs/mcp-server` | [`packages/octane-mcp-server`](../packages/octane-mcp-server) | agent tooling | `0.2.17` | 2 |
| `@octanejs/mdx` | [`packages/mdx`](../packages/mdx) | framework binding | `0.1.38` | 4 |
| `@octanejs/mobx` | [`packages/mobx`](../packages/mobx) | framework binding | `0.1.22` | 1 |
...
| `@octanejs/radix` | [`packages/radix`](../packages/radix) | framework binding | `0.1.40` | 1 |
| `@octanejs/rainbowkit` | [`packages/rainbowkit`](../packages/rainbowkit) | framework binding | `0.0.21` | 2 |
| `@octanejs/react-error-boundary` | [`packages/react-error-boundary`](../packages/react-error-boundary) | framework binding | `0.1.22` | 2 |
| `@octanejs/react-map-gl` | [`packages/react-map-gl`](../packages/react-map-gl) | framework binding | `0.0.13` | 2 |
| `@octanejs/recharts` | [`packages/recharts`](../packages/recharts) | framework binding | `0.1.38` | 1 |
...
| `@octanejs/swr` | [`packages/swr`](../packages/swr) | framework binding | `0.0.7` | 7 |
| `@octanejs/syntax-highlighter` | [`packages/syntax-highlighter`](../packages/syntax-highlighter) | framework binding | `0.0.7` | 2634 |
| `@octanejs/tanstack-ai` | [`packages/tanstack-ai`](../packages/tanstack-ai) | framework binding | `0.0.35` | 1 |
| `@octanejs/tanstack-db` | [`packages/tanstack-db`](../packages/tanstack-db) | framework binding | `0.0.4` | 1 |
| `@octanejs/tanstack-devtools` | [`packages/tanstack-devtools`](../packages/tanstack-devtools) | framework binding | `0.0.35` | 1 |
| `@octanejs/tanstack-form` | [`packages/tanstack-form`](../packages/tanstack-form) | framework binding | `0.0.35` | 1 |
| `@octanejs/tanstack-hotkeys` | [`packages/tanstack-hotkeys`](../packages/tanstack-hotkeys) | framework binding | `0.0.30` | 1 |
| `@octanejs/tanstack-pacer` | [`packages/tanstack-pacer`](../packages/tanstack-pacer) | framework binding | `0.0.30` | 15 |
| `@octanejs/tanstack-query` | [`packages/tanstack-query`](../packages/tanstack-query) | framework binding | `0.1.40` | 1 |
| `@octanejs/tanstack-router` | [`packages/tanstack-router`](../packages/tanstack-router) | framework binding | `0.1.40` | 6 |
| `@octanejs/tanstack-router-ssr-query` | [`packages/tanstack-router-ssr-query`](../packages/tanstack-router-ssr-query) | framework binding | `0.0.30` | 1 |
| `@octanejs/tanstack-start` | [`packages/tanstack-start`](../packages/tanstack-start) | framework integration | `0.1.30` | 13 |
| `@octanejs/tanstack-store` | [`packages/tanstack-store`](../packages/tanstack-store) | framework binding | `0.0.35` | 1 |
| `@octanejs/tanstack-table` | [`packages/tanstack-table`](../packages/tanstack-table) | framework binding | `0.1.38` | 5 |
| `@octanejs/tanstack-virtual` | [`packages/tanstack-virtual`](../packages/tanstack-virtual) | framework binding | `0.1.38` | 1 |
| `@octanejs/tauri` | [`packages/tauri`](../packages/tauri) | framework binding | `0.0.24` | 1 |
| `@octanejs/testing-library` | [`packages/testing-library`](../packages/testing-library) | framework binding | `0.1.38` | 2 |
...
| `@octanejs/visx` | [`packages/visx`](../packages/visx) | framework binding | `0.1.35` | 49 |
...
| `octane` | [`packages/octane`](../packages/octane) | core runtime + compiler | `0.1.41` | 25 |
